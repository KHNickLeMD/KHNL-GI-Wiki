...
```mermaid
flowchart TD
    A["Symptomatic microscopic colitis"] --> B["Budesonide 9 mg daily<br/>(first line — strong, moderate;<br/>strong/high vs mesalamine)"]
    B --> C["Consider stopping after 8 weeks"]
    C --> D["Symptom-free<br/>(~1/3 of patients)"]
    C --> E["Relapse after stopping induction"]
    E --> F["Budesonide maintenance 6 mg daily<br/>(strong, moderate) — taper to lowest<br/>effective dose; consider stopping at 6–12 mo"]
    B --> G["Budesonide not feasible<br/>(contraindication, poor response,<br/>cost, patient preference)"]
    G --> H["Mesalamine 3 g daily<br/>(conditional, moderate)"]
    G --> I["Bismuth salicylate<br/>8–9 tablets/day divided 3 times daily<br/>(conditional, low)"]
    G --> J["Prednisolone or prednisone<br/>(conditional, very low)"]
```
