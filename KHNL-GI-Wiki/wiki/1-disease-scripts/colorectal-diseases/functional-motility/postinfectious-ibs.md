...
**Risk after enteric infection** [[acg-2020-ibs]]:

| Metric | Value |
|---|---|
| Pooled prevalence of postinfection IBS | **11% (95% CI 8.2–15.8)** |
| Risk vs. non-exposed individuals | **4.2× higher** |
| OR of IBS after bacterial / viral / parasitic gastroenteritis | **3.51 (95% CI 2.05–6.00)** |
| IBS after a **parasitic** enteritis | **41.9%** |
...
- **ACG recommends *against* routine stool testing for enteric pathogens in all patients with IBS** *(conditional recommendation, low quality of evidence)* — testing for bacterial and viral infections with subsequent treatment does not prevent IBS, and antibiotic exposure may itself be a risk factor. [[acg-2020-ibs]]
- **Exception — test for *Giardia*** in patients with high pretest probability or definite risk factors. Use **fecal immunoassay or PCR**; the CDC risk-factor list that triggers testing, and the test characteristics, live on [[giardiasis]]. [[acg-2020-ibs]]
