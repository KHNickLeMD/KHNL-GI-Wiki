...
```mermaid
flowchart TD
    A["Constipation on opioid therapy<br/>meeting OIC criteria"] --> B["Confirm opioid indication,<br/>pain-management program,<br/>minimum necessary dose"]
    ...
    I --> J["Naldemedine — strong, high quality"]
    I --> K["Naloxegol — strong, moderate quality"]
    I --> L["Methylnaltrexone — conditional, low quality"]
```
