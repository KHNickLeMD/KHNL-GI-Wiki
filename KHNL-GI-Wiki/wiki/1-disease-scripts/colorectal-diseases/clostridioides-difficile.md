...
- NAAT/GDH positive + toxin EIA negative (discordant) → clinical judgment; consider colonization vs. CDI with toxin below detection limit; NAAT+/toxin− patients have CDI-related complications rarely and clinical course similar to those without CDI even untreated
...
| Severity | Criteria |
|---|---|
| **Non-severe** | WBC <15,000 cells/mm³ AND serum creatinine ≤1.5 mg/dL |
...
- **Recurrent CDI (rCDI):** Recurrence of diarrhea + confirmatory positive test (NAAT or toxin EIA) within 8 weeks after treatment of a prior episode. Approximately 20% of patients recur after an initial episode; rates of further recurrences increase significantly after each episode.
- **Fulminant CDI:** Severe criteria plus hemodynamic instability (hypotension/shock), ileus, or megacolon — requires ICU-level management and early surgical consultation

---

## Differential Diagnosis

- Infectious colitis (bacterial: Salmonella, Campylobacter, STEC; viral: norovirus, CMV in immunocompromised)
...
- Post-infection irritable bowel syndrome (occurs in ~25% after treated CDI; C. difficile shedding may persist)
- Ischemic colitis
...
**First-line options (either is appropriate):**

- Vancomycin 125 mg PO QID × 10 days (strong recommendation)
- Fidaxomicin 200 mg PO BID × 10 days (strong recommendation) — similar clinical cure rates to vancomycin; significantly lower 30-day recurrence rate (13% vs 26.6%); higher cost but similar cost-effectiveness due to reduced recurrences

**Alternative for low-risk patients only:**

- Metronidazole 500 mg PO TID × 10 days — acceptable for younger outpatients with minimal comorbidities in cost-constrained settings; inferior to vancomycin in elderly, hospitalized, severely comorbid, or hypoalbuminemic patients
...
- Rifaximin and tigecycline have insufficient evidence; not currently recommended

### Severe Initial CDI

- Vancomycin 125 mg PO QID × 10 days (strong recommendation)
- Fidaxomicin 200 mg PO BID × 10 days (conditional recommendation — very low quality evidence for severe disease; excluded from pivotal trials)
...
- Vancomycin 500 mg PO/NG q6h × first 48–72 hours (strong recommendation) — expert opinion; step down to 125 mg q6h if clinical improvement, continue for additional 10 days
- IV metronidazole 500 mg q8h (conditional) — add particularly if ileus impairs oral vancomycin delivery; evidence mixed (single study showing mortality benefit vs. multicenter study showing none)
...
- If prior treatment was vancomycin or metronidazole → **Fidaxomicin 200 mg PO BID × 10 days** (conditional recommendation, moderate quality); superior to vancomycin in preventing second recurrence (19.7% vs 35.5%)
- Tapering/pulsed-dose vancomycin (strong recommendation, very low quality) — acceptable for any first recurrence regardless of prior therapy; example taper: 125 mg QID × 10–14 days → BID × 7 days → daily × 7 days → every 2–3 days × 8 weeks
