...
- [[hereditary-hemorrhagic-telangiectasia|Hereditary hemorrhagic telangiectasia]] — hepatic/visceral vascular malformations.
...
**Treat vs. observe — the decision is location + patient factors first, then size.** [[acg-2020-hepatic-mesenteric-circulation]]
...
- Guideline body text frames the intervention threshold as **>2–2.5 cm**; the graded recommendation uses **>2 cm** — use 2 cm.
- **Repair modality:** a **minimally invasive approach is preferred in general**. Open repair with arterial reconstruction has been recommended for **proper hepatic artery** aneurysms, but **endovascular stents** give excellent results with lower morbidity. **Coil embolization** may be considered for aneurysms **not** involving the proper hepatic artery.
