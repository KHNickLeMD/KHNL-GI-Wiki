...
| Risk factor |
|---|
| Children in childcare settings, particularly diaper-aged children |
| Close contacts of people with giardiasis (e.g. same household) or their caregivers |
| Drinking water / using ice from places where *Giardia* may live (untreated or improperly treated lakes, streams, wells) |
| Backpackers, hikers, campers drinking unsafe water or without good hygiene (e.g. proper handwashing) |
| Swallowing water while swimming or playing in recreational water |
| Exposure to human feces through sexual contact |
| International travel where *Giardia* may live — lakes, rivers, springs, ponds, streams |

- CDC additionally recommends **screening when acute diarrhea lasts >3 days**. [[acg-2020-ibs]]
...
**Agent selection** [[idsa-2017-infectious-diarrhea]] (Table 6):
