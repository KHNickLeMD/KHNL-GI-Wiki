...
| C. difficile colitis | Toxin+ PCR; risk factors (antibiotics, hospitalization, IBD) |
| Ischemic colitis | Vascular risk factors; watershed distribution; transient course |
...
- Prevention of hospitalization, colectomy, dysplasia/CRC
...
6. **Day 3 assessment:**
   ...
   - **Inadequate response → RESCUE: infliximab OR cyclosporine**
     ...
     - Insufficient data for tofacitinib/upadacitinib as rescue after IVCS failure
7. **Maintenance after rescue:**
   - IFX → continue IFX
   - Cyclosporine → bridge to thiopurine (preferred) or vedolizumab
...
**NSAIDs:** May trigger flares; avoid routine use
