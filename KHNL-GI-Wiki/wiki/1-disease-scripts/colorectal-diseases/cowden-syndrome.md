---
title: "Cowden Syndrome (PTEN Hamartoma Tumor Syndrome)"
...
|---|---|---|---|
| Breast (female) | 12.4% | 25–85% | 38–46 |
| Thyroid (follicular) | 1.1% | 3–38% | 31–38 |
| Endometrial | 2.7% | 5–28% | 25 (onset) |
| Renal cell | 1.6% | 15–34% | 40 (onset) |
| Colorectal | 4.8% | 9–16% | 44–48 |
| Melanoma | 2% | 6% | young onset |
...
- **Bannayan-Riley-Ruvalcaba syndrome (BRRS)** — allelic to Cowden (PTEN); macrocephaly, genital lentigines, lipomas — may be diagnosed in childhood
- **[[familial-adenomatous-polyposis]]** — adenomatous polyps; APC gene
- **Hereditary mixed polyposis syndrome** — GREM1; mixed polyp types
...
- Consider prophylactic thyroidectomy if CS is confirmed and thyroid structural disease is present (thyroid cancer risk 3–38%, predominantly follicular)
- Prophylactic mastectomy is a consideration for women with CS given 25–85% breast cancer risk — decision should be individualized in multidisciplinary setting
- Colectomy reserved for cancer, uncontrollable polyposis, or high-grade dysplasia

### Genetic Counseling

- Once PTEN mutation is identified in proband, all at-risk relatives should undergo mutation-specific testing
- Bannayan-Riley-Ruvalcaba syndrome and Cowden syndrome are allelic conditions — the same PTEN mutations can present as either phenotype in different family members

---

*See also: [[juvenile-polyposis-syndrome]] | [[peutz-jeghers-syndrome]] | [[familial-adenomatous-polyposis]] | [[colorectal-cancer]] | [[colonoscopy]]*
