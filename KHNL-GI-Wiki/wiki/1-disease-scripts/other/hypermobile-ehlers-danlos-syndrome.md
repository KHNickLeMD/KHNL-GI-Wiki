...
**hEDS (2017 international consensus criteria — all 3 required):**
...
- Up to 40% of POTS patients report a preceding viral URI/GI infection; acute and long COVID-19 associated with POTS.
- **BPA 1–2:** mechanistic links (collagen/extracellular-matrix laxity, mast-cell–mediated visceral sensitization, autonomic dysfunction, autoimmunity) are theoretical and evolving. **Target POTS/MCAS testing to clinical presentation — do NOT test universally** in all hEDS/HSDs.
...
- **Celiac (BPA 9):** consider serologic testing **earlier** even without diarrhea. Insufficient evidence to routinely test for disaccharidase deficiencies or other diet-mediated mechanisms.
...
- **Gastric motor function (BPA 11):** in coexisting POTS with chronic upper-GI symptoms, perform timely gastric emptying and/or accommodation testing after excluding anatomical/structural disease (abnormal gastric emptying may be more common than in general population).
- **POTS (BPA 4):** postural vital signs (active stand / head-up tilt); refer to cardiology or neurology for autonomic testing in refractory GI symptoms + orthostatic intolerance after excluding meds and trialing hydration/exercise. Not required for GI symptoms alone.
- **MCAS (BPA 5–7):** consider testing when episodic multisystem (≥2 systems) symptoms suggest a generalized mast-cell disorder. Serum tryptase at baseline and 1–4 h post-flare; activation = baseline +20% +2 ng/mL. If supported, refer to allergy/mast-cell center for expanded testing (urinary N-methylhistamine, leukotriene E4, 11β-prostaglandin F2). Do NOT test routinely for isolated GI symptoms without evidence of mast-cell disorder.
...
**POTS (BPA 13):** fluid (≈2 L/d) and salt (≈10 g/d) intake, exercise training, compression garments first-line. Pharmacologic for volume expansion / HR control / vasoconstriction (fludrocortisone, midodrine, beta-blockers) with cardiology/neurology integration if conservative measures fail.

**MCAS (BPA 14):** nonsedating H1 + H2 histamine receptor antagonists first-line; oral cromolyn mast-cell stabilizers and/or leukotriene receptor antagonist second-line. Avoid triggers (certain foods, alcohol, strong smells, temperature changes, mechanical/friction stimuli, emotional distress, opioids, NSAIDs, iodinated contrast).

**Nutrition / diet (BPA 15):** screen for weight loss and disordered eating; involve a dietitian. Upper-GI predominant → [[gastroparesis]] / small-particle diet. Lower-GI predominant → low-FODMAP, gluten- or dairy-free. Low-histamine diet for MCAS. Deliver all diets with nutritional counseling to avoid restrictive eating.
