---
title: "Hypermobile Ehlers-Danlos Syndrome (GI Manifestations)"
...
**hEDS — 2017 international consensus criteria; all 3 required.** [[aga-2025-heds-gi]]
...
Nine points; **test both sides** for A–D (1 point per side), spine scores 1. [[aga-2025-heds-gi]] (Figure 1, reproduced from the Ehlers-Danlos Society)

| Maneuver | How to test | Points |
|---|---|---|
| **A. 5th finger / pinkies** | Rest palm and forearm on a flat surface, palm down, fingers straight. Can the fifth finger be bent/lifted upwards at the knuckle **beyond 90°**? | 1 per hand |
| **B. Thumbs** | Arm out straight, palm facing down, wrist fully bent downward. Can the thumb be pushed back **to touch the forearm**? | 1 per thumb |
| **C. Elbows** | Arms outstretched, palms up. Does the elbow extend **>10° beyond** a normal outstretched position? | 1 per side |
| **D. Knees** | Standing, knees locked/bent backwards as far as possible. Does the lower leg extend **>10° forward**? | 1 per side |
| **E. Spine** | Bend forward — can the **palms** be placed **flat on the floor** in front of the feet **without bending the knees**? | 1 |

**Positive Beighton score — age-adjusted cutoff (≥):**

| Age band | Cutoff |
|---|---|
| Children (pre-puberty) | **6/9** |
| Puberty up to age 50 | **5/9** |
| ≥50 years | **4/9** |
...
**Consensus diagnostic criteria — A + B + C.** [[aga-2025-heds-gi]] (Table 1, modified from Valent et al)
...
- **General principle (BPA 8):** evaluate GI/DGBI symptoms as in the general population — positive symptom-based strategy + limited noninvasive testing; age- and indication-appropriate endoscopy (complication rates not increased except in vascular EDS).
- **Celiac (BPA 9):** consider [[celiac-disease|celiac]] serology **earlier**, and not only in those with diarrhea. Insufficient evidence to routinely test for disaccharidase deficiencies or other diet-mediated mechanisms.
- **Functional defecation disorders (BPA 10):** [[anorectal-manometry]], balloon expulsion test, or defecography for incomplete-evacuation symptoms — high pelvic floor dysfunction prevalence, **especially rectal hyposensitivity**.
- **Gastric motor function (BPA 11):** in coexisting POTS with chronic upper-GI symptoms, perform **timely** gastric emptying and/or accommodation testing after excluding anatomical/structural disease (abnormal gastric emptying may be more common than in the general population).
- **POTS (BPA 4):** postural vital signs (active stand or head-up tilt — see the HR criteria above); refer to cardiology or neurology for autonomic testing in patients with **refractory GI symptoms plus orthostatic intolerance**, after excluding medication side effects and after adequate hydration and exercise have been tried. **Not required** for GI symptoms alone.
- **MCAS (BPA 5–7):** test when **episodic** symptoms across **≥2 physiologic systems** (cutaneous, GI, cardiac, respiratory, neuropsychiatric) suggest a generalized mast-cell disorder — serum tryptase at baseline and **1–4 h after a symptom flare**, applying the +20% + 2 ng/mL rule. If supported, refer to allergy or a mast-cell center for expanded testing (urinary N-methylhistamine, leukotriene E4, 11β-prostaglandin F2). **Do not** test routinely for isolated GI symptoms without clinical or laboratory evidence of a mast-cell disorder.

---

## Therapeutics

**Overarching (BPA 12, 16):** treat the **most prominent GI symptoms and abnormal function-test results**; follow general [[disorders-of-gut-brain-interaction|DGBI]]/motility management, adding targeted POTS and/or MCAS treatment. Care should be **integrated and multidisciplinary** (cardiology, neurology, rheumatology, dietitian, psychology). Largely expert opinion — few clinical trials.

### GI Symptom Management

*Treatment considerations for hEDS/HSD with POTS and/or MCAS.* [[aga-2025-heds-gi]] (Table 2)
...
- Patients whose symptoms worsen with stress or who use maladaptive coping benefit from **early** referral for brain-gut / gut-directed hypnotherapy.
...
- **BPA 15:** screen for **weight loss and disordered eating**; involve a dietitian.
- Upper-GI predominant (nausea, vomiting) → [[gastroparesis]] / **small-particle diet** (modified food composition, consistency, volume).
- Lower-GI predominant → **low-FODMAP**, wheat/gluten-free, or dairy-free; **low-histamine** for MCAS. Efficacy in these populations is unstudied.
- Severe symptoms with weight loss or dehydration despite optimal medical therapy → parenteral fluid and/or enteral/parenteral nutrition as a stabilizing measure, delivered through a multidisciplinary model.
- Deliver every diet with nutritional counseling to avoid overly restrictive eating.
...
1. [[aga-2025-heds-gi|AGA Clinical Practice Update on GI Manifestations and Autonomic or Immune Dysfunction in Hypermobile Ehlers-Danlos Syndrome: Expert Review]]
