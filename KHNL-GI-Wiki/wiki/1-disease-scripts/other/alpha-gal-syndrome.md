...
**Clinical diagnosis with supporting labs.** Requires all three:

1. **Consistent symptoms** — unexplained GI symptoms (abdominal pain, diarrhea, nausea, vomiting), typically hours after eating mammalian meat/products.
...
- **Geography (US):** range of *Amblyomma americanum* — Southeast, mid-Atlantic, Midwest, East Central regions (New York/Iowa → Texas/Florida). International: Australia, South Africa, Western Europe, Japan.
- Oral food challenge is the formal allergy diagnostic but is **impractical** here (hours-long delay, inconsistent reactions between exposures).
...
*Workup of unexplained diarrhea: see [[chronic-diarrhea]].*

- [[irritable-bowel-syndrome]] and other functional GI illness — the most common misdiagnosis; recognizing alpha-gal as an IgE-mediated cause of GI symptoms is a departure from functional-GI paradigms.
- Other food allergies/intolerances.
- **Red-flag symptoms argue against alpha-gal:** anemia, GI bleeding, or weight loss are **not** caused by the allergy — consider **not** testing for alpha-gal and pursue an organic workup instead.

## Diagnostics

- **Serum alpha-gal IgE antibody** — the key specific test; send in the right clinical/geographic context. Positive alone is non-diagnostic (see Establishing the Diagnosis).
- **Diagnostic avoidance-diet trial** — eliminate mammalian meat (beef, pork, venison) and related products (lard, dairy, ice cream) for **at least a month**; avoid restaurants (cross-contamination) and processed foods (additives); **re-evaluate after the trial** for symptom improvement.
- **Do not test** patients whose picture is dominated by red flags (anemia, GI bleeding, weight loss).
- **Follow-up titers:** repeat alpha-gal IgE at **6–12 months** if tick bites are avoided (levels may fall).

**Mechanism (Figure 1, source — not reproduced here):** ingested alpha-gal binds fat in a glycolipid → absorbed, incorporated into chylomicrons → enters circulation ~2 h → binds IgE on GI mast cells → degranulation releasing histamine/mediators acting on sensory nerves (pain), smooth muscle (contraction), and mucous glands.

## Therapeutics

### Dietary avoidance (cornerstone)

**Eliminate all mammalian meat and mammalian-derived products** — "any animal with hair":

| Avoid | Notes |
|---|---|
| Beef, pork, venison, other mammalian meat | Fatter cuts carry higher reaction risk |
| Lard, butter, milk, **dairy** | Higher alpha-gal in **high-fat dairy**: ice cream, cream, cream cheese |
| **Gelatin** (pig/cow bone collagen) | Marshmallows, gummy bears, gelatin candies/desserts |
...
- Inform a reliable person.
- Take **1–2 diphenhydramine 25 mg tablets**.
- Ensure access to **self-injectable epinephrine**, especially if respiratory compromise.
...
- Dynamic condition — symptoms fluctuate; sensitization may fade if tick bites are avoided.
- As alpha-gal IgE falls/turns negative, may resume **first dairy, then mammalian meat**, in small portions.
- **Self-challenge:** modest doses only (**quarter serving of meat**), have antihistamines + autoinjectable epinephrine available, and another person present. Patients with systemic symptoms (itching, hives) should work with an **allergist first** (anaphylaxis risk).

### Referral to allergist

- Refer when skin/systemic changes occur: facial/throat swelling, voice changes, difficulty breathing, hives, fainting — at risk for anaphylaxis; need epinephrine-autoinjector counseling.
- **No established desensitization protocol** exists for alpha-gal syndrome.
...
1. [[aga-2023-alpha-gal-syndrome|AGA Clinical Practice Update on Alpha-Gal Syndrome for the GI Clinician: Commentary]]
