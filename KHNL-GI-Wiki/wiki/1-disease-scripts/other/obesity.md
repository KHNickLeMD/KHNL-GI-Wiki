...
**Who gets a drug (Rec 1 — Strong / moderate):** adults meeting the BMI thresholds above **who have had an inadequate response to lifestyle interventions** → add a pharmacologic agent to lifestyle intervention, rather than continuing lifestyle alone ([[aga-2022-obesity-pharm]]). *The inadequate-lifestyle-response clause is part of the indication, and the drug is added to — never instead of — lifestyle modification.*

- **Anti-obesity medications generally need to be used chronically**; choose the agent on the patient's clinical profile — comorbidities, preferences, cost, and access.

**Agent selection — the comorbidities and contraindications are the decision** ([[aga-2022-obesity-pharm]] Recs 2–9, all conditional; implementation considerations as printed):
...
- Because of that delayed emptying, the two GLP-1 agents also carry a **pre-endoscopy management** rule — dosing, titration, and the periprocedural rule live on [[glp-1-receptor-agonists]].
...
2. [[aga-2021-intragastric-balloons|AGA Clinical Practice Guidelines on Intragastric Balloons in the Management of Obesity (2021)]]
