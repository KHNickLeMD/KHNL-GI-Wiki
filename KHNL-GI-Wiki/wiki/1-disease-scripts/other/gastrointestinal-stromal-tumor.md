...
- **Tumor rupture** is a stated risk factor — NCCN notes "some stratification schemes have included tumor rupture, which has been associated with a much higher risk of recurrence" — but neither NCCN nor the subepithelial-lesion guidelines quantify it or place a ruptured tumor into a named stratum. The **modified-NIH (Joensuu) classification** and the Joensuu prognostic contour maps, which do, are cited by NCCN; consult them directly when rupture is the deciding feature.
