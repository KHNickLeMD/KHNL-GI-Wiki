...
```mermaid
flowchart TD
    A["CT findings suggestive of SM"] --> B{"≥3 of 5 Coulier criteria?"}
    B -->|"No (hazy mesentery only)"| N["Not diagnostic —<br/>no follow-up if asymptomatic"]
    B -->|"Yes"| C{"Features concerning for malignancy?<br/>nodes >1 cm · SUVmax ≥3.0 ·<br/>other intra-abdominal nodes ·<br/>spiculated/necrotic/calcified/invasive<br/>or absent halo sign"}
    C -->|"Yes"| BX["¹⁸FDG-PET/CT to characterize<br/>+ biopsy (IgG4 staining if indicated)"]
    C -->|"No"| S{"Symptomatic?"}
    S -->|"No"| OBS["No treatment;<br/>annual CT × 2 y, then symptom-driven"]
    S -->|"Yes"| RX["Treat concomitant GI disorders +<br/>tamoxifen 10 mg BID ± prednisone 30–40 mg/d<br/>(alt: colchicine 0.6 mg BID + prednisone;<br/>azathioprine 2–2.5 mg/kg/d)"]
    RX --> R{"Response at 4–6 mo?<br/>(50%–60% respond)"}
    R -->|"No"| SEC["Second line for severe/refractory:<br/>rituximab, thalidomide, cyclophosphamide,<br/>methotrexate, infliximab, ustekinumab"]
