...
- **Imaging-led, usually without biopsy.** CT in the right clinical context is typically sufficient.
- CT signs (no single sign diagnostic):
  - **"Misty mesentery"** — increased mesenteric fat attenuation
...
- **CT abdomen/pelvis** — primary modality (signs above).
- **Biopsy — consider when atypical features suggest malignancy:** a discrete mesenteric mass, **calcified mass with bowel retraction**, or new/accompanying lymphadenopathy. Surgical biopsy with **IgG4 staining** may be preferred. Routine biopsy is **not** required when findings are characteristic and there is no malignancy concern.
- PET may show mild uptake (nonspecific).

## Therapeutics

**Presentation-based:**

- **Asymptomatic** → observe; no treatment.
- **Symptomatic — pharmacotherapy:**
  - **Prednisone** monotherapy 30–40 mg/day (typically start 40 mg/day × 3–4 months, then taper ~5 mg/week)
  - **Tamoxifen 10 mg twice daily** — most commonly used; alone or combined with prednisone (taper prednisone after ~3 months, continue tamoxifen)
  - Alternatives: thalidomide, cyclophosphamide, methotrexate
