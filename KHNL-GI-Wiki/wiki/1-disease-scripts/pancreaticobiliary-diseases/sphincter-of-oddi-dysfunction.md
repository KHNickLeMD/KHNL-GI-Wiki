...
Two parallel 3-type schemes — **biliary** (Rome III revision of the Milwaukee Biliary Group classification) and **pancreatic** (modified Milwaukee). The type is the decision: it predicts response to sphincterotomy and dictates whether ERCP/manometry is even appropriate.

**Biliary SOD** ([[asge-2015-ercp-benign-biliary]]):
...
**Pancreatic SOD** (modified Milwaukee) ([[asge-2015-benign-pancreatic-disease]]):
...
- **Noninvasive first:** cross-sectional imaging, [[mri-mrcp|MRCP]], and [[endoscopic-ultrasound|EUS]] to exclude stones, sludge, strictures, [[chronic-pancreatitis|CP]], and malignancy. **EUS is the preferred low-risk test** for interrogating idiopathic disease, especially in older patients where occult malignancy must be excluded. ([[asge-2015-benign-pancreatic-disease]])
- **Sphincter of Oddi manometry (SOM):** direct measurement of sphincter pressure at [[ercp|ERCP]]. Reserved for **suspected type II** biliary SOD to establish the diagnosis and select responders; **not needed for type I** (>90% respond regardless). ([[asge-2015-ercp-benign-biliary]])
- **For suspected type 2 pancreatic SOD in [[acute-pancreatitis|IRAP]]** with normal EUS/MRCP and no stones/sludge/CP: ERCP with SOM **may be considered**; an alternate strategy is ERCP with empiric biliary and/or pancreatic sphincterotomy (Low). ([[asge-2015-benign-pancreatic-disease]])
- **Suspected SOD carries a significantly higher post-ERCP pancreatitis risk**, whether or not manometry is performed — this shapes the risk/benefit of any invasive workup. ([[asge-2015-ercp-benign-biliary]])

## Therapeutics

### Biliary SOD
- **Type I:** [[ercp|ERCP]] with **biliary sphincterotomy** — SOM not required (Moderate). ([[asge-2015-ercp-benign-biliary]])
