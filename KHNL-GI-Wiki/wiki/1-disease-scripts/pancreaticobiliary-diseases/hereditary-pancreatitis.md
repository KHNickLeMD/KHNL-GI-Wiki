...
- Grade established [[chronic-pancreatitis|chronic pancreatitis]] with **M-ANNHEIM** scoring; morphology by **Cambridge** grade — both live on [[chronic-pancreatitis]].
- **Progression rate:** genetic/idiopathic etiology progresses from AP → CP at **roughly half the rate of alcoholic CP** (alcoholic CP progresses ~2× faster than genetic/idiopathic and ~5× faster than biliary) ([[acg-2020-chronic-pancreatitis]]).

### Classification / Typing

Pathogenic genes implicated in hereditary/genetic pancreatitis ([[acg-2020-chronic-pancreatitis]]):

| Gene | Inheritance | Mechanism | Phenotype |
|---|---|---|---|
| **PRSS1** | AD | Trypsinogen misfolding / ER stress | **Hereditary pancreatitis** — RAP, CP |
| **SPINK1** | AR | Loss of trypsin inhibition | Severe in homozygotes (~2% of population are carriers) |
| **CFTR** | AR | Ductal bicarbonate failure | Cystic fibrosis (severe) or CFTR-related disorder |
| **CTRC** | AD | Trypsin not degraded | Early-onset CP; synergistic risk with smoking |
| **CPA1** | Complex | Misfolding | Nonalcoholic CP |
| **CEL** | AD | Misfolding / aggregation | MODY-8 pancreatitis |
| **CASR** | AR | Intracellular Ca dysregulation | Disease-modifying |
| **CLDN2** | Xq | — | Accelerates RAP → CP in alcoholics (disease-modifying) |

- **Minimum testing panel:** **PRSS1, SPINK1, CFTR, CTRC**; extended panels available ([[acg-2020-chronic-pancreatitis]]).

## Differential Diagnosis

*Workup: see [[recurrent-acute-pancreatitis]].*

- [[chronic-pancreatitis|Chronic pancreatitis]] of other TIGAR-O etiology — toxic-metabolic (alcohol, smoking, hypercalcemia, hypertriglyceridemia), autoimmune ([[autoimmune-pancreatitis|AIP]] type 1/2), obstructive ([[pancreas-divisum|pancreas divisum]], ampullary stenosis).
...
**Start at age 40** for autosomal-dominant hereditary pancreatitis — **annual**, by **[[endoscopic-ultrasound|EUS]], EUS alternating with [[mri-mrcp|MRI]], or MRI**, chosen by patient preference and available expertise ([[asge-2022-pancreatic-cancer-screening]], Recs 2/4/6i; all conditional, very low quality).

- Unlike most other genetic-susceptibility conditions, the HP start age is a **flat age 40 with no "10 years earlier than the youngest affected relative" modifier** ([[asge-2022-pancreatic-cancer-screening]]).
- Counsel on **harms before enrolling**: across screened cohorts, low-yield pancreatic surgery occurred in 2.8% of all screened but **46.6% of those operated**, with a **19.9% perioperative adverse-event rate** among operated patients. No adverse events from screening EUS or MRI. See [[pancreatic-cancer-screening]] for the full framework.

⚠ **Sources conflict on the start age and on whether to screen at all:**
...
Per source priority (guidelines tier; newer publication date wins), **ASGE 2022's age 40 governs**. ACG 2020's caveat is about CP generally, not HP specifically.
...
- **Genetic counselor referral preferred**; family-planning implications for **autosomal-dominant inheritance (PRSS1)** ([[acg-2020-chronic-pancreatitis]]).
...
2. [[acg-2020-chronic-pancreatitis|ACG 2020: Chronic Pancreatitis]]
3. [[acg-2015-hereditary-gi-cancer|ACG 2015: Genetic Testing and Management of Hereditary Gastrointestinal Cancer Syndromes]]
4. [[acg-2024-acute-pancreatitis|ACG Clinical Guideline: Management of Acute Pancreatitis (2024)]]
