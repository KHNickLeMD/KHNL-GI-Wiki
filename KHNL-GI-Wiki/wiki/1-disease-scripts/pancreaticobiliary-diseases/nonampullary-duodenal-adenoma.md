---
title: "Nonampullary Duodenal Adenoma"
...
- [[#Assessment]]
  ...
  - [[#Lesion Description & Risk Stratification]]
- [[#Differential Diagnosis]]
- [[#Diagnostics]]
- [[#Therapeutics]]
  - [[#Resection Technique by Lesion]]
...
- **Nonampullary DA** = duodenal adenoma not involving the major papilla; must be distinguished from **non-neoplastic** and **subepithelial** mimics before resection.
- **Non-neoplastic lesions** (metaplastic foveolar epithelium, gastric heterotopia, inflammatory/pseudopolyps) may mimic adenoma — most frequent in the **duodenal bulb**. Careful optical evaluation + pathologic correlation may be needed to exclude dysplasia. **Nondysplastic lesions do not require resection unless symptomatic or bleeding.**
- If pre-resection concern about underlying pathology, mucosal biopsies may be taken — but caution if future resection is likely, as biopsy can cause submucosal fibrosis, increasing difficulty/risk of later resection. In FAP, repeated/aggressive forceps biopsy and **submucosal tattooing are discouraged** (interfere with future mucosectomy).
- **Duodenal tattoo injection is not required** (numerous anatomic landmarks; high risk of tattoo diffusion).

### Lesion Description & Risk Stratification

Describe every duodenal polyp by **(BPA 3):**
...
| Papilla relationship | proximity/relationship to the **major papilla** (rule out ampullary involvement) |

- **Ideal inspection (BPA 2):** identify **major and minor papilla** with **photodocumentation** to confirm no involvement. A clear distal-attachment cap on a forward-viewing gastroscope improves visualization of the papilla and medial wall. Use a **side-viewing duodenoscope** when the papillae are not visible with the gastroscope and for most lesions on the **medial wall within 5 cm of the ampulla**. For posterior/lateral wall and distal-duodenum lesions, a **pediatric colonoscope** can help (extra length, favorable 5–6 o'clock working-channel orientation).
- **Malignant transformation risk (BPA 7):** all sporadic DAs should be **considered for resection**, but vs colonic adenomas the time course to malignancy is **much more prolonged** and resection morbidity **much greater** → weigh **comorbidities and anticipated longevity**. Lesions initially **≥20 mm** and **proximal to the ampulla** are associated with histologic progression (one study: 20.9% progressed to HGD at 6 mo, 4.7% to carcinoma in situ).
...
| Modality | Role | Notes |
|---|---|---|
| Forward-view [[upper-endoscopy\|gastroscope]] + distal cap | Primary inspection/resection | Cap improves papilla + medial-wall views |
| Side-viewing duodenoscope | Medial-wall lesions <5 cm from ampulla; papillae not seen on gastroscope | Confirms no papillary involvement |
| Pediatric colonoscope | Posterior/lateral wall + distal duodenum | Added length, favorable working-channel orientation |
| [[colonoscopy]] | **Concomitant colonic neoplasia** | Perform if no high-quality exam in last 3 y (BPA 4) — colonic neoplasia risk 2–7× general population (colonic polyps 61% vs 37%; advanced adenomas 18% vs 5%) |
| [[capsule-endoscopy]] | Small-bowel survey | **Not advised** for sporadic or nonsporadic DAs (BPA 5) — small-bowel polyp risk negligible. Reserve periodic capsule for **Peutz-Jeghers** |

---

## Therapeutics

**Endoscopic resection is the preferred treatment (BPA 6)** — less morbid, resource-intensive, and expensive than surgery. In a modeling study of large DAs (mean 40 mm), endoscopy vs surgery: morbidity 18% vs 31%, hospital stay median 1 vs 4.75 days, cost $11,093 vs $19,358. Effort should be made to **completely resect at the initial session** (postresection fibrosis/scarring makes later resection higher-risk and often needs ablative/avulsion techniques). Technique is **individualized** by lesion size, morphology, comorbidities, and endoscopist comfort (BPA 8).
...
- **Initial surveillance at 6 months (BPA 12)** for a completely resected DA. Recurrence is usually diminutive but **scarred and often not amenable to conventional snare resection** — may require **avulsion techniques** to achieve cure (can be complicated by stricture from prior extensive resection).
- After a **negative 6-month exam:** general practice is to repeat at **1 year**, and if clear, **annually for 2–3 years** (few data on optimal timing).
