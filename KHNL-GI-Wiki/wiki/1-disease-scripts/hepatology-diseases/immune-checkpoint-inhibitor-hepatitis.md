...
**Grade-directed management** [[acg-2021-dili]]:

| Grade | ICI | Immunosuppression |
|---|---|---|
| 1 | Continue | Monitor LFTs weekly |
| 2 | Withhold; restart when grade ≤1 | Oral prednisone 0.5–1 mg/kg/day |
| 3–4 | **Withhold permanently** | IV methylprednisolone 1–2 mg/kg/day; if no response in 3 days → add mycophenolate mofetil 500–1000 mg BID; [[tacrolimus]] alternative |

- **Ipilimumab-containing combinations:** higher grade 3–4 hepatitis rate (~8–10%) vs PD-1 monotherapy (~1–2%). [[acg-2021-dili]]
