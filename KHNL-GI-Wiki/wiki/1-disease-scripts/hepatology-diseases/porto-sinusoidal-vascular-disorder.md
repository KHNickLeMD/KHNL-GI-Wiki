---
title: "Porto-Sinusoidal Vascular Disorder (PSVD)"
...
Porto-sinusoidal vascular disorder (PSVD) is a broad clinico-pathological entity of the intrahepatic portal/sinusoidal vasculature that can cause [[portal-hypertension|portal hypertension]] **in the absence of cirrhosis** — but PSVD may also exist without any features of portal hypertension. It replaces and encompasses several older labels [[baveno-vii-2022-portal-hypertension]]:

- Non-cirrhotic portal fibrosis
- Idiopathic portal hypertension / non-cirrhotic intrahepatic portal hypertension
- Overlapping histologic patterns: **nodular regenerative hyperplasia (NRH)**, **obliterative portal venopathy**, hepatoportal sclerosis, incomplete septal cirrhosis
...
3. Unexplained liver blood-test abnormalities even without any signs of portal hypertension.
...
PSVD is defined **histologically + clinically**, not by a stage. The diagnostic criteria (below) group features as *specific* vs *not specific* for portal hypertension and *specific* vs *compatible* PSVD histology.
...
- **[[cirrhosis]]** — the principal mimic; must be excluded (adequate biopsy, imaging, LSM). PSVD favored by smooth surface, no segment-IV atrophy, HVPG <10 mmHg, LSM <10 kPa.
- **[[portal-vein-thrombosis|Portal vein thrombosis / cavernoma]]** — pre-hepatic; may coexist with PSVD, so PVT does not exclude PSVD.
...
3. ≥1 feature **not specific** for portal hypertension **together with** ≥1 histologic lesion **compatible** (but not specific) for PSVD.

**Table 2 — Criteria in the definition of PSVD** [[baveno-vii-2022-portal-hypertension]]:
...
- **Contrast-enhanced CT** at diagnosis to assess anatomy/patency of the portal venous system and portosystemic collaterals (9.25).
- Screen for **associated diseases** — immunological, prothrombotic, and genetic disorders, and drug/toxin exposure (9.20).
- HVPG is typically <10 mmHg and may **underestimate** portal hypertension (pre-sinusoidal component).
...
- **[[tips|TIPS]]** can be considered for severe complications of portal hypertension; associated conditions that worsen post-TIPS outcome must be weighed (9.29).
- **[[liver-transplantation|Liver transplantation]]** is an option in selected patients with severe/refractory portal-hypertension complications or advanced liver dysfunction; discuss at expert centres (9.30).

**Open question:** LSM cut-offs to exclude cirrhosis in this setting cannot yet be proposed (statements 8.34, 9.16) — biopsy remains necessary.
...
1. [[baveno-vii-2022-portal-hypertension|Baveno VII — Renewing Consensus in Portal Hypertension (2022)]]
