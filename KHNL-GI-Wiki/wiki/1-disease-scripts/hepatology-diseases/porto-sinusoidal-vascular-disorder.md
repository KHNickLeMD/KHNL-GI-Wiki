---
title: "Porto-Sinusoidal Vascular Disorder (PSVD) / Non-Cirrhotic Portal Fibrosis (NCPF)"
...
PSVD/NCPF is defined **histologically + clinically**, not by a stage. Baveno VIII replaces the Baveno VII three-way rule with a **point-scoring system** that grades clinical portal-hypertension signs, histological lesions, associated conditions, and the presence of a competing cause of chronic liver disease — see [[#Diagnostic scoring system]].

---

## Differential Diagnosis

*Workup of portal hypertension and its aetiologies: see [[portal-hypertension]].*

- **[[cirrhosis]]** — the principal mimic; must be **excluded on an adequate biopsy** before the diagnosis can be made. PSVD/NCPF favoured by smooth surface, no segment-IV atrophy, HVPG <10 mmHg, LSM <10 kPa.
- **[[portal-vein-thrombosis|Portal vein thrombosis / cavernoma]]** — pre-hepatic; **may coexist**, so PVT does not exclude PSVD/NCPF. Conversely, in a patient with non-cirrhotic PVT, biopsy and HVPG should be considered when PSVD/NCPF is suspected (Baveno VIII 9.4).
- **[[budd-chiari-syndrome|Budd-Chiari syndrome]]** — post-hepatic outflow obstruction.
- Schistosomiasis, congenital hepatic fibrosis, sarcoidosis, and other pre-sinusoidal causes of non-cirrhotic portal hypertension.
- **Concomitant chronic liver disease is not a differential but a modifier** — it scores **−1** in the diagnostic system rather than excluding the diagnosis.

---

## Diagnostics

**Biopsy adequacy (8.41 — relaxed in Baveno VIII):** a [[liver-biopsy|liver biopsy]] specimen of **≥15 mm with at least one fragment ≥10 mm** — or otherwise considered adequate for interpretation by an expert pathologist — is required.

> ⚠ **Changed from Baveno VII 9.18**, which required a specimen **>20 mm with minimal fragmentation**. The new standard is shorter and explicitly permits fragmentation provided one fragment reaches 10 mm.
...
|---|---|---|
| **Clinical signs of portal hypertension** (8.44) | **Specific** — medium/large oesophageal varices; gastric varices; spontaneous portosystemic collaterals; **spleen stiffness >40 kPa in the absence of myeloproliferative neoplasm** | **+3** |
| | **Non-specific** — clinically overt [[ascites]]; small oesophageal varices; **platelets <150 ×10⁹/L**; splenomegaly | **+2** |
| | No sign | 0 |
| **Histological lesions** (8.43) | **Major** — nodular regenerative hyperplasia (NRH); **muscularized portal venules**; **portal venule stenosis involving ≥50% of portal tracts**. *All three minor criteria present together also counts as a major criterion.* | **+5** |
| | **Minor** — abnormal distribution of vascular structures; **portal venule stenosis involving 25–49% of portal tracts**; regenerative changes without clear NRH | **+2** |
| | Normal | 0 |
...
**Variceal screening and surveillance** [[baveno-viii-2026-portal-hypertension]]:

- **[[upper-endoscopy|Endoscopic screening]] for gastro-oesophageal varices at diagnosis** (8.46).
- **Surveillance interval: every 2 years if no varices, every 1 year if small varices** (8.46). Baveno VII 9.23 said the interval "has not yet been defined."
- **Endoscopy can be safely avoided — at diagnosis *and* in follow-up — if spleen stiffness is <40 kPa AND serum bilirubin is <1 mg/dL (<17 µmol/L)** (8.47, new). **Both are required.** Below both thresholds the likelihood of finding varices is low.
  - ⚠ **This is the largest practical change on this page.** Baveno VII 9.21–9.22 made endoscopy mandatory at diagnosis and stated flatly that the non-invasive Baveno criteria "cannot be applied to patients with PSVD." Baveno VIII 8.48 narrows that prohibition to the **LSM-based** cirrhosis criteria and creates a **spleen-stiffness-plus-bilirubin** escape in their place.
- **LSM-based cirrhosis criteria still cannot be applied** to PSVD/NCPF (8.48) — do not use the [[portal-hypertension|LSM/platelet Baveno VI rule]] here.
...
- **Doppler ultrasound every 6 months** to screen for [[portal-vein-thrombosis|PVT]] **in patients with signs of portal hypertension**; liver nodules can be assessed at the same visit (8.50).
- **No data guide PVT screening in patients without features of portal hypertension** (8.51).
- If PVT develops → anticoagulate per the **non-cirrhotic PVT** framework (Baveno VII 9.28; Baveno VIII Panel 9). Baveno VIII 9.13 additionally notes that **TIPS is part of endovascular portal-flow restoration in patients with increased intrahepatic resistance, naming PSVD explicitly**.
...
[[portal-hypertension]], [[cirrhosis]], [[portal-vein-thrombosis]], [[budd-chiari-syndrome]], [[liver-biopsy]], [[liver-stiffness-measurement]], [[hepatic-venous-pressure-gradient]], [[variceal-upper-gi-bleeding]], [[tips]], [[liver-transplantation]], [[upper-endoscopy]], [[ascites]], [[hepatocellular-carcinoma]], [[hepatopulmonary-syndrome-portopulmonary-hypertension]], [[interventional-eus-vascular]], [[liver-disease-in-pregnancy]], [[anticoagulation-gi-bleeding]]
