...
- [[#Diagnostics]]
  ...
  - [[#Serum Ammonia]]
  - [[#Nonresponse to Therapy — What to Re-Test]]
- [[#Therapeutics]]
  - [[#Acute OHE — Four-Pronged Approach]]
  - [[#Lactulose]]
  - [[#Rifaximin]]
...
Every bout should be characterized along **all axes simultaneously** — the 2014 four axes, plus a **fifth axis (social infrastructure)** added by ACG 2026.
...
**Axis 2 — Severity** — West Haven grade (table above)
...
*No dedicated diagnostic schema — OHE is a clinical diagnosis of exclusion; see [[cirrhosis]] for the decompensation framework it sits within.*
...
- *2014 Recommendation 8 (Grade III, B, 2)* likewise limited testing to impaired QoL or employment/public-safety implications.

### Serum Ammonia

- **Do not use serum ammonia alone to diagnose MHE/CHE** (ACG 2026, Rec 2, *conditional, very low certainty*)
- **Suggest against routine ammonia testing to guide inpatient HE treatment decisions** (ACG 2026, Rec 5, *conditional, very low certainty*)
- **Do not use ammonia to guide initiation or titration of therapy, or to evaluate recurrence, in the outpatient setting** (ACG 2026, Key concept 14)
- **A normal ammonia in altered mental status should prompt consideration of other diagnoses** (ACG 2026, Key concept 11) — low/normal ammonia has negative predictive value for HE as the cause. Elevated ammonia adds no diagnostic, staging, or prognostic value in chronic liver disease ([[aasld-easl-2014-hepatic-encephalopathy]], Rec 9, Grade II-3, A, 1)
...
All elements initiated simultaneously ([[aasld-easl-2014-hepatic-encephalopathy]], Recs 14–17, Grade II-2, A, 1):
...
3. Identification and correction of precipitating factors — **nearly 90% can be treated by precipitant correction alone**
...
| Glycerol phenylbutyrate | Investigational | Reduces episodes + time-to-event; needs validation |
| [[probiotics\|Probiotics]] | Not routinely recommended (case-by-case) | Limited high-quality RCT data |
...
- **Treat with lactulose rather than no treatment** (ACG 2026, Rec 3, *conditional, low certainty*) — a shift from the 2014 position (Rec 29, Grade II-2, B, 1) that MHE treatment is not routinely recommended apart from case-by-case
- **Insufficient evidence for or against routine MHE/CHE treatment specifically to prevent OHE** (ACG 2026, Rec 4)
- **Second-line by phenotype** (Key concept 7): BCAA/LOLA if sarcopenia/frailty; zinc if low serum zinc; l-carnitine if muscle cramps
- **Theragnostic lactulose trial:** reassess adherence and symptom improvement at **4–8 weeks** to decide on continuation (Key concept 8)
- Cognitive testing plus lactulose or rifaximin may improve health-related QoL (Key concept 5)
...
- **Recurrent intractable OHE together with liver failure = indication for LT** ([[aasld-easl-2014-hepatic-encephalopathy]], Rec 13, Grade I). HE by itself is not an LT indication unless liver function is poor or QoL severely impaired
- **Multiple HE episodes with MELD <15 → evaluate candidacy for living-donor LT** (ACG 2026, Rec 24, *conditional, low certainty*) — HE burden is under-represented by MELD
- **Adding 4–5 MELD points** (any MELD iteration) more accurately reflects 90-day mortality of inpatient OHE and outpatient CHE (Key concept 26)
- **Early LT evaluation** with high MELD 3.0, severe HE (grades III–IV), or frequent episodes (Key concept 28); multiple episodes cause persistent cognitive impairment that may not fully recover after LT (Key concept 27)
- **Persistent inpatient confusion is a relative contraindication to transplant** (Key concept 29)
- HE typically improves after LT, but not all manifestations are reversible; post-LT cognitive deficits may persist
...
1. **Multidisciplinary medication reconciliation at discharge** — ensure appropriate prophylaxis is prescribed and harmful medications are reduced or stopped (ACG 2026, Key concept 13)
2. Confirm neurological status before discharge; warn caregivers status may change
3. **Driving:** give **oral and written advice to avoid driving** to patients with a **recent (<3 months) OHE episode** and their caregivers (ACG 2026, Key concept 17); take a driving history at clinic visits
4. **Patient and caregiver education** for all (Key concept 18); **screen caregivers for burnout** and refer to palliative care/social work as needed (Key concept 19)
5. Nutritional optimization and monitoring of muscle mass/strength; monitor for MHE/CHE between episodes
6. Address the fifth axis — social, financial, and institutional support
