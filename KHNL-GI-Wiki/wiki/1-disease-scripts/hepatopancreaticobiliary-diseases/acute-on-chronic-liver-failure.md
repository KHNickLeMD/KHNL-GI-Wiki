...
**Common precipitating events (~48% infection-related):** Bacterial infection (SBP, UTI, pneumonia, bacteremia), alcohol-associated hepatitis, GI bleeding, procedural complications, drug/hepatotoxin exposure, viral hepatitis flares. Often precipitant is not identified.
...
| Liver ultrasound + Doppler | PVT, HCC, ascites, portal hemodynamics |
...
- If meets HRS-AKI criteria after albumin challenge:
  ...
  - **Terlipressin (0.5–2.0 mg IV q6h or 2 g/24h continuous infusion):** indicated for Stage 2+ HRS-AKI without ACLF-3 (EASL-CLIF) or major cardiopulmonary/vascular disease (GS 25). Contraindicated in ACLF-3 due to CONFIRM trial respiratory failure signal
...
*Cross-references: [[acute-liver-failure]], [[aki-in-cirrhosis]], [[spontaneous-bacterial-peritonitis]], [[portal-hypertension]], [[variceal-upper-gi-bleeding]], [[ascites]], [[hepatopulmonary-syndrome-portopulmonary-hypertension]], [[liver-transplantation]], [[hepatic-encephalopathy]]*
