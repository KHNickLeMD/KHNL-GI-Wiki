...
|---------------|---------|------------------------|-----------------|
| Hepatocellular | ≥5 | Acute viral hepatitis A/B/C/E, AIH, Wilson disease, ischemic hepatitis, Budd-Chiari | Viral serologies + HCV RNA, ANA/ASMA/IgG, ceruloplasmin, imaging |
| Cholestatic | ≤2 | Biliary obstruction, PBC, PSC | Abdominal imaging (US/CT/MRI); limit ERCP to cases where imaging can't exclude stones/stricture/malignancy |
...
| ICI-induced hepatotoxicity | Immune checkpoint inhibitor therapy; onset 4–12 weeks; mixed → hepatocellular pattern; low ANA titers possible; histology ≠ AIH |
...
|-------|---------|---------|-------|
| Azathioprine/6-MP | Cholestatic or hepatocellular; hepatoportal sclerosis | Moderate to long | Monitor CBC + LFTs regularly in IBD patients |
...
*Cross-references: [[abnormal-liver-chemistries]], [[acute-liver-failure]], [[autoimmune-hepatitis]], [[helicobacter-pylori-infection]] (metronidazole/amoxicillin DILI in H. pylori treatment context), [[inflammatory-bowel-disease]] (azathioprine/methotrexate), [[nafld-masld]] (differential), [[primary-biliary-cholangitis]] (cholestatic DILI differential)*
