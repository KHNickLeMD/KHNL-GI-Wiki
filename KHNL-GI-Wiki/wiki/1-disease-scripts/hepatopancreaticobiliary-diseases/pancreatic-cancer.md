...
## Diagnostics
- **CT (pancreas protocol)** / **MRI–[[mri-mrcp|MRCP]]** — primary staging and resectability assessment.
- **[[endoscopic-ultrasound|EUS]] with FNA/FNB** — tissue diagnosis; most sensitive modality for small solid lesions (in surveillance, almost all solid cancers were detected only by EUS, not MRI). A linear-array echoendoscope outperforms a radial one for detecting pancreatic lesions (82% vs 67%).
...
- **CA 19-9** — adjunct for diagnosis and treatment monitoring (limited sensitivity/specificity; falsely low in Lewis-antigen-negative individuals).
