...
7. ATP7B molecular genetic investigation (depending on logistics)
...
| Variable | 0 | 1 | 2 | 3 | 4 |
|---|---|---|---|---|---|
| Bilirubin (mg/dL) | 0–5.8 | 5.9–8.7 | 8.8–11.7 | 11.8–17.5 | >17.5 |
...
| **KF rings (slit-lamp exam)** | Copper in Descemet's membrane; golden-brown pigment at limbus. Present in: ~95–100% neurologic WD, ~44–62% hepatic WD at diagnosis, rarely in children with liver disease. NOT pathognomonic — also in primary biliary cholangitis (rare). Absent KF rings do NOT exclude WD. |
| **Liver biopsy** | Hepatic parenchymal copper >250 μg/g DW: occurs in most WD; <50 μg/g DW in untreated patient = excludes WD. Intermediate (50–250 μg/g) = prompt other testing. Histologic changes range from steatosis to cirrhosis; may look identical to AIH. EM of mitochondria: characteristic ultrastructural changes. (GS 9) |
...
**Drug overview (Table 9):**

| Drug | Mechanism | Neurological worsening | Key adverse effects |
|---|---|---|---|
| **D-Penicillamine** | Copper chelation → ↑ urinary excretion | 10–20% initial phase | Hypersensitivity (fever/rash early weeks), nephrotic syndrome, bone marrow suppression, elastosis perforans serpiginosa, hepatotoxicity; stop immediately if early sensitivity |
| **Trientine** (dihydrochloride or **tetrahydrochloride, FDA 2022**) | Copper chelation → ↑ urinary excretion | 10–15% initial phase | Gastritis, sideroblastic anemia (rare); fewer adverse effects than D-penicillamine; preferred for penicillamine-intolerant patients |
| **Zinc** (sulfate/acetate/gluconate) | Induces enterocyte metallothionein → blocks Cu absorption | Uncommon; can occur initially | Gastric irritation (most common ~33%); biochemical pancreatitis; no dose reduction needed for surgery/pregnancy |
...
| Drug | Maintenance 24-h Cu (μg/24h) | Maintenance NCC (μg/dl) | Overtreatment (24-h Cu) |
|---|---|---|---|
| D-Penicillamine | 200–500 (≈3–8 μmol/24h) | 5–15 | <100 (<1.6 μmol/24h) |
| Trientine | 150–500 (≈2.4–8 μmol/24h) | 5–15 | <100 (<1.6 μmol/24h) |
| Zinc | <100 (<1.6 μmol/24h) | 5–15 | <20 (<0.3 μmol/24h) |

**Signs of overtreatment (GS 23):** Cytopenias, ↑ serum ferritin (tissue iron retention), low serum copper, NCC <5 μg/dl. Reduce dose or briefly interrupt therapy; close follow-up.

**Treatment failure (GS 24):** Can occur at initiation or during chronic therapy. Rule out concurrent disease and nonadherence first. Change pharmacotherapy; if advanced disease/liver failure → LT.

**Adherence (GS 25):** Lifelong adherence essential. Team-based support; regular monitoring. Adolescence is a high-risk period. Measure 24-h urinary zinc to assess zinc adherence; KF ring reappearance after resolution = nonadherence.
...
- Dysarthria/dysphagia: speech therapy, swallow evaluation for aspiration risk

### Psychiatric Management (GS 38)

- One-third of patients with psychiatric manifestations improve with copper removal alone
- Persistent/severe psychiatric features despite adequate WD treatment → psychotropic medications or counseling (GS 38)
...
- **Continue treatment throughout pregnancy** — interruption causes hepatic decompensation and/or fetal copper toxicity (GS 34)
- Preconception: genetic counseling; discuss medication safety; partner ATP7B genotyping optional (identifies heterozygote risk for infant) (GS 33)
- **Reduce chelator dose 25–50%** in third trimester (to promote wound healing) if cesarean section anticipated; resume pre-pregnancy dose after delivery
- D-Penicillamine: FDA category D (known teratogenic potential — thyroid abnormalities, diffuse cutis laxa in case reports); reduce dose
- Trientine: FDA category C; data sparser; reduce dose; heat-stable tetrahydrochloride form for adherence
- **Zinc: safe in pregnancy**; no dose reduction required; preferred if switching before pregnancy (establish stability on zinc before conception)
- Breastfeeding: weigh benefits vs. harms individually — D-penicillamine excreted into breast milk; zinc excreted at high bioavailability; trientine data limited (GS 35)
- Monitor LFTs each trimester; high-risk obstetrics if portal hypertension present
- See [[liver-disease-in-pregnancy]] for full obstetric management

---

*Cross-references: [[autoimmune-hepatitis]], [[drug-induced-liver-injury]], [[nafld-masld]], [[acute-liver-failure]], [[hereditary-hemochromatosis]], [[primary-biliary-cholangitis]], [[primary-sclerosing-cholangitis]], [[hepatocellular-carcinoma]], [[liver-transplantation]], [[liver-disease-in-pregnancy]], [[abnormal-liver-chemistries]]*
