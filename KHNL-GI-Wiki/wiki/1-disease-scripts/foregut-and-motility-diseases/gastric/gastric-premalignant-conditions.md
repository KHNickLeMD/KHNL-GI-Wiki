...
Histopathologic stages along the Correa cascade that precede gastric adenocarcinoma: atrophic gastritis (AG) → gastric intestinal metaplasia (GIM) → dysplasia (LGD/HGD). H. pylori is the dominant risk factor (attributable risk 75–89%). US 5-year GC survival is 36%; early detection is curative (>95% 5-year survival for early GC).
...
Gastric intestinal metaplasia (GIM)
  ↓  complete → incomplete (higher risk)
...
5. Adequate gastric inspection time — the 2–3 min upper endoscopy is substandard for GPMC evaluation
...
- GIM subtype: complete (type I) vs incomplete (types II/III) vs mixed
- Dysplasia grade: IND, LGD, HGD
...
| ESD appropriate candidate | **Refer to high-volume center** with expertise in gastric neoplasia (Strong/Low) |
...
| All GEP except FGP | Sydney protocol biopsies of surrounding flat mucosa — high GPMC/H. pylori/AIG prevalence (Conditional/Very low) |
