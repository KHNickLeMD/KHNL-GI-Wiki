...
> **2024 paradigm shift** [[acg-2024-hp-treatment]]: Clarithromycin triple therapy (CTT) is **no longer recommended empirically** anywhere in the US (national resistance >15%). BQT is now a **Strong recommendation** as first-line. [[vonoprazan|Vonoprazan]]-based regimens (FDA-approved 2022) are new Strong recommendations.
...
|---|---|---|---|
| **[[bismuth-quadruple-therapy\|Bismuth quadruple therapy (BQT)]]** | PPI bid + bismuth subsalicylate 300 mg (or subcitrate 120–300 mg) qid + metronidazole 500 mg tid–qid (1,500–2,000 mg/day) + tetracycline 500 mg qid | 14 days (≥10) | **Strong** |
...
- **Clarithromycin triple therapy (PPI + CLR + amoxicillin): NOT recommended empirically in the US** — national CLR resistance >15%; use only with confirmed susceptibility
...
|---|---|
| **BQT failure** | Vonoprazan dual/triple OR levofloxacin-based (if susceptible) OR rifabutin triple |
| **Vonoprazan-based failure** | BQT OR rifabutin triple |
| **Two prior failures** | **Susceptibility testing mandatory**; rifabutin triple; individualize |

*Do not repeat a regimen already used — cross-resistance likely.*
...
- Serology: NOT for post-treatment confirmation (cannot distinguish active from past infection)
