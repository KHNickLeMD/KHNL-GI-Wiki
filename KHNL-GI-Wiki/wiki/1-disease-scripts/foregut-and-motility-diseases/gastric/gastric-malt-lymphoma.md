...
- **[[gastric-adenocarcinoma]]** — same presenting symptoms (dyspepsia, weight loss, GI bleeding); **pathologically distinct**, separated only by mucosal sampling. [[asge-2015-gastric-premalignant]]
- **[[helicobacter-pylori-infection|H. pylori]] gastritis without lymphoma** — the underlying driver; present in nearly all MALT cases, so a positive H. pylori test does not itself make the diagnosis. [[asge-2015-gastric-premalignant]]
- **[[gastric-premalignant-conditions|Gastric premalignant conditions]]** ([[atrophic-gastritis|atrophic gastritis]], [[gastric-intestinal-metaplasia|intestinal metaplasia]]) — the other H. pylori-driven mucosal sequelae. [[acg-2024-hp-treatment]]
- **[[subepithelial-lesion|Subepithelial lesions]]** — when the lymphoma presents as a nodular mass rather than erosions. [[asge-2015-gastric-premalignant]]
- **[[peptic-ulcer-disease]]** — the other H. pylori sequela presenting with dyspepsia and bleeding. [[acg-2024-hp-treatment]]

## Diagnostics

| Test | Role |
|---|---|
| **[[upper-endoscopy\|EGD]] with mucosal sampling** | **Establishes the diagnosis.** Endoscopic findings range from subtle erosions to nodular masses — biopsy regardless of appearance [[asge-2015-gastric-premalignant]] |
| **[[helicobacter-pylori-infection\|H. pylori]] testing** | **Required in all cases** — MALT-type marginal zone B-cell lymphoma is a named test-and-treat indication; H. pylori status drives the entire treatment plan [[acg-2024-hp-treatment]] |
...
- **Hold interfering drugs before testing:** PPIs (and possibly [[potassium-competitive-acid-blockers|P-CABs]]), bismuth, and antibiotics reduce the sensitivity of endoscopic tests just as they do non-endoscopic ones — **bismuth and antibiotics for at least 4 weeks** before a test of cure. [[acg-2024-hp-treatment]]
...
- **Failure to confirm cure leaves the patient at continued risk** of peptic ulcer, gastric adenocarcinoma, and gastric MALT lymphoma — which is why test of cure is not optional here. [[acg-2024-hp-treatment]]

### Post-Eradication Surveillance

**Surveillance is required after successful eradication, for two reasons:** complete regression may take a **prolonged period of time**, and there is a **risk of recurrence — with or without H. pylori reinfection**. [[asge-2015-gastric-premalignant]]

| Interval after eradication | Surveillance |
|---|---|
| **First 2 years** | [[upper-endoscopy\|Endoscopy]] + mucosal sampling **every 3–6 months** |
| **Thereafter** | Extend to **every 6–12 months** |

- **The optimal interval has not been defined.** The schedule above is from one large international series reporting low rates of progression on that regimen (median follow-up 42.2 months, range 2–144). [[asge-2015-gastric-premalignant]]

## See Also

[[helicobacter-pylori-infection]], [[gastric-adenocarcinoma]], [[gastric-premalignant-conditions]], [[atrophic-gastritis]], [[gastric-intestinal-metaplasia]], [[upper-endoscopy]], [[endoscopic-ultrasound]], [[dyspepsia]], [[peptic-ulcer-disease]], [[bismuth-quadruple-therapy]], [[subepithelial-lesion]], [[gastric-cancer-screening]]
