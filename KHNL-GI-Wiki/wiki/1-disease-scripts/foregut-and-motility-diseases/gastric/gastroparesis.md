...
created: 2026-05-15
updated: 2026-05-15
sources: [acg-2022-gastroparesis]
---
...
- **Only FDA-approved drug for GP in the United States**
- **Mechanism:** D2 receptor antagonist; also 5-HT4 agonist and 5-HT3 antagonist
- **Dose:** 10 mg oral qid, 30 minutes before meals and at bedtime; intranasal 10–14 mg qid also available
- **Duration:** FDA-restricted to <12 weeks; not recommended in patients ≥65 years
- **Black Box warning:** tardive dyskinesia (TD)
  - Actual risk: ~0.1 per 1,000 patient-years (far lower than prior estimates of 1%–10%)
  - High-risk groups: elderly women, diabetics, renal/hepatic insufficiency, concurrent antipsychotics
  - Reversible extrapyramidal reactions reported in ~0.1% of prescriptions
...
- **Available in the US only under FDA expanded access program** (off-label; not FDA-approved)
...
- **Short-term use only (1–4 weeks):** tachyphylaxis develops rapidly
- **IV dosing:** 200–250 mg IV — dramatically accelerates GE (solid retention at 2h: 63% → 4%)
- **Oral dosing:** 250 mg tid or 500 mg tid (with meals and at bedtime)
- **Azithromycin IV:** equivalent GE acceleration to erythromycin IV; may have less QTc risk
- **Macrolide cardiovascular safety:** SRMA (33 studies, 22.6 million patients) — no increase in arrhythmia or cardiovascular mortality
- **Use context:** Acute/hospitalized GP (IV), or short bridge therapy (oral)

#### 5-HT4 Agonists (Conditional, Low Evidence)

- **Prucalopride 2 mg/d** (Carbone 2019, RCT): significant improvement in GCSI total and all subscales + GE T½ — but benefit confined to idiopathic GP subgroup
...
- Provide symptom relief (nausea, vomiting) but do NOT improve GE (GRADE Conditional, Low evidence)
...
- **Aprepitant (NK1 antagonist):** reduced secondary symptom outcomes in one RCT but not primary nausea outcome
...
| Agent | Recommendation | Strength | Rationale |
|---|---|---|---|
| Central neuromodulators (TCAs, nortriptyline) | NOT recommended | Strong | Nortriptyline = placebo in 130 IG patients (RCT); high discontinuation rate |
| Ghrelin agonists (relamorelin) | NOT supported | Strong | Failed primary endpoints in phase 3 RCTs; impairs glycemic control in DM |
| Haloperidol (routine use) | NOT supported | Conditional | Single-dose ED use reduces acute pain/nausea; no evidence for chronic GP management |
| Herbal therapies (Rikkunshito, STW5/Iberogast) | NOT recommended | Conditional | Insufficient evidence; STW5 data primarily in FD, not GP |
| Intrapyloric botulinum toxin | NOT recommended | Strong | 2 negative RCTs; no benefit over placebo in unselected patients |

### 7. Pyloric Therapies

#### G-POEM (Gastric Per-Oral Endoscopic Myotomy) — Preferred Pyloric Intervention

- **Indication:** medically refractory GP (GRADE Conditional, Low evidence)
- **Mechanism:** Full-thickness myotomy of the pyloric sphincter via submucosal tunneling
- **Results from pooled open-label data (n=276, 14 studies):**
...
- **Sham-controlled RCT** (Vosoughi 2021, n=80): G-POEM superior to sham at 3 months
...
#### Laparoscopic Pyloroplasty (LP)

- Heineke-Mikulicz technique: longitudinal incision, transverse closure
- Improved GE in 90% and short-term symptom improvement in 177-patient series
- Morbidity rate ~6.8%; G-POEM largely replaces LP as preferred approach
- Comparable to G-POEM in RCT/propensity-matched data

#### Intrapyloric Botulinum Toxin (BTX)

- NOT recommended based on 2 negative RCTs (GRADE Strong, Moderate evidence)
