---
title: "Cyclic Vomiting Syndrome (CVS)"
...
- [[#Assessment]]
  ...
  - [[#Severity Assessment]]
  - [[#Phases]]
  - [[#Clinical Clues and Comorbidities]]
...
| **Moderate–severe** | ≥4 episodes/yr, each >2 days, **≥1** ED visit or hospitalization | **Prophylactic + abortive therapy** |
| **Coalescent CVS** | Worsening trajectory → loss of "well periods," may meet chronic nausea vomiting syndrome criteria (history of prior episodic pattern distinguishes it) | Prophylaxis akin to moderate–severe |

### Phases

Four phases — recognizing the phase guides treatment (see Figure 1 of [[aga-2024-cvs]]):
1. **Inter-episodic** (well interval) — trigger mitigation + prophylaxis.
2. **Prodromal** (~65% of patients, median 1 h) — **ideal window for abortive therapy** (earlier = higher abort probability).
3. **Emetic** — uncontrollable retching/vomiting for hours–days; abortive + supportive care, rehydration.
4. **Recovery** (~1–2 days) — electrolyte-rich/nutrient fluids.
...
Goal: lengthen the inter-episodic phase and/or reduce emetic severity.
...
- Treat all patients regardless of CHS suspicion.
- **IV dextrose-containing fluids** + **IV antiemetics** for most patients.
- **IV ketorolac = first-line non-narcotic analgesic**; narcotics only in the most severe refractory episodes.
- Sedation is a goal in itself — quiet, dark room + IV benzodiazepines.
