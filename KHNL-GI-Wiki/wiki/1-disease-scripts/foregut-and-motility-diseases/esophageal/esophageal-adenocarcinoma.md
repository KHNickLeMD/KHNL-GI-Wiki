...
For invasive and advanced disease, EAC is staged and treated on the [[esophageal-cancer|esophageal/EGJ cancer]] oncologic pathway ([[nccn-2026-esophageal-egj-cancer]]): perioperative **FLOT** (± durvalumab in selected tumors) with esophagectomy for resectable locally advanced disease, and biomarker-directed systemic therapy for metastatic disease (HER2 → trastuzumab; PD-L1 CPS → nivolumab/pembrolizumab; MSI-H/dMMR → immunotherapy; later-line HER2+ → trastuzumab deruxtecan).
