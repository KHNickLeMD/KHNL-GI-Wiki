...
- Also document: location of diaphragmatic hiatus, GEJ, squamocolumnar junction (SCJ)

**Dysplasia grading (histopathologic):**

| Grade | Definition | Key requirement |
|---|---|---|
| NDBE | Intestinal metaplasia, no dysplastic features | — |
| IND (Indefinite for Dysplasia) | Unable to exclude dysplasia vs. inflammation | Confirm with expert GI pathologist; intensify PPI |
...
4. Adjust insufflation/desufflation for subtle lesion detection
5. Spend adequate time on Barrett's segment and cardia (in retroflexion)
6. High-definition white light endoscopy
7. Chromoendoscopy (acetic acid or virtual chromoendoscopy)
8. Use Prague criteria to describe segment length
9. Use Paris classification for any visible lesions
10. Seattle protocol with partially deflated esophagus
...
- **[[endoscopic-ultrasound|EUS]]:** Not routinely indicated for HGD, LGD, or early EAC referred for EET (low accuracy for T1a vs T1b). Indicated for T1b EAC with suspected deeper invasion or lymphadenopathy, and in select T1a cases with high-risk features.
- **CT/PET:** For staging more advanced EAC (T1b and beyond).
...
- Chronic GERD symptoms (weekly for ≥5 years) PLUS ≥3 of the following risk factors:
  - Male sex
  - Age >50 years
  - White race (reflects European ancestry genomics, a recognized limitation)
...
- **Cryotherapy** — acceptable alternative, especially RFA-refractory cases
  - Spray cryotherapy (liquid nitrogen, truFreeze): CED 81–88%, CEIM 57–61%
  - Cryoballoon (liquid nitrous oxide, C2CryoBalloon): CED 76%, CEIM 72%
...
- Shared decision making: discuss EET risks (stricture, procedure-related) vs surveillance with risk of missing progression

### Post-CEIM Surveillance

CEIM defined as: 1–2 surveillance endoscopies with no visible BE and no IM on biopsies from GEJ and tubular esophagus.
