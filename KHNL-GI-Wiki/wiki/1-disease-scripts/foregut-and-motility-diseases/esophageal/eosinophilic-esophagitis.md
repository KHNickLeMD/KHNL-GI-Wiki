...
|---|---|
| GERD | No eosinophils on biopsy or responds to PPI (but PPI response ≠ exclude EoE) |
| Proton pump inhibitor-responsive esophageal eosinophilia (PPIREE) | Now considered subset of EoE, not separate entity |
| Achalasia / motility disorders | Manometry abnormal; esophageal body aperistalsis |
...
| Celiac disease | Duodenal findings; anti-TTG; responds to gluten-free diet |
| IBD (Crohn's) | Perianal, small bowel involvement; colonoscopy findings |
