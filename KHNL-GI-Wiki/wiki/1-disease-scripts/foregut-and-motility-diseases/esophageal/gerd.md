...
| Post-procedural GERD | De novo GERD post-SG or post-POEM; distinct surveillance protocols apply |
...
- Systematic documentation and photo-documentation of:
  ...
  - Prague C&M classification of any Barrett's segment
  - Hiatal hernia axial length (cm)
  - Hill grade or AFS grade of GEJ flap valve (forward view and retroflexion)
  - Z-line, top of gastric folds, diaphragmatic impression
  - Fundoplication status if prior surgery
...
- Role in GERD: primarily to assess GEJ integrity and exclude major motility disorder (achalasia, absent contractility) before anti-reflux surgery or TIF — see [[high-resolution-manometry]]
- See [[hrm-antireflux-surgery]] and [[flip-panometry]] for detailed pre-procedural assessment
...
Recommend for all patients with GERD symptoms:
...
1. Optimize PPI compliance and administration timing (30–60 min before meals)
2. pH monitoring **off PPI** if GERD diagnosis uncertain
3. Impedance-pH monitoring **on PPI** if GERD diagnosis established but symptoms persist
4. **Stop PPI** if on-therapy testing is negative for reflux
5. HRM before any anti-reflux procedure
6. No additional medical therapies recommended over established PPI use (Conditional/Moderate)

### Monitoring

- Barrett's esophagus surveillance: if detected on any endoscopy (including post-SG), follow existing BE surveillance guidelines
- Post-SG asymptomatic: repeat EGD at 3 years then every 5 years
- Post-POEM: periodic endoscopy even in asymptomatic patients (best practice advice)
- Long-term PPI users (>6 months): reassess need; attempt de-escalation; document ongoing indication
- Post-TIF: symptom reassessment; repeat pH study if symptoms recur or inadequate response

---

## See Also

[[barretts-esophagus]], [[eosinophilic-esophagitis]], [[achalasia]], [[laryngopharyngeal-symptoms]], [[ambulatory-reflux-monitoring]], [[high-resolution-manometry]], [[hrm-antireflux-surgery]], [[flip-panometry]], [[antireflux-surgery]], [[vonoprazan]], [[upper-endoscopy]], [[asge-2024-gerd]], [[acg-2021-gerd]], [[sages-2021-gerd-surgery]], [[lyon-2024-gerd-diagnosis]]
