...
**"Ineffective swallow" is any one of three patterns** (CCv4.0 diagnostic thresholds) — the third is easy to miss and is the one that used to be its own disorder:

| Pattern | Definition |
|---|---|
| **Weak contraction** | DCI **≥100 and <450** mmHg·s·cm |
| **Failed peristalsis** | DCI **<100** mmHg·s·cm |
| **Fragmented swallow** | Transition-zone defect of peristalsis **>5 cm** under the **20 mmHg** isobaric contour, **in the setting of a DCI ≥450** mmHg·s·cm |

(For contrast: normal contraction = DCI 450–8,000 mmHg·s·cm.)
