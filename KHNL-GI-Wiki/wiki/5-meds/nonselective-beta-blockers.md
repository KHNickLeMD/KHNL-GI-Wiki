---
title: "Nonselective Beta-Blockers (NSBBs)"
category: med
...
```mermaid
flowchart TD
    A["Compensated cirrhosis / cACLD"] --> B{"LSM ≤15 kPa<br/>AND platelets ≥150 ×10⁹/L?"}
    B -->|"Yes"| C["CSPH ruled out<br/>No NSBB — repeat NITs in 12 months"]
    B -->|"No"| D{"ANTICIPATE / NICER ≥75%<br/>OR LSM ≥25 kPa<br/>OR SSM (100 Hz) >55 kPa<br/>OR varices / collaterals / decompensation?"}
