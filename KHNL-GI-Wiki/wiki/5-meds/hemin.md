...
- **Prophylaxis:** off-label prophylactic IV hemin for recurrent attacks (≥4/year).
- **Adverse effects / monitoring:** chronic hemin (9% iron by weight) can cause secondary [[iron-overload-and-iron-metabolism|iron overload]] with liver fibrosis. On ≥monthly prophylactic hemin, monitor ferritin and iron every 3–6 months; consider therapeutic phlebotomy if ferritin >1000 ng/mL.
