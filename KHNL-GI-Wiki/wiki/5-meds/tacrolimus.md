...
Per [[aasld-ast-2025-liver-transplant-graft-complications]] (Table 4):
...
## Indications in Liver Transplantation

**Monotherapy** (Rec 29, Strong, Level 3): Tacrolimus monotherapy should be considered as maintenance IS in patients at low risk for rejection (non-immune-mediated liver disease) from 3 months post-LT; similar graft survival vs. combination therapy. BPAR rates: 2.6% TAC monotherapy vs. 3.5% TAC/MMF (NS).

**Combination therapy** (Rec 30, Strong, Level 3): TAC + antimetabolite (MMF) or mTOR inhibitor preferred when CNI reduction needed (adverse effects: renal dysfunction, neurotoxicity, DM). TAC + MMF + reduced TAC dose improves renal function without increasing graft rejection vs. standard-dose TAC.

**HCC recipients** (Rec 32, Weak, Level 3): Consider adding/converting to mTOR inhibitor (sirolimus or everolimus) to reduce HCC recurrence, particularly for within-Milan criteria recipients (see [[hepatocellular-carcinoma]]).

**CNI nephrotoxicity** (Rec 33, Strong, Level 2): Convert from TAC to or add mTOR inhibitor early (~3 months post-LT) to prevent CKD progression. Early implementation produces the best renal outcomes.
...
[[calcineurin-inhibitors]], [[liver-transplantation]], [[hepatocellular-carcinoma]], [[aasld-2012-liver-transplant-long-term]], [[aasld-ast-2025-liver-transplant-graft-complications]]
