---
title: "Mesalamine and the 5-Aminosalicylates (5-ASA)"
category: med
...
```mermaid
flowchart TD
    A["Mildly to moderately<br/>active UC"] --> B{"Extent?"}
    B -->|"Proctitis"| C["Rectal 5-ASA<br/>suppository 1 g/day"]
    B -->|"Left-sided"| D["Rectal 5-ASA enema ≥1 g/day<br/>+ oral 5-ASA ≥2.0 g/day"]
    B -->|"Extensive"| E["Oral 5-ASA ≥2.0 g/day"]
    C --> F["Reassess response<br/>within 8 weeks"]
    D --> F
    E --> F
    F -->|"No response<br/>or intolerant"| G["Treat as moderate-to-severe<br/>— do NOT switch 5-ASA formulation"]
```
