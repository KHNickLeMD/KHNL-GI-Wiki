...
- **On-demand / intermittent** PPI for heartburn control in **NERD** (non-erosive reflux disease) — Conditional/Low; symptom-free days equivalent to continuous therapy, both superior to placebo. On-demand is **not** adequate for erosive esophagitis.
- **Step-down to H2RA** is an acceptable option, particularly in NERD.
- Rebound acid hypersecretion demonstrated in healthy controls, but **strong evidence for increased symptoms after abrupt withdrawal is lacking**.
