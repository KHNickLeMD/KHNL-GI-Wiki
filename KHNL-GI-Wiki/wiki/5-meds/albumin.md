...
**Ascites without LVP or SBP (why BPA 6 says no)**
- Albumin did **not** enhance the diuretic effect of furosemide (crossover RCT); a 126-patient unblinded RCT showed faster ascites resolution and less recurrence but **no survival benefit and not cost-effective**.
- Chronic weekly albumin: ANSWER (n=431, persistent ascites) lowered 18-month mortality, LVP need, hyponatremia, SBP and HRS-AKI — but unblinded and not placebo-controlled; the placebo-controlled MACHT trial (albumin + midodrine) found **no difference** in mortality or ascites complications.
- ATTIRE (n=777 inpatients, new/worsening ascites; albumin dosed to maintain a serum albumin level of 3.0 throughout admission — the CPU prints the unit as "g/L", an apparent typo for g/dL): **no effect** on infection, AKI, or death, and **more pulmonary edema** in the albumin arm (which received 10× the albumin of controls).
- Net: the outpatient/inpatient population that benefits from albumin **beyond LVP, SBP, and AKI remains undetermined**.
