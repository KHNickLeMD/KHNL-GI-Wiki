...
> **Stub — pending a primary source.** A full synthesis (CD4-count stratification, the opportunistic-infection differential, and the pathogen-directed treatment table) requires a primary HIV opportunistic-infection guideline (e.g., a CDC/NIH/IDSA or BHIVA OI guideline). None is currently in this wiki's `raw/` folder, so that content has been intentionally left out rather than sourced from review articles. See the note at the bottom.
...
> **Note:** This page previously contained a CD4-stratified differential and pathogen-directed treatment table compiled from review articles. That secondary-sourced content was removed per your sourcing rule. To rebuild a complete synthesis, add a primary HIV/GI opportunistic-infection guideline PDF to `raw/` (or grant explicit permission to use secondary literature for this page).
