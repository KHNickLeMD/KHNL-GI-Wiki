---
title: "Subepithelial Lesion (SEL)"
...
| Lesion | Typical Location | EUS Layer(s) | Malignant Potential | Tissue Needed? |
|---|---|---|---|---|
...
| Metastasis | Anywhere | Any/extrinsic | Already malignant | Yes |

**MM** = muscularis mucosa; **SM** = submucosa; **MP** = muscularis propria

### By EUS Echogenicity

| EUS Pattern | Typical Entities |
|---|---|
...
4. **Margins** (smooth vs. irregular)
5. **Internal characteristics** (anechoic foci, echogenic foci, cystic spaces)
...
| CT/MRI with contrast | Large lesions, staging, surgical planning | Inferior to EUS for small lesions; useful for GIST >2 cm or neoadjuvant decisions |
| High-frequency miniprobe EUS | Small SEL precluding standard tissue acquisition | 80–93% accuracy; limited depth and no Doppler/biopsy capability |
| Endoscopy alone | Lipoma identification (pillow sign) | 99% specificity, 40% sensitivity for lipoma; not reliable for other SEL |
...
Presence of ≥2 of: irregular border, echogenic foci, cystic spaces → malignancy sensitivity 80–100% for GIST. Absence of all three → malignancy in only 0–11%.

**Important caveat:** EUS features (other than size) do not reliably predict mitotic index in 2–5 cm GIST. Tumor size is the only EUS parameter correlated with higher mitotic rate.
...
- **Site changes the stratum at identical size and mitotic rate.** Small-intestine GISTs are **more aggressive — 40–50% malignant vs 20–25% gastric**; non-gastric/non-small-bowel GISTs are treated like small-intestine lesions ([[asge-2017-subepithelial-lesions]]). This is why *all* nongastric GISTs are resected regardless of size (table above).
- **EUS-FNA cannot assess mitotic rate** — final risk is set by surgical pathology.
