...
- Dengue with hepatitis (transaminase elevation common)
- Malaria with hepatitis (Plasmodium falciparum)
...
- Visceral leishmaniasis (kala-azar): massive splenomegaly, weight loss, pancytopenia

## Diagnostic Algorithm

1. **Exposure history**: Destination(s), travel duration, freshwater exposure, animal contact, food/water sources, sexual exposures, vector exposure (mosquitoes, ticks), vaccination status (hepatitis A/B, typhoid, yellow fever)
2. **Incubation period**: Date of symptom onset relative to travel; use to narrow differential (see table above)
3. **Symptom characterization**: Diarrhea (bloody vs. watery), jaundice, hepatosplenomegaly, rash, CNS symptoms
4. **Malaria rule-out first** (even if GI-dominant): Thick and thin blood smears × 3 or rapid malaria antigen test — mandatory in any febrile traveler from endemic region regardless of prophylaxis
5. **Targeted workup** based on leading diagnosis (see Key Tests)
6. **Empiric treatment** rarely indicated before diagnosis in stable patients — exception is severe sepsis presentation where empiric coverage for enteric pathogens (ceftriaxone) is reasonable

## Key Tests

| Test | Diagnoses Targeted |
|------|------------------|
| Thick/thin blood smear × 3 or malaria RDT | Malaria (mandatory) |
| Stool culture (Salmonella, Shigella, Campylobacter, E. coli) | Bacterial diarrhea |
| Stool ova and parasites × 3 | Giardia, Entamoeba histolytica, helminths |
| Stool Giardia antigen EIA | Giardiasis (more sensitive than O&P) |
| Stool Entamoeba histolytica antigen | Amoebiasis (distinguishes from E. dispar) |
| Hepatitis A IgM | Acute hepatitis A |
| Hepatitis E IgM + RNA | Acute hepatitis E (especially Asia/Africa travel) |
...
| Leptospira serology (MAT) or PCR | Leptospirosis |

## Red Flags / Alarm Features

- **Malaria not ruled out**: Any febrile traveler from endemic area requires malaria testing — Plasmodium falciparum can be rapidly fatal
- **Altered mental status**: Cerebral malaria, typhoid encephalopathy, severe dengue — emergent evaluation
