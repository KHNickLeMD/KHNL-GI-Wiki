...
| Grade | Clinical Finding | Treatment Category |
|-------|-----------------|-------------------|
...
|------|---------------------------|
| Ascitic fluid PMN count | ≥250 cells/mm³ = SBP (see [[spontaneous-bacterial-peritonitis]]) |
| SAAG | ≥1.1 g/dL = portal hypertension |
| Ascitic protein | >2.5 g/dL supports cardiac source; <1.5 g/dL = risk factor for SBP |
| Ascitic culture | Bedside blood culture bottles; sensitivity >90% with ≥10 mL |
| Spot urine Na/K ratio | >1 → adequate natriuresis (patient should be losing weight); ≤1 → insufficient diuresis |
| 24-hour urine sodium | <80 mmol/day = insufficient natriuresis (if patient not losing weight, consider dietary noncompliance) |
...
|------|--------------|-------------|-------|
| Spironolactone | 100 mg/day | 400 mg/day | First-line for first episode; dose changes q72h (long half-life); painful gynecomastia → switch to eplerenone (50 mg per 100 mg spiro) or amiloride (10 mg per 100 mg spiro) |
| Furosemide | 40 mg/day | 160 mg/day | Add for long-standing ascites; combine with spironolactone |
| Torsemide / bumetanide | — | — | Alternative loop diuretics if suboptimal furosemide response |
...
| Severity | Serum Na (mEq/L) | Management |
|----------|-----------------|-----------|
| Mild | 126–135 | Monitor; water restriction |
| Moderate | 120–125 | Fluid restriction 1,000 mL/day + diuretic cessation |
