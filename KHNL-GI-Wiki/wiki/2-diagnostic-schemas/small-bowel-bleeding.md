...
| **Occult SBB** | Iron-deficiency anemia ± guaiac-positive stools with confirmed small bowel source |
...
4. If negative → consider RBC scan and/or angiography or surgery ± IOE.
...
- SBE: comparable to DBE in most studies; no distal balloon limits total enteroscopy rate.
...
- CTA preferred over CTE in brisk active overt bleeding. *(Conditional/Very Low)*
...
- IOE should be available at time of surgery. *(Conditional/Low)*
