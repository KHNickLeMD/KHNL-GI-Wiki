---
title: "Extraesophageal Reflux (EER)"
...
**Extraesophageal reflux (EER)** = symptoms or conditions of the airway/larynx/oropharynx suspected to be caused or aggravated by retrograde flow of gastric contents — laryngitis, chronic cough, asthma, and dental erosions being the classic quartet. EER is a *suspicion*, not a diagnosis: **no single test conclusively proves that gastroesophageal reflux (GER) causes extraesophageal symptoms**, and **50–60% of patients with EER symptoms do not have [[gerd|GERD]]** and will not respond to anti-reflux therapy.
...
*Workup: this page is the schema. For the laryngeal-specific workup, see [[laryngopharyngeal-symptoms]].*

Conditions commonly attributed to EER, each with a large non-reflux differential (AGA 2023, Table 1):

| EER manifestation | Non-reflux differentials to exclude | Collaborating specialty |
|---|---|---|
| Chronic cough | Upper-airway cough syndrome/post-nasal drip, asthma, ACE inhibitor, non-asthmatic eosinophilic bronchitis, [[laryngopharyngeal-symptoms\|vagal hypersensitivity]] | Pulmonology, allergy |
| Laryngitis / hoarseness / dysphonia | Vocal fold lesions, muscle tension dysphonia, malignancy, [[laryngopharyngeal-symptoms\|laryngeal hyperresponsiveness]] | Otolaryngology |
| Asthma | Intrinsic/allergic asthma, vocal cord dysfunction | Pulmonology, allergy |
...
[[gerd]], [[laryngopharyngeal-symptoms]], [[ambulatory-reflux-monitoring]], [[reflux-testing]], [[upper-endoscopy]], [[antireflux-surgery]], [[proton-pump-inhibitors]], [[barretts-esophagus]], [[hiatal-hernia]], [[dysphagia]], [[esophageal-cancer]]
