...
- **Benign:** [[hepatic-hemangioma|hemangioma]] (most common), [[focal-nodular-hyperplasia|FNH]], [[hepatocellular-adenoma|hepatocellular adenoma]], [[hepatic-cysts|simple/complex cyst]].
- **Malignant:** [[hepatocellular-carcinoma|HCC]], metastasis, [[cholangiocarcinoma|intrahepatic cholangiocarcinoma]], fibrolamellar HCC.
...
- Background **cirrhosis** or chronic liver disease.
- Known extrahepatic **malignancy** (favor metastasis).
- **Arterial hyperenhancement + washout** (HCC pattern).
- **Interval growth**, large size (>5 cm), or atypical/indeterminate features.
- **Elevated AFP** with a hepatocellular lesion (suspect HCC / malignant transformation of HCA).
