---
title: "G-POEM (Gastric Peroral Endoscopic Myotomy)"
...
- Scale **0 (none) – 5 (very severe)**, 2-week recall, 9 symptoms in 3 subscales:
  - Nausea/vomiting (3 items), postprandial fullness/early satiety (4 items), bloating (2 items).
- **Total = average of the 3 subscale means.** Moderate-to-severe disease often corresponds to **GCSI total >2**.
...
- Most **post-infectious gastroparesis** — usually self-limited; **should not be offered G-POEM**.
- **Abdominal-pain-predominant** symptoms — less likely to respond.
- **Nonselective use should be discouraged.**
...
1. Submucosal bleb **4–5 cm proximal to the pylorus**, typically **greater curvature** (saline + ~0.25% indigo carmine/methylene blue).
2. Longitudinal or transverse **1.5–2 cm mucosal incision**.
3. Submucosal **tunnel** by repeated injection/dissection until the **pyloric ring is exposed** (blended-cutting for incision, blended-coagulation for tunnel; hemostatic forceps for large vascular complexes; intermittent stomach deflation reduces looping).
4. **Single myotomy** extended **1–3 cm proximally into the antrum**; insulated-tip knife may widen the safety margin in difficult cases / early learning curve. **At minimum incise the inner circular muscularis;** authors advise **full-thickness pyloromyotomy of circular and oblique bundles with serosal preservation** (do not breach serosa).
5. **Close** the mucosal incision with endoscopic **clips or suturing**. Fluoroscopy optional.

**Variations:**

- **Lesser-curvature approach** — similar outcomes, but pyloromyotomy is more challenging.
- **Double myotomy** (2nd incision near the 1st) — superior to single myotomy at 6 months in a single study; technically easy, adds little time, but **needs more long-term data before being deemed routinely necessary**.
...
- Clinic follow-up ~**1–3 months**; **repeat solid-phase GES no sooner than 4–8 weeks**; obtain **GCSI before G-POEM and at each visit**.
- **Clinical success:** total GCSI decrease **≥1**, typically with **>25% decrease in ≥2 subscales**.
- **Recurrence:** return of symptoms with GCSI back to baseline or **≥3** after an initial response.
- Desirable signs: relief of nausea/vomiting, larger meals, weight gain.
...
- Overall **6.2%–14%**, most mild, when done by trained/experienced endoscopists — but serious AEs occur.
- Prospective n=80: **6.2%, all mild** — capnoperitoneum ×3 (needle decompression), mucosotomy ×1 (stented), thermal mucosal injury ×1 (clipped).
- Retrospective n=216: **14%** (77% mild / 16% moderate / 6% severe); most common abdominal pain, then mucosotomy, capnoperitoneum; 2 severe = pain → negative laparoscopy, and a 2-mm perforation → laparoscopic omental patch.
- Retrospective n=374: **8.6%; bleeding most common** (all managed endoscopically/conservatively). Also reported: gastric ulceration, dumping syndrome.

## After Failed G-POEM

- A sizable minority will not respond. **Redo G-POEM is very challenging** (dense fibrosis) with sparse data.
- Gastric electrical stimulation may be attempted if not already failed (no published guidance).
- **No proven medical or minimally invasive salvage strategy** → set realistic expectations, refine selection; intraprocedural impedance planimetry may gauge myotomy adequacy.

## Comparison with Alternatives

| Comparator | Finding |
|---|---|
| **Laparoscopic pyloroplasty** (propensity-matched 30 vs 30) | Pyloroplasty: longer stay (4.6 vs 1.4 d), longer operative time (99.3 vs 33.9 min), more AEs (16.7% vs 3.3%) — comparable function, **less morbidity with G-POEM** |
| **Surgical pyloroplasty** (meta-analysis, 332 vs 376) | Pooled GCSI success **76% vs 77%** (NS); comparable AEs |
| **Gastric electrical stimulation** (propensity-matched 23 vs 23) | G-POEM **better and longer-lasting** response |

*Coverage: many insurers still consider G-POEM investigational; the CPU argues safety/effectiveness are now well supported.*
