...
Radiofrequency ablation (RFA) delivers controlled thermal energy to destroy a thin layer of diseased mucosa — or, in solid organs, tumor tissue — while sparing deeper layers. In luminal GI it is the **preferred primary ablative modality** within [[endoscopic-eradication-therapy|endoscopic eradication therapy]] for flat dysplastic [[barretts-esophagus|Barrett's esophagus]] (widest evidence base — [[acg-2022-barretts|ACG 2022]]). It is also used for bleeding chronic [[radiation-proctopathy]] and, intraductally, for malignant biliary obstruction.
...
| Bleeding chronic radiation proctopathy | Suggested option alongside APC, bipolar electrocoagulation, heater probe — no modality shown superior (Rec 1) | [[asge-2019-radiation-proctopathy]] |
...
*Evidence caveat: intraductal RFA trial data come predominantly from **extrahepatic** stricture populations — the perihilar evidence is less robust than for PDT ([[acg-2023-biliary-strictures]]).*
...
- Bipolar RF catheter passed at [[ercp|ERCP]] across the malignant stricture, then **plastic stent** placement (stent must be removable if repeat ablation is planned).
- Used with systemic therapy for unresectable perihilar disease — see [[biliary-stricture]].
