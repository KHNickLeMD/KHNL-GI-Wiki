...
Surgery is **not** for undifferentiated heartburn — GERD must be objectively confirmed first (see [[reflux-testing]]).
...
The hiatal hernia size + Hill grade pair is the operative decision point ([[asge-2024-gerd]]):
...
Adults with confirmed chronic/refractory GERD — 15 RCTs ([[sages-2021-gerd-surgery]]):

| Outcome | Result favoring surgery |
|---|---|
| % time with abnormal pH | 2.11% less |
| Long-term symptom control | 79.2% vs 62.6% |
| Still on PPI at long-term follow-up | **25% surgical vs 72% medical** |
| Treatment failure (reoperation) | 2.4% less |

- **Harms:** complication rate 10.5% vs 7.5%; **12% more gas-bloat** symptoms.
...
All conditional recommendations — outcomes are broadly equivalent, so these are **shared-decision-making trade-offs** ([[sages-2021-gerd-surgery]]):
...
- **Gas-bloat** is the signature adverse effect: 12% more than medical management; worsened by short gastric division at 10–20 y.
- **Dysphagia** is the signature trade-off of a complete wrap.
- Post-ARS [[gerd|GERD]] recurrence, slipped/herniated wrap, and post-fundoplication outflow obstruction (PFOO) → see [[hrm-antireflux-surgery]].
...
1. [[sages-2021-gerd-surgery|SAGES 2021 Guidelines for Surgical Treatment of Gastroesophageal Reflux (GERD)]]
