...
Versus standard of care/lifestyle alone (pooled RCTs):

- Greater weight loss at 6, 9, and 12 months, with **benefit declining over time** (~15.5 lbs at 6 mo → ~9.8 lbs at 12 mo).
- **%TBWL** greatest at 6–8 mo (MD 6.89%); percent excess weight loss greatest at 9 mo (MD 20.43%).
- **≥5% TBWL** in 85.1% vs 34.6% (RR 2.44); **≥10% TBWL** in 61.9% vs 13.7% (RR 4.31) at 6–8 mo.
- Improves HbA1c, fasting glucose, transaminases (ALT −9 U/L, AST −3 U/L), waist circumference (−4.1 cm), and remission of diabetes, hypertension, and dyslipidemia.

**Concomitant lifestyle modification** is strongly recommended (Rec 2, strong, moderate certainty): moderate- to high-intensity diet (e.g. very-low-calorie ketogenic) augments and sustains weight loss.
...
- Post-marketing surveillance: rare **hyperinflation, acute pancreatitis, and death**.
- **Early removal in 9.4%**, most often for device/symptomatic intolerance (fullness, epigastric pain, reflux, nausea, emesis).

## After Removal

AGA suggests subsequent weight-loss/maintenance interventions — **dietary intervention, pharmacotherapy, repeat (sequential) IGB, or [[bariatric-surgery]]** — chosen by shared decision-making (Rec 7, conditional, low certainty). Sequential IGB gives greater BMI reduction (MD 5.49 kg/m²) but more complications; post-IGB pharmacotherapy (e.g. liraglutide 3 mg, sibutramine) maintained or added to weight loss; IGB can also serve as a bridge before bariatric surgery.
