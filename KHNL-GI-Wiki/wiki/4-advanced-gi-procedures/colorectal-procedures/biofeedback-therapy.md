...
- **Not** a substitute for surgery in proven dyssynergia with a structural abnormality — surgery is reserved for biofeedback failure **and** a structural lesion (e.g. significant rectocele).

---

## Protocol

The dyssynergic defecation course comprises ([[acg-2021-anorectal-disorders]]):

1. Education
2. Abdominal breathing
3. Manometric-guided relaxation
4. Balloon expulsion retraining
...
- Requires objective anorectal physiology testing first: **[[anorectal-manometry|ARM]] + balloon expulsion test (BET)** are required to diagnose a defecation disorder and to identify biofeedback candidates in levator ani syndrome ([[acg-2021-anorectal-disorders]]).
- Digital rectal examination is recommended in all patients with suspected defecation disorder — **75% sensitivity, 87% specificity** for dyssynergia.
...
- **Levator ani syndrome:** the Strong recommendation rests on a **single key RCT** with no independent replication in 10 years — the guideline itself flags this ([[acg-2021-anorectal-disorders]]).
- Availability of trained therapists and manometric equipment limits delivery; galvanic stimulation is the named fallback for levator syndrome only.
