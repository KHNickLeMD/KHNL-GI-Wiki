...
## Key Principle — Not for IE
- **Do not give antibiotic prophylaxis solely to prevent infective endocarditis (IE)** for any GI endoscopic procedure, regardless of cardiac lesion (aligns with AHA).
...
- **Exception:** high-risk cardiac patients with an **established GI infection** in which enterococci may be part of the flora may receive coverage — directed at treating the infection, not the procedure.
...
- **Orthopedic prostheses** — any procedure (AAOS blanket-prophylaxis statement was withdrawn for lack of evidence).
...
| Peritoneal dialysis | Lower GI endoscopy | **Suggested** | 44BB |
