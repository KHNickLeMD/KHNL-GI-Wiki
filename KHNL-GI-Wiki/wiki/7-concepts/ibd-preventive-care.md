...
Patients with IBD ([[crohns-disease]] and [[ulcerative-colitis]]) require proactive health maintenance beyond GI disease management. More than 70% of IBD patients will at some time be on immune-modifying therapy, significantly elevating the risk of vaccine-preventable infections, certain malignancies, and osteoporosis. Gastroenterologists should not assume primary care manages these issues — verification, documentation, and administration at GI visits is expected.
...
| Rotavirus (live) | Infants with in-utero biologic exposure | Conditionally offered after specialist discussion |
...
- Screen all IBD patients (CD and UC) for depression and anxiety at baseline and annually
...
- Counsel all IBD patients who smoke to quit
- Note: smoking has divergent effects by disease — protective in UC but accelerates CD (do not use this to suggest continued smoking in UC)
