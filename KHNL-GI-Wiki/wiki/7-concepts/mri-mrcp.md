...
Magnetic resonance imaging (MRI) and magnetic resonance cholangiopancreatography (MRCP) are noninvasive cross-sectional modalities for the pancreaticobiliary system. MRCP uses heavily T2-weighted sequences to image the pancreatic and bile ducts without contrast or instrumentation, while contrast-enhanced MRI characterizes solid and cystic pancreatic lesions and liver disease.
