---
title: "Hepatic Venous Pressure Gradient (HVPG)"
category: concept
...
Baveno VII methodology statements ([[baveno-vii-2022-portal-hypertension]], 1.1–1.8):

- **Catheter:** end-hole, compliant **balloon-occlusion** catheter (reduces random error of WHVP) — preferred over a straight catheter (1.1).
- **Confirm occlusion:** inject a small volume of contrast with the balloon inflated to confirm a satisfactory wedged position and **exclude hepatic veno-venous communications** (1.2); such communications underestimate WHVP and must be reported (1.3).
- **Tracings:** slow-speed (≤7.5 mm/s) **permanent** tracings (paper or electronic); on-screen digital readings are much less accurate and should not be used (1.5).
...
- In alcohol-related or viral cirrhosis, a **decrease in HVPG in response to NSBBs** is associated with a significant reduction in variceal bleeding and other decompensating events (Baveno VII 1.14).
- **What counts as an HVPG response to an NSBB — the numbers** (Baveno VI, reprinted in the [[baveno-viii-2026-portal-hypertension|Baveno VIII]] still-valid box). In the setting of **primary prophylaxis**:
  - **Chronic NSBB treatment:** a decrease in HVPG of **at least 10% from baseline, or to ≤12 mmHg**, is clinically relevant.
  - **Acute response to intravenous propranolol** may be used to identify NSBB responders — again **a decrease of 10%, or to ≤12 mmHg**.
...
[[portal-hypertension]], [[cirrhosis]], [[interventional-eus-vascular]], [[tips]], [[variceal-upper-gi-bleeding]], [[porto-sinusoidal-vascular-disorder]], [[primary-biliary-cholangitis]], [[nafld-masld]], [[hepatocellular-carcinoma]], [[noninvasive-liver-disease-assessment]], [[liver-stiffness-measurement]], [[endoscopy-sedation]], [[portal-vein-thrombosis]], [[liver-biopsy]]
...
4. [[wang-2026-eus-ppg-delphi-consensus|International Expert Delphi Consensus on EUS-guided Portosystemic Pressure Gradient: Best Practices and Future Directions (2026)]]
