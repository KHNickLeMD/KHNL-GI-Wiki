...
Hepatic encephalopathy (HE) is a **brain dysfunction caused by liver insufficiency and/or portosystemic shunting (PSS)**, manifesting as a wide spectrum of neurological or psychiatric abnormalities ranging from subclinical alterations to coma. *HE is not a single entity but a continuum* — from unimpaired cognitive function through coma [[aasld-easl-2014-hepatic-encephalopathy]].

---

## Classification (Four-Axis System)
...
- Electrolyte disorders (hyponatremia — independent risk factor for HE; hypercalcemia)
...
4. **ICT (Inhibitory Control Test)** — freely downloadable; requires highly functional patients
5. **Stroop test** — smartphone app available; validated for MHE screening
6. **SCAN test** — computerized; digit memory task; prognostic value
7. **EEG** — sensitive; nonspecific; useful quantitatively

*Recommendation 8 (Grade III, B, 2):* MHE/CHE testing most warranted in patients with impaired QoL or employment/public-safety implications (e.g., drivers, pilots, heavy machinery operators).
...
### Lactulose (First-Line for OHE)

- **Recommendation 19 (Grade II-1, B, 1):** Lactulose is the first choice for treatment of episodic OHE
- **Recommendation 25 (Grade II-1, A, 1):** Lactulose recommended for prevention of recurrent OHE after the initial episode
- **Dosing:** 25 mL lactulose syrup q1–2 h until ≥2 soft/loose stools/day achieved; then titrate to 2–3 BM/day (typically 3–4× daily dosing). Avoid overuse: aspiration, dehydration, hypernatremia, severe perianal skin irritation, and overuse can paradoxically *precipitate* HE.
- Lactulose as secondary prophylaxis post-upper-GI-bleeding supported by RCT [[aasld-easl-2014-hepatic-encephalopathy]]
...
- **Recommendation 27 (Grade III, B, 1):** Routine prophylactic therapy (lactulose or rifaximin) is **NOT recommended for prevention of post-TIPS HE**

### Alternative / Adjunct Therapies

| Agent | Recommendation | Grade | Comment |
|---|---|---|---|
| Oral BCAAs | Rec 21 (Grade I, B, 2) | Alternative/additional for OHE non-responsive to conventional therapy | IV BCAAs have no effect on episodic bouts |
| IV LOLA (L-ornithine L-aspartate) | Rec 22 (Grade I, B, 2) | Alternative/additional for refractory OHE | Oral LOLA ineffective |
...
- **Recommendation 30 (Grade I, A, 1):** Daily energy intake 35–40 kcal/kg IBW
...
- **Recommendation 29 (Grade II-2, B, 1):** Treatment of MHE is **not routinely recommended** apart from case-by-case basis
- Exceptions: impaired QoL, employment/safety concerns (driving), high risk of progression
- Agents studied in MHE: lactulose, rifaximin, probiotics, LOLA — all show cognitive improvement in trials; none formally recommended for routine use

### Post-TIPS HE

- OHE incidence post-TIPS: 10–50%; shunt-diameter reduction can reverse HE in some
- Routine prophylaxis (lactulose, rifaximin) NOT effective (Grade III, B, 1)
- If intractable post-TIPS HE: shunt diameter reduction → consider shunt embolization
- Careful TIPS patient selection (avoid in severe/recurrent pre-existing HE)

### Portosystemic Shunts (PSS) and Type B HE

- Large spontaneous PSS can be successfully embolized for recurring OHE in patients with good liver function → rapid HE clearance, though variceal bleeding risk may emerge
- Pre-LT: identify large PSS; consider embolization to reduce recurrent HE

### Liver Transplantation

- **Recommendation 13 (Grade I):** Recurrent intractable OHE together with liver failure = indication for LT
- HE by itself is NOT an LT indication unless associated with poor liver function or severely impaired QoL
- HE typically improves after LT; however, not all manifestations are fully reversible
- Post-LT cognitive deficits may persist (separate from HE-related causes)
- Large PSS may need embolization before or during transplant workup

---

## Discontinuation of Secondary Prophylaxis

**Recommendation 28 (Grade III, C, 2):** Prophylactic therapy may be discontinued when precipitating factors are well controlled (infections, VB treated) OR liver function/nutritional status has significantly improved.
...
4. Nutritional optimization and monitoring of muscle mass/strength
5. Monitor for MHE/CHE between episodes
