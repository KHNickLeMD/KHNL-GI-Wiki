---
title: "IBD in Patients With Malignancy"
category: concept
...
*Driven by chronic inflammation and field cancerization — not by drugs.*
...
- Emphasize **mucosal healing** and **dysplasia surveillance** (>1/3 of UC-CRC colectomies have synchronous CRC/dysplasia elsewhere — field cancerization).
...
*AGA 2024 Table 1 — the greatest concern is thiopurines and anti-TNF; insufficient data to change the other classes.*

| IBD drug | Lymphoma | Other heme | Melanoma | NMSC | Solid organ |
|---|---|---|---|---|---|
| **Thiopurine** | **Stop** | Consider alternative | No change | **Stop** (if recurrent/difficult) | Consider alternative (stop if cervical/GU) |
| **Anti-TNF** | Consider alternative | No change | **Stop** | No change | No change |
| **Anti-TNF + thiopurine** | **Stop thiopurine** + consider alternative for anti-TNF | No change | **Stop anti-TNF** | **Stop thiopurine** | No change |
| Anti-integrin (vedolizumab) | No change | No change | No change | No change | No change |
| Anti–IL-12/23, anti–IL-23 | No change | No change | No change | No change | No change |
| JAK inhibitor | No change | No change | No change | No change | No change |
| S1P modulator | No change | No change | No change | No change | No change |

- Combination anti-TNF + thiopurine → hepatosplenic T-cell lymphoma is the key concern driving thiopurine cessation.

## IBD Therapy in Patients With Prior Cancer

- Cohort/registry and meta-analytic data are **reassuring**: no significant increase in new or recurrent cancer from immunomodulators, anti-TNF, vedolizumab, or ustekinumab.
- CESAME: prior-cancer patients have higher incident cancer (HR 1.9) but **no** association with immunomodulator exposure. Confirmed by ENEIDA, NYCCO.
- Meta-analyses (11,700 and 24,328 patients): no recurrence difference by anti-TNF / immunomodulator / no immunosuppression.
- **SAPPHIRE registry** (305 IBD + prior cancer; median f/u 4.8 y): 15% developed subsequent cancer — no significant association with immunosuppression (aHR 1.41; 95% CI 0.69–2.90).
- Practical point: effective IBD therapy generally need not be withheld on cancer-history grounds alone — decide with oncology.
