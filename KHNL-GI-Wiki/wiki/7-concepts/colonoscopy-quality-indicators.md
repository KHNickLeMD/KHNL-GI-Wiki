---
title: "Colonoscopy Quality Indicators"
category: concept
...
flowchart TD
    ...
    F -- "No" --> G["Split-dose as standard<br/>Rewrite instructions to 6th-grade level,<br/>patient's native language<br/>Add education, navigation"]
    F -- "Yes" --> H{"Cecal intubation ≥90%?"}
    H -- "No" --> I["Loop reduction technique<br/>CO₂ insufflation<br/>Variable-stiffness endoscope"]
    H -- "Yes" --> J["Optimize: HD scopes, right-colon second look,<br/>cold snare 3–9 mm, expert referral for complex polyps,<br/>detailed documentation, adverse-event and interval-CRC monitoring"]
```
