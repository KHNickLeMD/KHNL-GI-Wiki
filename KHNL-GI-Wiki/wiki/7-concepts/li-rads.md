...
- **Arterial phase hyperenhancement (APHE)** — nonrim; required for LR-5.
...
|---|---|---|
| **LR-1** — Definitely benign | 0% | Return to US surveillance in 6 months |
| **LR-2** — Probably benign | Low | Return to US surveillance in 6 months |
| **LR-3** — Intermediate | 20–40% | Repeat/alternative diagnostic imaging in **3–6 months** (GS 19); return to US surveillance if prolonged stability |
| **LR-4** — Probably HCC | 60–70% | Multidisciplinary discussion; repeat CE-MRI/multiphasic CT **within 3 months** *or* immediate biopsy (GS 20). **Biopsy preferred when immediate diagnosis changes management** (GS 20a) |
| **LR-5** — Definitely HCC | ~95% | **HCC confirmed — no biopsy required.** Multidisciplinary discussion for tailored workup; biopsy optional (confirmation or molecular analysis — GS 21) |
| **LR-M** — Probably/possibly malignant, **not HCC-specific** | ~35% HCC (93–100% malignant on sampling; only 29–44% HCC) | **Biopsy** — risk of mixed tumors and non-HCC malignancy (GS 22, **Level 1, Strong**). Rim APHE suggests non-HCC malignancy, e.g. [[cholangiocarcinoma]] |
| **LR-TIV** — Tumor in vein | Lower than LR-5 | Multidisciplinary discussion; biopsy advised |
...
- **CEUS** is second-line — when MRI/CT are unavailable, inconclusive, or contraindicated.
- LI-RADS is the *diagnostic* step downstream of screening ultrasound; the US visualization-score recall algorithm lives on [[hcc-surveillance]].
...
[[hepatocellular-carcinoma]], [[hcc-surveillance]], [[focal-liver-lesions]], [[portal-hypertension]], [[chronic-hepatitis-b]], [[cholangiocarcinoma]], [[hepatic-hemangioma]], [[focal-nodular-hyperplasia]], [[hepatocellular-adenoma]], [[liver-transplantation]]
