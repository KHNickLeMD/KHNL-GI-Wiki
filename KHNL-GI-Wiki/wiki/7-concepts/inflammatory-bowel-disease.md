...
- **Initial workup:** IBD-tailored history/exam; CBC (anemia), CRP and/or fecal calprotectin; assess disease activity with **biomarkers + endoscopy when indicated**; evaluate for IBD-related complications and **concomitant infections** ([[clostridioides-difficile|C. difficile]], CMV). Preparatory labs for anticipated drugs: fasting lipid panel before cyclosporine/JAK inhibitor; latent TB (TST or IGRA — IGRA preferred if BCG-vaccinated) and HBV testing; [[nutrition-in-hospitalized-patients|malnutrition screen]] (e.g., MUST).
