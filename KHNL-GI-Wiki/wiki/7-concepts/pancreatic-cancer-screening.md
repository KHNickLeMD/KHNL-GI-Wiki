---
title: "High-Risk Pancreatic Cancer Surveillance"
category: concept
...
## Contents
- [[#Who to Screen]]
  - [[#Eligibility, Risk, and Start Age]]
  - [[#Defining High Risk]]
  - [[#Genetic Testing]]
  - [[#Where the Two Guidelines Differ]]
- [[#When Not to Screen]]
- [[#Modality]]
- [[#Frequency]]
...
Screening is suggested for individuals at increased risk **because of genetic susceptibility** (conditional recommendation, low quality of evidence). Being a candidate has three parts: a qualifying condition, the family-history requirement attached to it (if any), and reaching the start age for that condition.
...
| Autosomal-dominant [[hereditary-pancreatitis\|hereditary pancreatitis]] (PRSS1) | No | 53-fold ([[acg-2015-hereditary-gi-cancer\|ACG 2015]]) | **40** (no earlier-start clause) |
...
- Testing for suspected [[familial-pancreatic-cancer|familial pancreatic cancer]] should analyze **BRCA1/2, CDKN2A, PALB2, and ATM**. Add [[peutz-jeghers-syndrome|PJS]]-, [[lynch-syndrome|Lynch]]-, and [[hereditary-pancreatitis|hereditary pancreatitis]]-associated genes when the personal/family history meets that syndrome's criteria ([[acg-2015-hereditary-gi-cancer|ACG 2015]]).
- Known genetic mutations explain only ~20% of familial clustering, so a negative panel does not remove a kindred from FPC-based eligibility.

### Where the Two Guidelines Differ

*Newer tier-1 guidance wins; both positions are stated because readers carry the older rule.*

| Issue | [[acg-2015-hereditary-gi-cancer\|ACG 2015]] | [[asge-2022-pancreatic-cancer-screening\|ASGE 2022]] — **follow this** |
|---|---|---|
| Family history for BRCA1/2, PALB2 carriers | Required (1st-/2nd-degree affected relative) | **Not required** |
| Family history for ATM, Lynch | Required | Required (unchanged) |
| Peutz-Jeghers start age | Age 35 (Rec 23); its surveillance table says age 30, q1–2y | **Age 35, annual** |
| Interval | Annual (q1–2y for PJS in the table) | **Annual for all** |

**Where [[aga-2020-pancreas-cancer-screening\|AGA 2020]] sits.** It is tier-1 but *older* than ASGE 2022, so where they conflict ASGE wins; it is cited below for the content ASGE and ACG do not carry.
...
|---|---|---|
| **Patient/condition** | Very high risk ([[peutz-jeghers-syndrome\|Peutz-Jeghers]], [[fammm-syndrome\|FAMMM]]); MRI contraindicated (claustrophobia, contrast allergy, implanted metal, renal failure) | Increased risk of adverse events from anesthesia or endoscopic procedures; patient places high value on avoiding invasive testing |
| **Combines with** | Screening [[upper-endoscopy\|upper endoscopy]] or [[colonoscopy]] ([[lynch-syndrome\|Lynch]], Peutz-Jeghers) | Other imaging (e.g. enterography in Peutz-Jeghers) |
| **Sequence** | Reasonable as the **initial** screening test | Alternative or alternating exam |
| **Technique** | **Linear-array** echoendoscope detects more pancreatic lesions than radial (**82% vs 67%**, *P* < .001); also more sensitive than MRI for small solid lesions (in 2 studies almost all solid cancers were found only by EUS) | **With and without IV contrast**, minimum **1.5-T** magnet with phased-array coils; **3-T** may better detect small lesions |
...
**How much to shorten it — the lesion-based ladder** ([[aga-2020-pancreas-cancer-screening|AGA 2020]], BPA 9). This is the operative detail behind ACG's "may be shortened"; lesion risk is assigned by a multidisciplinary team.

| Finding | Next exam |
|---|---|
| No concerning pancreas lesion | **12 months** |
| **Low-risk** lesion | shortened interval and/or [[endoscopic-ultrasound\|EUS]] in **6–12 months** |
| **Indeterminate** lesion | EUS within **3–6 months** |
...
- ⚠ AGA 2020 does **not** define what makes a lesion low-risk vs indeterminate vs high-risk — the ladder's strata are named but not specified, and the CPU defers the assignment to the multidisciplinary team. Neither other ingested source supplies the criteria. **Decision gap:** the CAPS consortium recommendations (Goggins 2020) would be needed. Do not infer strata from the sporadic-cyst worrisome-feature criteria.
...
- **Gap — nothing beyond that.** No ingested guideline gives a growth rate, main-duct threshold, or solid-lesion size that mandates surgery in a high-risk individual, and ASGE 2022 gives no operative guidance at all. [[aga-2020-pancreas-cancer-screening|AGA 2020]] is now ingested and **does not close this gap** — it scopes itself explicitly to *"primary screening rather than management of abnormal screening test results"* and states only that the decision belongs to a dedicated multidisciplinary team together with the individual and their family (BPA 10), with resection performed at **high-volume centers** (BPA 11). The CAPS consortium recommendations (Goggins 2020) would still be needed. Do not infer a threshold.
...
- No clinical trial has compared screened vs unscreened controls; quality of evidence is **low to very low** throughout.
- **Interval after a normal baseline** — whether one or several normal exams permit lengthening the interval is undefined.
...
[[pancreatic-cancer]], [[endoscopic-ultrasound]], [[mri-mrcp]], [[brca-pathogenic-variants]], [[familial-pancreatic-cancer]], [[fammm-syndrome]], [[peutz-jeghers-syndrome]], [[lynch-syndrome]], [[hereditary-pancreatitis]], [[pancreatic-cysts]], [[chronic-pancreatitis]], [[upper-endoscopy]], [[colonoscopy]], [[obesity]], [[hcc-surveillance]]
...
3. [[aga-2020-pancreas-cancer-screening|AGA Clinical Practice Update on Pancreas Cancer Screening in High-Risk Individuals: Expert Review (2020)]]
