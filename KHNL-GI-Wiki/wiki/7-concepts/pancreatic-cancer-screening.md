...
| Condition | Start age |
|---|---|
| [[brca-pathogenic-variants\|BRCA2]] pathogenic variant | 50, or 10 yr before youngest affected relative |
| [[brca-pathogenic-variants\|BRCA1]] pathogenic variant | 50, or 10 yr before youngest affected relative |
| PALB2 pathogenic variant | 50, or 10 yr before youngest affected relative |
| [[familial-pancreatic-cancer\|FPC syndrome]] | 50, or 10 yr before youngest affected relative (screen all first-degree relatives of affected members) |
| [[fammm-syndrome\|FAMMM syndrome]] | 40, or 10 yr before youngest affected relative |
| [[peutz-jeghers-syndrome\|Peutz-Jeghers syndrome]] | 35, or 10 yr before youngest affected relative |
| ATM heterozygote with 1st/2nd-degree affected relative | 50, or 10 yr before youngest affected relative |
| [[lynch-syndrome\|Lynch syndrome]] with 1st/2nd-degree affected relative | 50, or 10 yr before youngest affected relative |
| Autosomal-dominant [[hereditary-pancreatitis\|hereditary pancreatitis]] | 40 |

Key change from prior guidance: **all [[brca-pathogenic-variants|BRCA1/2]] carriers should be screened regardless of family history** of pancreatic cancer (previous guidelines required a family history). BRCA1's lifetime risk (~3.5%-3.8%) does not clearly cross the 5% high-risk threshold, so screening BRCA1 carriers is a weaker, judgment-based suggestion — counsel on uncertain benefit and real harms.
...
## Frequency
Annual screening is suggested (conditional, very low quality). Rationale: tumor-progression models predict that progression from localized to advanced stage can occur within 1 year, and most reporting centers screen annually.

## Yield and Harms
- Pooled yield of any high-risk lesion: **3.1%**; resectable/borderline-resectable lesion: **2.1%**.
- **60%** of screen-detected cancers were resectable/borderline-resectable vs ~20% of symptom-detected — evidence of meaningful stage shift; one study showed 3-year survival 85% (screen-detected) vs 25% (symptomatic noncompliant).
