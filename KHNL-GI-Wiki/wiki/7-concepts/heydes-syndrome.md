...
The same mechanism occurs with **left ventricular assist devices (LVADs)**, which generate continuous non-pulsatile flow and analogous shear stress → acquired vWF deficiency → recurrent GI bleeding from angioectasia.
...
See [[angioectasia]], [[small-bowel-bleeding]].
