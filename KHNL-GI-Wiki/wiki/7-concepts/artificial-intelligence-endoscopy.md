...
- **Downstream burden:** ADR gains are mostly small non-advanced adenomas → more [[polypectomy-emr|polypectomies]] and shorter [[colonoscopy-surveillance|surveillance]] intervals (Mori: intensive-surveillance proportion +~35% US / +~20% Europe).
