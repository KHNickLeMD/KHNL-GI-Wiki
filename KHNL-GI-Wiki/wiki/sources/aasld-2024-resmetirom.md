...
**Whom to treat:** adults with MASH and F2–F3 identified preferentially by **imaging-based NILDA** (VCTE LSM 8–15 kPa, MRE 3.1–4.4 kPa) or historical biopsy. ELF 9.2–10.4 (MAESTRO IQR) may be used where imaging unavailable. NOT recommended in cirrhosis (VCTE >20 kPa or MRE >5 kPa), concomitant active liver disease, excess alcohol (>20 g/d ♀ / >30 g/d ♂), or active thyroid disease.
...
### Determination of efficacy and futility (data at 52 weeks; may change with long-term data)
...
- Among persons without clear evidence of liver disease improvement or worsening, the decision to continue therapy (pending longer-term data) should be based on holistic assessment (baseline fibrosis status and benefit of stabilizing fibrosis even without regression; comorbidity profile; adherence/response to lifestyle; changes in liver biochemical and NILDA parameters; adverse effects).

## Key Findings / Claims

- **Dosing:** 100 mg/d (≥100 kg) or 80 mg/d (<100 kg); reduce to 80/60 mg with moderate CYP2C8 inhibitor (e.g., clopidogrel). Substrate of CYP2C8 + OATP1B1/1B3; weak CYP2C8 inhibitor.
- **Statin DDI (max doses with resmetirom):** rosuvastatin 20, simvastatin 20, atorvastatin 40, pravastatin 40 mg/d. Resmetirom lowers LDL-C.
- **Adverse events:** diarrhea (24–34%) and nausea (12–22%), onset usually <12 wk (often <4 wk); increased symptomatic gallstone disease; one severe hepatotoxicity case (interface hepatitis / DILI-AIH, baseline AMA+/ANA+ PBC). Discontinue for hepatotoxicity per [[drug-induced-liver-injury]] thresholds (AST/ALT >5× ULN, or ALP >2× ULN ×2; or total bilirubin >2.5 mg/dL + elevated AST/ALT/ALP; or INR >1.5 + elevated enzymes).
- **Thyroid:** mild reductions in free T4 (~16–21%, up to 24% on levothyroxine) and TSH, usually within normal range; new hypothyroidism requiring levothyroxine in 1.8%. Baseline TSH required; routine thyroid monitoring NOT needed if baseline normal; standard monitoring if known thyroid disease.
- **Sex hormones:** ↑ SHBG; total testosterone ↑50–100% in men (free unchanged); ↑ total estradiol in women — clinical significance unknown.
- **Response biomarkers (52-wk):** MRE ≥20% reduction ≈ true fibrosis improvement (RSNA QIBA 19%); VCTE 25% threshold proposed (overestimates histologic response — 49% had ≥25% drop vs 24–30% histologic); CAP NOT useful for response; <30% MRI-PDFF reduction at 52 wk → histologic response rate no different from placebo (~10%, marker of futility); ELF/blood-based NILDA worsening = futility signal. Stabilization of fibrosis may still be beneficial — lack of improvement should not mandate discontinuation in advanced fibrosis.
- **Concomitant GLP-1/GIP-RA + resmetirom:** not formally studied (MAESTRO-NASH excluded recent initiators/dose-changers of GLP-1 RA, TZD, vitamin E within 6 mo); insufficient data — individualize.

## Relevance to Wiki

- **[[nafld-masld]]** — replaces the page's vague "refer to AASLD Oct 2024 update" placeholder with full resmetirom candidacy (VCTE 8–15 / MRE 3.1–4.4 kPa), dosing, statin DDI, thyroid/gallstone pretreatment rules, and efficacy/futility framework (VCTE ≥25% / MRE ≥20% at 12 mo; MRI-PDFF <30% = futility).
- Candidate **[[resmetirom]]** med page (currently none) — this is the primary source for it.
- **[[drug-induced-liver-injury]]** — hepatotoxicity discontinuation thresholds referenced. **[[semaglutide]]** — GLP-1 RA combination uncertainty.
