---
title: "AASLD Practice Guidance on Autoimmune Hepatitis (2020)"
category: source
...
## Key Recommendations (GRADE-rated)
...
## Key Guidance Statements (Non-GRADE)
...
- **Interface hepatitis:** Lymphoplasmacytic infiltration beyond the limiting plate with hepatocyte necrosis (piecemeal necrosis); hallmark finding
...
- **Acute severe AIH:** Jaundice + INR 1.5–<2.0 + no hepatic encephalopathy
- **AIH-related ALF:** INR ≥2.0 + hepatic encephalopathy (any grade)
- **Biochemical remission:** Normalization of AST, ALT, and IgG to within normal range
...
- Withdrawal may be attempted after **≥2 years of sustained biochemical remission** (normal AST, ALT, IgG)
- Liver biopsy is preferred prior to withdrawal to confirm histologic remission (no interface hepatitis); not mandatory in adults but recommended in children
- **Relapse rates post-withdrawal:** Adults 50–87%; children 60–80%
- Anti-SLA/LP positivity: rarely remit off medications — withdrawal attempt not recommended
...
- Overall 10-year survival: 91%; 20-year survival: 70%
- Standardized mortality ratio: 1.63 (excess mortality versus general population)
