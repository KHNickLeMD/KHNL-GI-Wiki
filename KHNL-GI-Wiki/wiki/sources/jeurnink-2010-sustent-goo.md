---
title: "Surgical gastrojejunostomy or endoscopic stent placement for the palliation of malignant gastric outlet obstruction (SUSTENT study): a multicenter randomized trial"
category: source
tags: [gastric-outlet-obstruction, palliation, enteral-stent, gastrojejunostomy, pancreatic-cancer, rct]
created: 2026-09-02
updated: 2026-09-02
sources: []
---
...
## Bibliographic Info
- **Article:** [Jeurnink SM, Steyerberg EW, van Hooft JE, van Eijck CHJ, Schwartz MP, Vleggaar FP, Kuipers EJ, Siersema PD, for the Dutch SUSTENT Study Group. Surgical gastrojejunostomy or endoscopic stent placement for the palliation of malignant gastric outlet obstruction (SUSTENT study): a multicenter randomized trial. Gastrointest Endosc. 2010;71(3):490–9.](https://doi.org/10.1016/j.gie.2009.09.042)
...
**Read the statistics with the authors' own caveat.** The trial was small and performed many comparisons. The authors state explicitly that Bonferroni correction for multiple testing **would remove every nominally significant finding except those with P < .001** — which here means only the initial hospital-stay cost difference survives correction. All P values below are the uncorrected nominal values and the authors ask that they be read as **descriptive**.
...
**Interventions:**
- **Stent arm:** Enteral Wallflex (Boston Scientific), **22 mm diameter**, 60 / 90 / 120 mm length; over a guidewire, deployed under endoscopic and fluoroscopic monitoring. Uncovered design.
- **GJJ arm:** open or laparoscopic, antecolic or retrocolic, under general anesthesia. **In practice 16 of 18 were open, only 2 laparoscopic** — a key limitation, since laparoscopic GJJ is the modern comparator.

**Efficacy — the curves cross:**

| Outcome | GJJ (n=18) | Stent (n=21) | P |
|---|---|---|---|
| Median days to GOOSS ≥2 (able to eat) | 8 | **5** | <.01 |
...
**Safety and durability (Table 3):**

| Event | GJJ (n=18) | Stent (n=21) | P |
|---|---|---|---|
| Technical problems | 2 | 5 | .6 |
| **Major complications** | **0** | 6 in 4 patients | .02 |
| Early major (<7 days) | 0 | 1 (stent migration, day 3) | .3 |
| Late major (≥7 days) | **0** | 5 in 3 patients | .04 |
| Minor complications | 6 in 5 patients | 4 in 4 patients | NS |
| Persistent obstructive symptoms | 3 in 3 patients | 3 in 3 patients | .9 |
| **Recurrent obstructive symptoms** | 1 in 1 patient | **8 in 5 patients** | .02 |
| **Reinterventions** | 2 in 2 patients | **10 in 7 patients** | <.01 |

- **The major-complication difference is definitional.** When **stent obstruction is not counted as a major complication**, complication rates do not differ between arms (P = .4). The qualifier must travel with the number.
- Late stent failures were **obstruction by food debris and by tumour ingrowth/overgrowth** — the recognized weakness of uncovered stents. Covered stents trade this for a higher migration risk.
...
| Cost component | GJJ | Stent | P |
|---|---|---|---|
| Initial treatment | 1656 | 2092 | **<.001** |
| Initial hospital stay | 9403 | **4309** | **<.001** |
| Intramural care during follow-up | 2331 | 2233 | .9 |
| Extramural care | 2071 | 1952 | .8 |
| Medication / feeding | 359 | 281 | .03 |
| **Total per patient** | **16,536** | **11,720** | .049 |

Higher GJJ cost is driven almost entirely by the longer initial hospital stay. The authors state that **cost should not be the predominant argument** for choosing stenting.

**Conclusion (verbatim intent):** despite slower initial symptom improvement, GJJ gave better long-term results and is **the treatment of choice in patients with a life expectancy of 2 months or longer**; stent placement, with better short-term outcomes, is **preferable for patients expected to live less than 2 months**.

---

## Relevance to Wiki

- **Primary source for the new [[gastric-outlet-obstruction]] diagnostic-schema page** — supplies the GOOSS 0–4 score in full, the malignant-GOO palliation decision rule keyed to the 2-month prognosis threshold, and the durability-versus-speed trade-off table.
- Updates [[pancreatic-cancer]] — 28 of 39 trial patients had pancreatic malignancy; the page previously carried **no** GOO palliation content despite GOO being a common late complication.
- Contributes to [[endoscopic-oncology]], which mentioned SEMS for malignant gastric outlet obstruction in one line with no decision content.
- Relevant to [[ercp]] and [[biliary-stricture]] — a transpapillary duodenal stent can foreclose endoscopic biliary access, pushing later drainage percutaneous.
- Relevant to [[enteral-access]] — GOO is a stated indication for small-bowel rather than gastric feeding access.

---

## Contradictions / Open Questions

- **Internal discrepancy in the paper itself:** the minor-complication comparison is reported as **P = .9 in the running text and P = .8 in Table 3**. Either way it is non-significant, so no wiki claim depends on it; recorded here rather than silently picking one.
