---
title: "AASLD 2023 Practice Guidance on Prevention, Diagnosis, and Treatment of Hepatocellular Carcinoma"
category: source
...
- Non-cirrhotic chronic HBV (≥0.2%/year):
  ...
  - Women from endemic country, age >50
  - Persons from Africa at earlier age (median HCC age 46 years)
...
- **GS 13:** AASLD advises repeat short-interval US and AFP in approximately 3–6 months for patients with a <1 cm lesion on abdominal ultrasound (**Level 3, Strong Recommendation**).
  - **GS 13a:** Patients with stability for ≥2 follow-up exams may return to semiannual surveillance (**Level 5, Weak Recommendation**).
- **GS 14:** Patients with any suspicious lesion ≥1 cm on ultrasound should undergo diagnostic evaluation with multiphasic contrast-enhanced CT or MRI (**Level 1, Strong Recommendation**).
...
- **GS 16:** In at-risk patients with cirrhosis or chronic HBV, diagnosis of HCC should be based on noninvasive imaging criteria and/or pathology (**Level 1, Strong Recommendation**).
  ...
  - **GS 16c:** AASLD advises against use of biomarkers, including AFP alone or liquid biopsy, to make a diagnosis of HCC given insufficient accuracy (**Level 3, Weak Recommendation**).
- **GS 17:** In the absence of cirrhosis or at-risk chronic HBV, diagnosis of HCC should be confirmed by pathology. Noninvasive imaging criteria have insufficient accuracy in these populations (**Level 1, Strong Recommendation**).
- **GS 18:** The noninvasive diagnosis of HCC should be based on either dynamic contrast-enhanced MRI or multiphasic CT (**Level 1, Strong Recommendation**).
- **GS 19:** In patients with an LR-3 observation, AASLD advises repeat cross-sectional imaging in 3–6 months (**Level 2, Weak Recommendation**).
- **GS 20:** In patients with an LR-4 observation, AASLD advises multidisciplinary discussion to determine optimal follow-up, including repeat imaging with contrast-enhanced MRI or multiphasic CT within 3 months or immediate biopsy (**Level 2, Strong Recommendation**).
  - **GS 20a:** For patients in whom an immediate diagnosis would make an impact on management decisions, AASLD advises biopsy over repeat imaging (**Level 5, Strong Recommendation**).
- **GS 21:** AASLD advises multidisciplinary consideration of biopsies for LR-4 and LR-5 observations to confirm diagnosis or enable molecular analysis (**Level 3, Weak Recommendation**).
...
- **LR-4:** Probably HCC (60–70%) → multidisciplinary discussion; may include biopsy; repeat contrast imaging within 3 months or immediate biopsy
- **LR-5:** Definitely HCC (~95%) → HCC confirmed; multidisciplinary discussion; may include biopsy
- **LR-M:** Probably/possibly malignant (~35% HCC) → multidisciplinary discussion; often includes biopsy
- **LR-TIV:** Tumor in vein → multidisciplinary discussion; may include biopsy

**LI-RADS CT/MRI criteria (Figure 6):**
...
- **GS 31:** Routine postoperative surveillance should be performed using contrast-enhanced multiphasic CT or MRI every 3–6 months for all patients following liver resection (**Level 3, Strong Recommendation**).
...
5. Persistent AFP >500 ng/mL in patients who had prior AFP ≥1000 ng/mL
...
- **GS 48:** AASLD advises second-line therapy in patients with preserved liver function (CTP A or well-selected CTP B), ECOG PS 0–1, who develop HCC progression or intolerance with first-line systemic therapy (**Level 1, Strong Recommendation**).
  ...
  - **GS 48b:** AASLD advises sorafenib or lenvatinib as preferred agents after first-line durvalumab+tremelimumab if not eligible for clinical trials (**Level 5, Weak Recommendation**).
  - **GS 48c:** AASLD advises cabozantinib or regorafenib (or ramucirumab in AFP ≥400 ng/mL) as preferred agents after sorafenib or lenvatinib (**Level 1, Strong Recommendation**).
...
| HIMALAYA | Durvalumab vs. sorafenib | 16.6 vs. 13.8 mo | 0.86 (0.73–1.03) | 3.7 vs. 4.1 mo | 17.0% vs. 5.1% |
...
- **Pembrolizumab:** 200 mg IV every 3 weeks. Second-line (accelerated FDA approval; KEYNOTE-240 Phase III missed primary endpoint; KEYNOTE-394 hit OS endpoint in Asian population). Use in patients without prior anti-PD1/anti-PD-L1 therapy.
...
- Locoregional therapy ladder: resection → ablation → TACE/TARE → systemic
- Systemic therapy dosing for all agents (sorafenib, lenvatinib, atezo+bev, durvalumab+tremelimumab, regorafenib, cabozantinib, ramucirumab, pembrolizumab)
- Transplant criteria: Milan, UCSF/expanded criteria (Table 3), UNOS-DS (Table 4), AFP biomarker thresholds
- TACE unsuitability and refractoriness criteria (Tables 5–6)
- Adjuvant therapy GS 32 (original) — superseded by [[aasld-2025-hcc-critical-update]]
