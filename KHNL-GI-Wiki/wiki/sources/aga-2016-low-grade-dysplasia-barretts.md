---
title: "AGA 2016 Clinical Practice Update: Diagnosis and Management of Low-Grade Dysplasia in Barrett's Esophagus (Expert Review)"
category: source
...
```mermaid
flowchart TD
    A["Barrett's esophagus with<br/>low-grade dysplasia"] --> B["Referral to an endoscopist with expertise in<br/>management of dysplasia and capability of<br/>performing endoscopic resection"]
    B --> C{"Confirm diagnosis with<br/>≥1 expert GI pathologist"}
    C -->|No| D["Diagnosis downgraded to<br/>non-dysplastic Barrett's esophagus"]
    D --> E["Surveillance endoscopy<br/>• Every 3–5 years<br/>• Separate biopsies for visible abnormalities<br/>• 4-quadrant biopsies every 2 cm"]
    C -->|Yes| F["Repeat upper endoscopy by expert using<br/>high-definition white light endoscopy under<br/>maximal acid suppression within 8–12 weeks"]
    F --> G["• Surveillance biopsies (4-quadrant q 1–2 cm)<br/>• Endoscopic resection of visible lesions"]
    G --> H["Expert GI pathology review"]
    H --> I["High-grade dysplasia /<br/>intramucosal cancer"]
    H --> J["Low-grade dysplasia confirmed"]
    H --> K["Non-dysplastic Barrett's esophagus"]
    K --> E
    I --> L["Endoscopic eradication therapy"]
    J --> M["Discuss risks and benefits of endoscopic<br/>eradication therapy vs surveillance"]
