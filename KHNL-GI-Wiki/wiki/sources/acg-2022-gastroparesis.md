...
*Numbering and grades below are the guideline's own (Table 1). Recommendation 1 sits under the guideline's "Risk factors" heading; 2–5 under "Diagnostic testing"; 6–20 under "Management".*

### Diagnostic Recommendations

| # | Recommendation | Strength | Evidence |
|---|---|---|---|
| 2 | SGE is standard test; solid meal ≥3 hours (ideally 4 hours) | Strong | Moderate |
| 3 | Radiopaque markers (ROM) NOT suggested for GP diagnosis | Conditional | Very low |
| 4 | Wireless motility capsule (WMC) may be alternative to SGE | Conditional | Low |
...
- Optimal methodology = solid meal + **at least 3 h** of data collection; ideally imaging up to 4 h unless >90% of the solid meal has emptied at 3 h
- Diagnosis of delayed GE: >10% retention at 4 hours
- Medications affecting GE (opioids, cannabinoids, prokinetics, antiemetics, neuromodulators) should be held 48 hours before testing
...
| 9 | Domperidone (where approved) for symptom management | Conditional | Low |
| 10 | 5-HT4 agonists over no treatment to improve GE | Conditional | Low |
| 11 | Antiemetic agents for symptom control (do NOT improve GE) | Conditional | Low |
| 12 | Central neuromodulators NOT recommended | Strong | Moderate |
| 13 | Ghrelin agonists NOT supported | Strong | Moderate |
| 14 | Haloperidol NOT supported for GP treatment | Conditional | Low |
| 15 | GES may be considered (humanitarian use device) | Conditional | Low |
| 16 | Acupuncture may benefit DG specifically; not other etiologies | Conditional | Very low |
| 17 | Herbal therapies (Rikkunshito, STW5/Iberogast) NOT recommended | Conditional | Low |
| 18 | EndoFLIP may characterize pyloric function and predict G-POEM outcomes | Conditional | Very low |
| 19 | Intrapyloric botulinum toxin NOT recommended (negative RCTs) | Strong | Moderate |
| 20 | Pyloromyotomy (G-POEM) over no treatment for medically refractory GP | Conditional | Low |
...
- Randomized crossover trials show mixed results for total symptom score
