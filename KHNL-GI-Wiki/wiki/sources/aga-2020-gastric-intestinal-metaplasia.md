---
title: "AGA 2020 Clinical Practice Update: Management of Gastric Intestinal Metaplasia"
category: source
...
**Recommendation 1 — H. pylori test and treat:**

- Test and treat H. pylori in all patients with GIM: Strong recommendation, Moderate quality evidence
- Meta-analysis: H. pylori eradication → pooled RR 0.68 (32% reduction) in GC incidence; RR 0.67 (33% reduction) in GC mortality
- Mechanism: eradication can halt or partially reverse Correa cascade progression at GIM stage

**Recommendation 2 — Surveillance:**
...
- AGAINST routine repeat endoscopy at <1 year for risk stratification: Conditional recommendation, Very low quality evidence
- Shared decision-making for patients with high-risk stigmata on index endoscopy
- Exception: inadequate index endoscopy, concern for missed synchronous dysplasia

**High-risk features for GC (shared decision-making triggers):**

- Incomplete-type GIM (type IIb/III): ~3-fold increased RR vs complete-type (type I)
- Extensive (corpus-involving) GIM: ~2-fold increased RR vs antrum-limited GIM
