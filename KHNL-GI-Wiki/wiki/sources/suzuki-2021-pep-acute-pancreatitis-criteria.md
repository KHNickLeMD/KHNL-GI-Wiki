---
title: "Post-endoscopic Retrograde Cholangiopancreatography Pancreatitis Assessed Using Criteria for Acute Pancreatitis (Suzuki 2021)"
category: source
...
- **Article:** [Suzuki A, Uno K, Nakase K, Mandai K, Endoh B, Chikugo K, Kawakami T, Suzuki T, Nakai Y, Kusumoto K, Itokawa Y, Inatomi O, Bamba S, Mizumoto Y, Tanaka K. Post-endoscopic retrograde cholangiopancreatography pancreatitis assessed using criteria for acute pancreatitis. JGH Open. 2021;5(12):1391–1397.](https://doi.org/10.1002/jgh3.12687)
...
- **Year:** 2021 (accepted for publication 17 November 2021)
- **Journal/Publisher:** JGH Open (Journal of Gastroenterology and Hepatology Foundation / John Wiley & Sons Australia) — open access
- **DOI:** [10.1002/jgh3.12687](https://doi.org/10.1002/jgh3.12687)
- **Type:** **Cohort study** — prospective, multicenter, observational. Registered UMIN000024813.
- **Grading:** none. This is primary research; it issues **no recommendations and no graded statements.**
- **Note on the file name:** this paper is filed in the source library under a name suggesting it is the Cotton consensus statement. It is not. The Cotton consensus is a separate 1991 document (Cotton PB, Lehman G, Vennes J, et al. *Endoscopic sphincterotomy complications and their management: an attempt at consensus.* Gastrointest Endosc 1991;37:383–93), which this cohort **cites and tests against** — it does not reproduce it. The Cotton criteria as quoted below are quoted **as this cohort states them**, not from the 1991 original.
...
### The two definitions, as the paper prints them

**Cotton consensus criteria for PEP (all three required), as quoted by this paper:**

1. **New or worsened abdominal pain**
2. **Serum amylase at least three times the upper limit of normal, measured more than 24 h after the procedure**
3. **New hospitalization, or prolongation of hospitalization, of at least 2 days**

**Diagnostic criteria for acute pancreatitis, as applied here (≥2 of 3):**

1. **Elevated serum amylase** — "significant" defined as **>3× the upper limit of normal**, the threshold borrowed from the Cotton consensus
2. **Abdominal pain lasting more than 24 h**
3. **Characteristic findings of AP on CT** — focal or diffuse enlargement of the pancreas, heterogeneity of pancreatic parenchyma, peripancreatic stranding, pancreatic or peripancreatic fluid collections, pancreatic necrosis, peripancreatic fat necrosis. **Two expert radiological diagnosticians, blinded to clinical information, independently assessed the CT images.**

**Where they diverge in practice:** the Cotton definition is an **AND** of pain, enzymes, and length of stay; the AP definition is a **2-of-3 OR** that admits CT. A patient with a painless enzyme rise and a positive CT is PEP by AP criteria and not PEP by Cotton; a patient whose pain settles inside 24 h is likewise not PEP by Cotton.

### Severity — the MHLW (Japanese) scoring system used in this cohort

Severity was graded by the **Japanese MHLW severity scoring system for AP (2008 revision)**, not by Cotton's fasting/length-of-stay bands and not by the Revised Atlanta Classification.
...
| Component | Score |
|---|---|
| **Extrapancreatic progression of inflammation** — anterior pararenal space | 0 |
| — root of mesocolon | 1 |
| — beyond the lower pole of the kidney | 2 |
| **Hypoenhanced lesion of the pancreas** (pancreas divided into head, body, tail) — localized to one segment or only peripancreatic | 0 |
| — extends to 2 segments | 1 |
| — occupies 2 whole segments or more | 2 |

**Total 0–1 = Grade 1; total 2 = Grade 2; total ≥3 = Grade 3.**

**Severity assignment: prognostic factor score ≥3, *or* CT grade ≥2 → "severe."**

### Incidence and the discordance between definitions (Table 5)

| | By AP criteria (this study) | By Cotton criteria |
|---|---|---|
| **PEP** | **142 (7.3%)** | **87 (4.5%)** |
| Mild | 117 (6.0%) | 54 (2.8%) |
| Moderate | — (no moderate band) | 20 (1.0%) |
| **Severe** | **25 (1.3%)** | **13 (0.7%)** |
...
- **Conventional risk factors that were *not* independently significant here:** younger age <50 (OR 0.703, P = 0.468), previous acute pancreatitis (0.881, P = 0.702), normal serum bilirubin (1.032, P = 0.878), cannulation attempts ≥10 (1.118, P = 0.641), precut sphincterotomy (1.028, P = 0.956), pancreatic guidewire passage (1.340, P = 0.202), elective ERCP (1.364, P = 0.254).
- **Prophylactic pancreatic stenting was a risk factor on univariate analysis (OR 2.399, 1.345–4.277, P = 0.002) but not on multivariable analysis (OR 0.935, 0.478–1.827, P = 0.843)** — confounding by indication, since stents were placed at operator discretion in patients already judged high-risk.
- 14 variables were entered into the model, chosen by prior reports, univariable results, and plausibility, respecting a minimum of 10 events per predictor. "No coexistence of acute cholangitis" and "diagnostic ERCP" were significant on univariate analysis but deliberately **excluded** from the model as scientifically implausible (their associations reflect procedure time and naïve papilla respectively).
...
[[ercp]], [[acute-pancreatitis]], [[choledocholithiasis]], [[cholangiocarcinoma]], [[pancreatic-cancer]], [[acute-cholangitis]], [[sphincter-of-oddi-dysfunction]]
...
2. [[azuma-2026-cryoprevention-pep|Local Postprocedural Cryoprevention Significantly Reduces the Incidence of Post-ERCP Pancreatitis: A Multicenter Randomized Controlled Trial (EUTOPIA, 2026)]]
