---
title: "AASLD 2021: Diagnosis, Evaluation, and Management of Ascites, SBP, and HRS in Cirrhosis"
category: source
tags: [ascites, sbp, hrs, cirrhosis, liver, paracentesis, hyponatremia, hepatic-hydrothorax, aki, tips, albumin]
created: 2026-05-15
updated: 2026-08-27
sources: []
---
...
- **Article:** [Biggins SW, Angeli P, Garcia-Tsao G, Ginès P, Ling SC, Nadim MK, Wong F, Kim WR. Diagnosis, Evaluation, and Management of Ascites, Spontaneous Bacterial Peritonitis and Hepatorenal Syndrome: 2021 Practice Guidance by the American Association for the Study of Liver Diseases. *Hepatology* 2021;74:1014–1048.](https://doi.org/10.1002/hep.31884)
- **Authors:** Scott W. Biggins, Paulo Angeli, Guadalupe Garcia-Tsao, Pere Ginès, Simon C. Ling, Mitra K. Nadim, Florence Wong, W. Ray Kim
- **Year:** 2021
- **Journal/Publisher:** *Hepatology*, Vol. 74, No. 2, pp. 1014–1048 (AASLD)
- **DOI:** [10.1002/hep.31884](https://doi.org/10.1002/hep.31884)
- **Type:** guideline — AASLD **Practice Guidance** (expert-panel consensus; explicitly *not* a systematic-review/GRADE-graded guideline, because "a sufficient number of randomized controlled trials were not available"). Guidance statements carry **no strength or evidence grade**.
...
Reproduced near-verbatim, grouped by the guidance's own boxed sections. The document numbers none of them and assigns no grades.
...
3. Moderate sodium restriction (2 g or 90 mmol/day) and diuretics (spironolactone with or without furosemide) are the first-line treatment in patients with cirrhosis and grade 2 ascites.
4. After ascites is adequately mobilized, attempts should be made to taper the diuretics to the lowest dose necessary to maintain minimal or no ascites to prevent the development of adverse effects.
...
10. Nonsteroidal anti-inflammatory drugs, angiotensin-converting enzyme inhibitors, and angiotensin receptor blockers should be avoided in patients with cirrhosis and ascites.
11. Aminoglycosides should be avoided whenever possible in the treatment of bacterial infections.
12. For patients with cirrhosis and diuretic-responsive ascites, controversial data suggest potential benefits of long-term infusion of human albumin solution. At present, no recommendation can be made for its use in routine clinical practice.
...
24. Mild hyponatremia (Na 126–135 mEq/L) in cirrhosis without symptoms does not require specific management apart from monitoring and water restriction.
...
30. First-line therapy of HH consists of dietary sodium restriction and diuretics plus thoracentesis as required.
31. TIPS can be considered in selected patients as a second-line treatment for refractory HH.
32. Chest tube insertion for HH should be avoided, but indwelling tunneled catheters may be considered in carefully selected patients who do not respond to medical therapy and are not candidates for TIPS.
33. Patients with HH should be considered for LT.

### Abdominal hernias

34. Elective hernia repair in cirrhosis is best performed through a multidisciplinary approach after ascites has been controlled and the patient's overall condition, including nutritional status, has been optimized.
35. TIPS insertion should be considered before elective hernia repair or after an emergent operation in patients with cirrhosis and uncontrolled ascites.

### SBP — diagnosis

36. Patients with ascites due to cirrhosis emergently admitted to the hospital should undergo a diagnostic abdominal paracentesis to rule out SBP even in the absence of symptoms/signs of infection.
37. Patients with ascites who develop signs, symptoms, or laboratory abnormalities suggestive of infection should undergo workup for infection plus a diagnostic abdominal paracentesis (for cell count and bacteriological culture). If the workup is negative and the patient has a pleural effusion, the patient should undergo a diagnostic thoracentesis.
38. The ascitic fluid should be cultured at the bedside in aerobic and anaerobic blood culture bottles before initiation of antibiotics.
39. The diagnosis of SBP/SBE is established with a fluid polymorphonuclear (PMN) leukocyte count >250/mm³.
...
44. Patients with SBP should be treated with IV albumin in addition to antibiotics (1.5 g/kg at day 1 and 1 g/kg at day 3). Patients with AKI and/or jaundice at time of diagnosis of SBP are more likely to benefit from albumin.
45. NSBBs should be temporarily held in patients with SBP who develop hypotension (mean arterial pressure <65 mm Hg) or AKI.

### SBP — prophylaxis

46. Patients who have recovered from an episode of SBP should receive long-term prophylaxis with daily norfloxacin. In settings in which norfloxacin is unavailable, oral ciprofloxacin is acceptable.
47. Antibiotic prophylaxis for SBP should be instituted in patients with cirrhosis and upper gastrointestinal hemorrhage. IV ceftriaxone 1 g/24 hours is the antibiotic of choice and should be used for a maximum of 7 days.
48. In patients with cirrhosis and low protein (<1.5 g/dL) ascites, primary SBP prophylaxis can be considered in selected patients with renal dysfunction (serum creatinine level >1.2 mg/dL, blood urea nitrogen level >25 mg/dL, or serum sodium level <130 mEq/L) or liver failure (Child-Turcotte-Pugh score >9 and bilirubin >3 mg/dL).

### AKI in cirrhosis — diagnosis
...
52. The treatment of choice for HRS-AKI is vasoconstrictor drugs in combination with albumin. The preferred drug is terlipressin, administered either as IV bolus or continuous IV infusion.
53. In settings where terlipressin is not available, norepinephrine should be given. If neither can be administered, a trial of oral midodrine (5 to 15 mg per os every 8 hours) in combination with octreotide (100 to 200 μg every 8 hours or 50 μg/hour IV) may be considered, yet the efficacy is low.
54. Patients should be closely monitored for the possible development of side effects of vasoconstrictors and albumin, including ischemic complications and pulmonary edema.
55. Response to terlipressin or norepinephrine is defined by creatinine decreases to <1.5 mg/dL or return to within 0.3 mg/dL of baseline over a maximum of 14 days. In patients whose creatinine remains at or above the pretreatment level over 4 days with the maximum tolerated doses of the vasoconstrictor, therapy may be discontinued.
56. Recurrence may occur after treatment discontinuation and should be retreated.
57. All patients with cirrhosis and AKI should be considered for urgent LT evaluation given the high short-term mortality even in responders to vasoconstrictors.
58. RRT should be used in candidates for LT with worsening renal function or electrolyte disturbances or increasing volume overload unresponsive to vasoconstrictor therapy. Initiation of RRT in patients who are not candidates for LT must be made with a clear endpoint in mind.
59. Given the complexity of patients with suspected HRS-AKI, decisions about management including initiation of vasoconstrictor therapy and RRT should be made, if possible, by multidisciplinary teams including specialists in hepatology, nephrology, critical care, and transplant surgery.
60. Simultaneous liver-kidney transplantation may be necessary for patients who are not expected to recover kidney function posttransplantation.

### Ascites in children

61. Diagnosis of ascites and its cause in children requires a comprehensive evaluation of clinical history, examination, and diagnostic testing, including abdominal ultrasound.
62. Children with cirrhosis and ascites should be referred for evaluation for LT.
63. Ascites in children is initially managed with restricted sodium intake to below 2 mmol/kg per day and administration of spironolactone (1–4 mg/kg per day) and furosemide (1–3 mg/kg per day in divided doses).
64. Symptomatic children with grade 3 and treatment RA should usually undergo therapeutic paracentesis, although the indications, risks, and benefits of this procedure in children have not been fully defined.
65. Children undergoing LVP should receive 25% albumin infusion of 0.5–1.0 g/kg, or 6–8 g per liter of ascites removed.
66. Diagnostic paracentesis should be performed in children with ascites and fever, abdominal pain, or clinical deterioration. The risks and benefits of this procedure for use in all children with new ascites but without these symptoms have not been defined.
67. Children with proven or suspected SBP should be treated with broad-spectrum antibiotic cover against both gram-positive and gram-negative organisms.
68. No recommendation can be given for the management of AKI and HRS in children with cirrhosis because of the absence of relevant definitions and lack of data on treatment and outcomes.

*(Numbering is this page's, for reference only — the source presents these as unnumbered bullets in section-level "Guidance Statement(s)" boxes.)*

## Key Findings / Claims

### Ascites classification (Table 5)

| By amount of fluid | Definition | By response to treatment | Definition |
|---|---|---|---|
| Grade 1 — mild | Only detected by ultrasound | Responsive ascites | Ascites that can be fully mobilized or limited to grade 1 with diuretic therapy associated or not to moderate dietary sodium restriction |
| Grade 2 — moderate | Moderate symmetric distension of abdomen | Recurrent ascites | Ascites that recurs on at least 3 occasions within a 12-month period despite dietary sodium restriction and adequate diuretic dosage |
| Grade 3 — large/gross | Marked distension of the abdomen | Refractory ascites | Ascites that cannot be mobilized or the early recurrence of which (i.e., after LVP) cannot be satisfactorily prevented by medical therapy |

No treatment is recommended for grade 1 ascites — no evidence it improves outcomes.

### SAAG interpretation (Table 4)

| SAAG | Interpretation | Potential causes |
|---|---|---|
| ≥1.1 g/dL | Reflects [[portal-hypertension\|portal hypertension]] (accuracy ~97%) | Ascites in cirrhosis; ascites related to massive liver metastasis; ascites related to liver involvement in right heart failure |
| <1.1 g/dL | Excludes portal hypertension | Peritoneal carcinomatosis; tuberculous peritonitis; other clinical conditions |

- **Ascitic fluid total protein >2.5 g/dL supports a cardiac source.**
- Amylase, cytology, and mycobacterial culture are **not** routine — order by clinical context (Table 3).

### Diuretic dosing and titration

| Drug | Start | Titration | Maximum |
|---|---|---|---|
| Spironolactone | 100 mg/day | Stepwise, interval ≥72 h (long half-life; full effect of a dose change may take 3 days) | 400 mg/day |
| Furosemide | 40 mg/day | By response and tolerability | 160 mg/day (generally accepted threshold defining medical refractoriness) |

- **Weight-loss ceiling:** without peripheral edema, weight loss >0.5 kg/day risks plasma-volume contraction (peritoneal reabsorption capacity ≈500 mL/day); with edema, up to 1 kg/day may be tolerated.
- **Urine sodium as adherence/dose check:** in the absence of renal dysfunction, 24-h urinary Na lower than intake (e.g., 80 mmol/day) = insufficient diuretic dose; persistent ascites *despite* adequate urinary Na excretion = dietary indiscretion. Spot urine Na/K >1 correlates with adequate natriuresis; ≤1 indicates insufficient natriuresis → increase diuretics.
- Adverse effects occur in 20%–40% of patients (Table 6): AKI (rise ≥0.3 mg/dL in 48 h, mostly loop), hyponatremia (<135 mmol/L, more common with loop), hypokalemia (<3.5 mmol/L, loop), hyperkalemia (>5.5 mmol/L, aldosterone antagonists), hepatic encephalopathy, gynecomastia, muscle cramps. Spironolactone 100 mg ≈ eplerenone ~50 mg ≈ amiloride ~10 mg.

### Refractory ascites — full diagnostic criteria (Table 7)

All three of the following must be met (Figure 3):

| Component | Criterion |
|---|---|
| Fails sodium restriction | 88 mmol or 2,000 mg/day |
| Fails maximum diuretics | Spironolactone 400 mg/day **or** amiloride 30 mg/day, **and** furosemide 160 mg/day — both for at least 1 week |
| Lack of treatment response | Mean weight loss <0.8 kg over 4 days **and** urinary sodium less than sodium intake |
| *or* Early recurrence | Reappearance of grade 2 or 3 ascites within 4 weeks of initial mobilization |

**Subtypes:**

- **Diuretic-resistant** — ascites that cannot be mobilized, or early recurrence that cannot be prevented, *because of lack of response* to sodium restriction and maximal diuretics.
- **Diuretic-intractable** — same, *because diuretic-induced complications* preclude effective doses. Diuretic-induced complications = renal impairment (creatinine increase >100% to a value >2.0 mg/dL); hyponatremia (decrease >10 mmol/L or absolute <125 mmol/L); hypo- or hyperkalemia (<3 mmol/L or >6 mmol/L); hepatic encephalopathy.

RA occurs in ~5%–10% of patients with cirrhosis and ascites; 6-month survival ~50%.
...
| Severity | Serum Na | Management |
|---|---|---|
| Mild | 126–135 mEq/L | Monitoring + water restriction only (if asymptomatic) |
| Moderate | 120–125 mEq/L | Fluid restriction 1,000 mL/day + stop diuretics |
...
- ODS occurs in ~0.5%–1.5% of LT recipients; onset 2–7 days after rapid correction.

### Hepatic hydrothorax

- Prevalence in cirrhosis 4%–12%; right-sided 73%, left 17%, bilateral 10%; 9% without clinical ascites.
- **Serum-to-pleural-fluid albumin gradient >1.1 g/dL** suggests HH.
- Prognosis worse than MELD predicts: 90-day mortality after hospitalization with HH was 74% despite mean MELD 14 (which predicts 6%–8%).
- Chemical pleurodesis is **not** recommended. Indwelling tunneled pleural catheters: infection 4.5%, fluid reaccumulation 20%, spontaneous pleurodesis 31%.

**MELD-exception criteria for HH (Table 8)** — adult LT candidates with chronic, recurrent, confirmed HH, infectious and malignant causes excluded, documenting all of:

- ≥1 thoracentesis >1 L weekly in the last 4 weeks (report date and volume of each)
- Pleural fluid transudative by pleural–serum albumin gradient ≥1.1 and by cell count
- No evidence of heart failure (objective evidence required)
- Pleural fluid culture negative on 2 separate occasions
- Pleural fluid cytology benign on 2 separate occasions
- Contraindication to TIPS (specify)
- Diuretic refractory
...
- Do **not** place a chest tube for SBE despite the word "empyema."
- Antibiotic duration 5–7 days; a small study found shorter courses (mean 4.8 vs 9.6 days) when stopped once PMN fell <250/mm³.
- In septic shock, mortality rises ~10% for every hour's delay in antibiotics; inappropriate initial therapy raises death risk 10-fold.

### Empiric antibiotics for infections in cirrhosis (Table 9)
...
| 3 | Increase in creatinine >3-fold of baseline, **or** creatinine >4 mg/dL (353.6 µmol/L) with an acute increase ≥0.3 mg/dL (26.5 µmol/L), **or** initiation of RRT |
...
### HRS-AKI diagnostic criteria (Table 11)
...
- **TIPS is not recommended in HRS-AKI** (insufficient information).
- CONFIRM trial (abstract at time of writing): terlipressin + albumin gave higher HRS reversal and 10-day RRT-free survival vs placebo (29.1% vs 15.8%, *P* = 0.012).
- Continuous RRT is preferred over intermittent dialysis when hemodynamically unstable.
...
| Belcher 2014 | 76 | 16 | 39 | 0.78 | 365 ng/mL | NA |
...
- SBP identified in 19%–28% of children admitted with ascites and fever/deterioration; post-TIPS hepatic encephalopathy rates 0%–48%.

## Relevance to Wiki

- Expands [[ascites]] — grading, diuretic titration and ceilings, refractory-ascites criteria, LVP/albumin dosing, TIPS selection
- Expands [[spontaneous-bacterial-peritonitis]] — diagnosis, empiric antibiotic selection by acquisition setting, albumin, primary and secondary prophylaxis criteria
- Supplies HRS-AKI terminology, diagnostic criteria, and vasoconstrictor dosing for [[aki-in-cirrhosis]]
- Hyponatremia grading/correction, hepatic hydrothorax, and abdominal hernia management for [[cirrhosis]]
- NSBB cautions in refractory ascites interface with [[portal-hypertension]] and [[variceal-upper-gi-bleeding]]
- Antibiotic selection table feeds [[antibiotic-prophylaxis-cirrhosis]] and [[albumin]]
...
- **NSBBs in refractory ascites** — the "window hypothesis" is unresolved; none of the cited studies are RCTs, and adequately powered trials with survival endpoints are needed (Table 14).
...
[[ascites]], [[spontaneous-bacterial-peritonitis]], [[aki-in-cirrhosis]], [[cirrhosis]], [[portal-hypertension]], [[albumin]], [[antibiotic-prophylaxis-cirrhosis]], [[liver-transplantation]]
