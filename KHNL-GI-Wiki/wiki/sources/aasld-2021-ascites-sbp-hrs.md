...
category: source
tags: [ascites, sbp, hrs, cirrhosis, liver, paracentesis]
created: 2026-05-15
updated: 2026-05-28
sources: []
---

# AASLD 2021: Diagnosis, Evaluation, and Management of Ascites, SBP, and HRS in Cirrhosis
...
- **Full title:** Diagnosis, Evaluation, and Management of Ascites, Spontaneous Bacterial Peritonitis and Hepatorenal Syndrome: 2021 Practice Guidance by the American Association for the Study of Liver Diseases
- **Authors:** Scott W. Biggins, Paulo Angeli, Guadalupe Garcia-Tsao, Pere Ginès, W. Ray Kim, Simon C. Ling, Mitra K. Nadim, Florence Wong
- **Year:** 2021
- **Journal/Publisher:** Hepatology, Vol. 74, No. 2 (AASLD)
- **DOI:** [10.1002/hep.31884](https://doi.org/10.1002/hep.31884)
- **Type:** guideline — Practice Guidance (expert panel consensus, not a formal systematic review/graded guideline)
...
- Correct chronic hyponatremia at 4–6 mEq/L per 24 hours; max 8 mEq/L per 24 hours (ODS risk)
...
- Reassess response with repeat paracentesis at 48 hours; failure = PMN decrease <25% from baseline
- Duration: 5–7 days (can be guided by PMN normalization to <250/mm³)
- IV albumin: 1.5 g/kg on day 1, 1 g/kg on day 3; especially beneficial if BUN >30, creatinine >1.0, or bilirubin >5 mg/dL
...
- Albumin: 1 g/kg day 1, then 40–50 g/day for duration of therapy
- Goal: creatinine decrease to <1.5 mg/dL or within 0.3 mg/dL of baseline over ≤14 days
- All patients should be evaluated urgently for LT

---

## Clinical Tables Referenced

| Table    | Content                                                               |
| -------- | --------------------------------------------------------------------- |
| Table 2  | Initial evaluation of patients with ascites                           |
| Table 3  | Guidance to diagnostic paracentesis by clinical setting               |
| Table 4  | SAAG interpretation                                                   |
| Table 5  | Ascites classification (grade 1–3; responsive, recurrent, refractory) |
| Table 6  | Adverse effects of diuretics                                          |
| Table 7  | Characteristics of refractory ascites                                 |
| Table 9  | Antibiotics for infections in cirrhosis                               |
| Table 10 | AKI stages                                                            |
| Table 11 | HRS-AKI diagnostic criteria                                           |
| Table 12 | Urine NGAL as biomarker for AKI type                                  |
| Table 13 | Simultaneous liver-kidney transplantation eligibility                 |
...
|---|---|---|
| **Ascites — Diagnosis** | | |
| Diagnostic paracentesis in all patients with new-onset ascites; send PMN count, total protein, albumin (SAAG), and cultures | Summary Statement | — |
| **Ascites — Medical Management** | | |
| Grade 2 ascites: sodium restriction (2 g/day) + spironolactone 100–400 mg ± furosemide 40–160 mg/day | Summary Statement | — |
| Refer for liver transplant evaluation at grade 2 or 3 ascites | Summary Statement | — |
| **Grade 3 / Refractory Ascites** | | |
| LVP with albumin infusion 6–8 g per liter of ascites removed when >5 L drained (to prevent PPCD) | Summary Statement | — |
| TIPS preferred over repeated LVP in well-selected refractory ascites patients (MELD <18, no advanced cardiopulmonary disease or severe encephalopathy) | Summary Statement | — |
| **SBP — Treatment** | | |
| Empiric IV third-generation cephalosporin (e.g., cefotaxime 2 g q12h) for community-acquired SBP with PMN >250/mm³ | Summary Statement | — |
| IV albumin 1.5 g/kg day 1 and 1 g/kg day 3 for SBP, especially if BUN >30, creatinine >1.0, or bilirubin >5 mg/dL | Summary Statement | — |
| **SBP — Prophylaxis** | | |
| Secondary prophylaxis: oral ciprofloxacin 500 mg/day after first SBP episode | Summary Statement | — |
| Primary prophylaxis: IV ceftriaxone during acute GI hemorrhage (5–7 days); oral fluoroquinolone for low ascitic protein with advanced hepatic/renal dysfunction | Summary Statement | — |
| **HRS-AKI** | | |
| Vasoconstrictors (preferred: terlipressin; alternatives: norepinephrine in ICU, or midodrine + octreotide) plus albumin 1 g/kg day 1 then 40–50 g/day | Summary Statement | — |
| Urgent liver transplant evaluation for all HRS-AKI patients | Summary Statement | — |
| **Hyponatremia** | | |
| Correct chronic hyponatremia at 4–6 mEq/L per 24 h; max 8 mEq/L per 24 h (osmotic demyelination risk) | Summary Statement | — |

## Relevance to Wiki

- Expands [[ascites]] — medical management, refractory ascites, TIPS criteria
- Expands [[spontaneous-bacterial-peritonitis]] — diagnosis, empiric treatment, albumin use, prophylaxis
- Creates concept: [[aki-in-cirrhosis|hepatorenal syndrome aki]] (HRS-AKI terminology and management)

## Contradictions / Open Questions

- Terlipressin was not yet FDA-approved at time of publication; approved by FDA September 2022 — now first-line vasoconstrictor for HRS-AKI in the US
- Vaptans (tolvaptan): FDA black box warning for hepatotoxicity; short-term use (≤30 days) only
