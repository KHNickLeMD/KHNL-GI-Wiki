---
title: "ACG 2015: Genetic Testing and Management of Hereditary Gastrointestinal Cancer Syndromes"
category: source
...
The hamartomatous syndromes (PJS, JPS, Cowden) each receive dedicated guidance on genetic testing criteria, surveillance schedules, and surgical thresholds. PJS (STK11/LKB1) carries a 39% lifetime CRC risk and up to 132-fold elevated pancreatic cancer risk. JPS (SMAD4/BMPR1A) carries 38–68% CRC risk and 21% upper GI cancer risk. Cowden syndrome (PTEN) carries 9–16% CRC risk but much higher breast (25–85%), thyroid (3–38%), and endometrial (5–28%) risks. Serrated polyposis syndrome (SPS) is defined by WHO criteria; no proven genetic etiology exists and MUTYH testing may be considered when adenomas co-occur. Hereditary pancreatic cancer surveillance (EUS ± MRI starting at age 50 or 10 years before earliest family cancer) is recommended for high-risk mutation carriers. HDGC (CDH1) warrants prophylactic gastrectomy after age 20 (>80% lifetime risk by age 80).
...
- CRC colonoscopy screening: q1–2y from age 20–25 (MLH1/MSH2); from 25–30 (MSH6/PMS2); annual colonoscopy considered in confirmed carriers (Strong/Moderate)
- Cumulative CRC risks: MLH1/MSH2 M 27–74%, F 22–61%; MSH6 M 22–69%, F 10–30%; PMS2 ~20% (both sexes)
- Colectomy with IRA is preferred treatment for LS-associated colon cancer (Conditional/Moderate)
- Prophylactic total colectomy may be discussed with carriers who have endoscopically normal colon
- Endometrial biopsy + TVUS annually from age 30–35 (Conditional/VLow); hysterectomy + BSO offered after childbearing, optimally at 40–45 (Conditional/Low)
- EGD + gastric biopsy at age 30–35; ongoing q3–5y if FH of gastric/duodenal cancer (Conditional/VLow)
- Urinary tract: limited evidence; NCCN recommends annual urinalysis
- Pancreatic cancer: 9–11-fold relative risk in LS; MRI ± EUS considered if FDR affected
- Aspirin chemopreventio: CAPP2 showed HR 0.63 for CRC at 55.7 months (intention-to-treat, P=0.12); all LS cancers HR 0.65 (P=0.05); evidence not sufficient for standard use recommendation (Conditional/Moderate)
...
- Biannual AFP + liver US for hepatoblastoma until age 7 (Conditional/VLow)
- Post-colectomy surveillance: yearly endoscopy of rectum or ileal pouch; ileostomy check q2y (Strong/Low)
- Sulindac causes regression of rectal adenomas but is NOT a substitute for colectomy; celecoxib has been removed from US market for this indication
...
- Colonoscopy from age 15 q2y; EGD from age 15 q2–3y
- Thyroid US annually from adolescence; breast MRI ± mammogram from age 25; annual endometrial sampling or vaginal US from age 30–35; annual renal US from age 18; annual skin exam
...
- Colonoscopy q1–3y with removal of all polyps >5mm (Conditional/Low)
- Surgery (colectomy + IRA) if polyps uncontrolled or cancer develops (Conditional/Low)
...
- Surveillance: EUS ± MRI/MRCP starting age 50 (or 10 years before earliest family cancer); PJS starts at age 35 (Conditional/VLow)
- Pancreatic surveillance should be conducted at experienced centers under research conditions
...
- CDH1 mutation found in 10.5–47% of individuals meeting criteria
- Prophylactic gastrectomy after age 20 (>80% risk by age 80) is recommended (Conditional/Low)
- Pre-gastrectomy endoscopic surveillance: detailed 30-min EGD with multiple random biopsies q6–12 months if surgery deferred; indigo-carmine staining or pH-sensitive congo red dye may improve detection
...
- Creates [[serrated-polyposis-syndrome]] (new page)
- Creates [[hereditary-diffuse-gastric-cancer]] (new page)
