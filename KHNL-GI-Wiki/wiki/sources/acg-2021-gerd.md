...
Verbatim from Table 1 unless noted; section numbering is the guideline's own (each section restarts at 1).

### Diagnosis of GERD

| # | Recommendation | Strength | Evidence |
|---|---|---|---|
| 1 | For patients with classic GERD symptoms of heartburn and regurgitation who have no alarm symptoms, we recommend an 8-wk trial of empiric PPIs once daily before a meal. | Strong | Moderate |
| 2 | We recommend attempting to discontinue the PPIs in patients whose classic GERD symptoms respond to an 8-wk empiric trial of PPIs. | Conditional | Low |
...
| # | Recommendation | Strength | Evidence |
|---|---|---|---|
| 1 | We recommend weight loss in overweight and obese patients for improvement of GERD symptoms. | Strong | Moderate |
| 2 | We suggest avoiding meals within 2–3 hr of bedtime. | Conditional | Low |
...
| 10 | For patients with GERD who require maintenance therapy with PPIs, the PPIs should be administered in the lowest dose that effectively controls GERD symptoms and maintains healing of reflux esophagitis. | Conditional | Low |
| 11 | We recommend against routine addition of medical therapies in PPI nonresponders. | Conditional | Moderate |
| 12 | We recommend maintenance PPI therapy indefinitely or antireflux surgery for patients with LA grade C or D esophagitis. | Strong | Moderate |
...
| # | Recommendation | Strength | Evidence |
|---|---|---|---|
| 1 | We recommend evaluation for non-GERD causes in patients with possible extraesophageal manifestations before ascribing symptoms to GERD. | Strong | Moderate |
| 2 | We recommend that patients who have extraesophageal manifestations of GERD without typical GERD symptoms (e.g., heartburn and regurgitation) undergo reflux testing for evaluation before PPI therapy. | Strong | Moderate |
| 3 | For patients who have both extraesophageal and typical GERD symptoms, we suggest considering a trial of twice-daily PPI therapy for 8–12 weeks before additional testing. | Conditional | Low |
| 4 | We suggest that upper endoscopy should not be used as the method to establish a diagnosis of GERD-related asthma, chronic cough, or LPR. | Conditional | Low |
| 5 | We suggest against a diagnosis of LPR based on laryngoscopy findings alone and recommend additional testing should be considered. | Conditional | Low |
| 6 | In patients treated for extraesophageal reflux disease, surgical or endoscopic antireflux procedures are only recommended in patients with objective evidence of reflux. | Conditional | Low |
...
## Key Concept Statements (Table 2 — not GRADE-graded)
...
- Before performing invasive therapy for GERD, a careful evaluation is required to ensure that GERD is present, to exclude achalasia, and to exclude conditions that might be contraindications to invasive treatment such as absent contractility.

**Long-term PPI issues**

- Verbatim counselling language supplied by the guideline: *"PPIs are the most effective medical treatment for GERD. Some medical studies have identified an association between the long-term use of PPIs and the development of numerous adverse conditions including intestinal infections, pneumonia, stomach cancer, osteoporosis-related bone fractures, chronic kidney disease, deficiencies of certain vitamins and minerals, heart attacks, strokes, dementia, and early death. Those studies have flaws, are not considered definitive, and do not establish a cause-and-effect relationship between PPIs and the adverse conditions. High-quality studies have found that PPIs do not significantly increase the risk of any of these conditions except intestinal infections. Nevertheless, we cannot exclude the possibility that PPIs might confer a small increase in the risk of developing these adverse conditions. For the treatment of GERD, gastroenterologists generally agree that the well-established benefits of PPIs far outweigh their theoretical risks."*
...
**Endoscopic findings and the LA classification**

- LA grade A EE is **not** sufficient for a definitive diagnosis of GERD — it is not reliably differentiated from normal.
- LA grade B EE **can** be diagnostic of GERD in the presence of typical GERD symptoms and PPI response.
- LA grade C is virtually always diagnostic; in outpatients LA grade D is a manifestation of severe GERD (but grade D may not be a reliable index of severity in hospitalized patients).
- In patients with LA grade C and D EE, endoscopy is recommended **after** PPI treatment to ensure healing and to evaluate for Barrett's esophagus.
- Barrett's segment >3 cm with intestinal metaplasia on biopsy is diagnostic of GERD and obviates pH testing for that purpose.
- Figure 1 (diagnostic algorithm) confirms GERD on LA grade B/C/D or Barrett's >3 cm; normal EGD or LA grade A proceeds to reflux monitoring off therapy.
- NERD should only be diagnosed if endoscopy is performed off PPIs.

**Reflux monitoring**

- Methods: wireless pH telemetry capsule (48–96 hr) or transnasal catheter pH / impedance-pH (24 hr). Neither is superior for clinical purposes.
- Most consistently reliable variables: total acid exposure time and the composite DeMeester score.
- SI ≥50% is considered positive; SAP >95% is considered positive.
- Monitoring off PPI (7 days off) when the diagnosis is unclear and before antireflux surgery/endoscopic therapy; monitoring on PPI when GERD is already objectively established but symptoms persist.

**Diagnostic test performance**

- Heartburn/regurgitation for erosive esophagitis: sensitivity 30%–76%, specificity 62%–96%.
- Empiric PPI trial (vs endoscopy + pH monitoring as reference): pooled sensitivity 78%, specificity 54%.
- Barium: only about one-half of patients with abnormal reflux on barium had abnormal pH monitoring.
...
- Up to 40% of PPI-treated patients report persistent heartburn/regurgitation.
- In 1 study, 42% of patients continued PPI treatment after a negative evaluation for refractory GERD (negative endoscopy and pH-impedance monitoring).

## Figures

- **Figure 1** — Diagnosis of GERD algorithm (p. 33).
- **Figure 2** — Diagnosis of extraesophageal GERD algorithm.
- **Figure 3A/3B** — Management of refractory GERD algorithms.
...
- **TIF hiatal hernia threshold:** ACG 2021 excludes hiatal hernias >2 cm (consistent with ASGE 2024), but predates the cTIF data reviewed in ASGE 2024, which stratifies by hernia size more granularly.
- **Stretta:** ACG 2021 makes a conditional, low-evidence statement that it *cannot* be recommended as an alternative to medical or surgical antireflux therapy — it is a graded statement, not a silence. ASGE 2024 similarly does not recommend Stretta for most patients.
- **Table 1 vs text:** Table 1 omits the diagnostic-endoscopy recommendation that appears as Diagnosis #3 in the text, and softens "We recommend against" (text, Diagnosis #8) to "We suggest against" while retaining the strong/low grade.
- **Salivary pepsin:** not recommended for evaluation of extraesophageal reflux symptoms; the guideline attributes this to difficulty distinguishing patients from normal controls.

## See Also

[[gerd]], [[asge-2024-gerd]], [[barretts-esophagus]], [[antireflux-surgery]], [[high-resolution-manometry]], [[gastroparesis]], [[laryngopharyngeal-symptoms]]
