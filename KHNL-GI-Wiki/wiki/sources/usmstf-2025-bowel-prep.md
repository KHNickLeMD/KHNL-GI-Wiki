---
title: "USMSTF 2025: Optimizing Bowel Preparation Quality for Colonoscopy"
category: source
tags: [colonoscopy, bowel-prep, split-dose, peg, simethicone, preparation-quality, crc-screening]
created: 2026-05-07
updated: 2026-05-28
sources: []
---
...
Update to the 2014 USMSTF bowel preparation recommendations. Developed 25 consensus statements organized around three time frames: before, during, and after colonoscopy. Focuses primarily on ambulatory patients at low risk for inadequate preparation; also addresses high-risk populations.
...
- Simethicone: now formally suggested as adjunct (≥320 mg)
...
|---|---|---|
| **Patient Education** | | |
| Provide verbal and written patient education instructions for all preparation components | Strong | High |
| Use patient navigation (telephonic or electronic/automated messaging) to improve adequate prep rates | Weak | Moderate |
| **Diet** | | |
| Limit dietary modifications to the day before colonoscopy for average-risk ambulatory patients | Strong | High |
| Allow low-residue or full liquid meals on the day before when using split-dose prep | Strong | High |
| **Choice of Purgative** | | |
| No single purgative is superior to others for adequate bowel preparation quality | Strong | High |
| Prefer 2L regimens over 4L regimens | Weak | Moderate |
| Select prep based on patient medical history, medications, and prior prep adequacy | Strong | Moderate |
| Avoid hyperosmotic regimens in patients at risk for volume overload or electrolyte disturbances | Strong | High |
| **Timing of Purgative** | | |
| Use split-dose administration for all patients regardless of prep volume | Strong | High |
| Same-day regimen is acceptable for afternoon colonoscopy | Strong | High |
| Same-day regimen is inferior to split-dose for morning colonoscopy | Weak | Low |
| Begin second portion of split-dose 4-6 hr before colonoscopy; complete >=2 hr before procedure | Strong | Moderate |
| **Adjuncts** | | |
| Use adjunctive oral simethicone >=320 mg before colonoscopy | Weak | Moderate |
| Do not routinely use non-simethicone adjuncts | Weak | Low |
| **During Colonoscopy** | | |
| If incomplete adherence suspected: insert scope to sigmoid to confirm inadequacy before aborting | Weak | Low |
| Assess bowel prep quality only after all washing and suctioning are completed | Strong | Moderate |
| Use term "adequate bowel preparation" to indicate standard intervals can be assigned | Strong | Moderate |
| Do not routinely use irrigation pumps to assist with preparation during colonoscopy | Weak | Very Low |
| Use same-day salvage maneuvers when feasible for inadequate preparations | Weak | Moderate |
| **Quality Tracking** | | |
| Routinely track adequate prep rate at endoscopist level and endoscopy unit level | Strong | Moderate |
| Target >90% adequate prep rate at both endoscopist and unit levels | Strong | Moderate |
| **Rescheduling** | | |
| Reschedule within 12 months for inadequate screening/surveillance prep; within 3 months for positive non-colonoscopic CRC test | Strong | Moderate |
| **High-Risk Modifications** | | |
| Modify instructions for prior or anticipated inadequate prep (enhanced education, navigation, dietary restriction, promotility agents, high-volume prep) | Strong | Moderate |
| Apply high-risk modifications for all high-risk patients | Strong | Moderate |
