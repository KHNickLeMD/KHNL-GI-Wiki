---
title: "AGA Institute Clinical Practice Update — Expert Review: Care of Patients Who Have Achieved a Sustained Virologic Response After Antiviral Therapy for Chronic Hepatitis C Infection"
category: source
tags: [hepatitis-c, hcv, svr, daa, hcc-surveillance, varices, fibrosis, elastography, cirrhosis, aga]
created: 2026-09-16
updated: 2026-09-16
sources: []
---
...
## Bibliographic Info
- **Article:** [Jacobson IM, Lim JK, Fried MW. American Gastroenterological Association Institute Clinical Practice Update—Expert Review: Care of Patients Who Have Achieved a Sustained Virologic Response After Antiviral Therapy for Chronic Hepatitis C Infection. *Gastroenterology* 2017;152:1578–1587.](https://doi.org/10.1053/j.gastro.2017.03.018)
- **Authors:** Ira M. Jacobson, Joseph K. Lim, Michael W. Fried
- **Year:** 2017
- **Journal/Publisher:** *Gastroenterology* (AGA Institute)
- **DOI:** [10.1053/j.gastro.2017.03.018](https://doi.org/10.1053/j.gastro.2017.03.018)
...
Four scenarios, by what the prior endoscopy showed:

| Prior screening endoscopy | Action |
|---|---|
| **No varices** | Repeat endoscopy at **2–3 y**; no further screening if still no varices **and** no other progressive liver disease |
| **Small varices, no treatment deemed necessary** | Repeat at **2–3 y**; stop if unchanged or smaller; otherwise treat and follow as needed |
| **Varices treated with primary prophylaxis** (β-blockers and/or band ligation) | Repeat at **6–12 mo**; if unchanged continue treatment and repeat at **1–2 y**; consider stopping treatment if varices are reproducibly small enough to be low risk |
| **Decompensated, or prior variceal bleed** | Continue surveillance and/or treatment as already instituted |

- Supporting data: 0/34 SVR patients developed de novo varices over median 11 y (vs 45/115 [39%] nonresponders, 22/69 [32%] untreated); 2/57 (3%) de novo varices in Child-Pugh A SVR patients vs 8/53 (15%) IFN failures.
- **Baveno VI sparing criteria (TE <20 kPa and platelets >150,000/µL) are not endorsed post-SVR** — "such data in patients post-SVR are not yet available and therefore application of these cutoffs in patients after SVR should be approached with caution and on an individual-patient basis."
- Caveat from Di Marco: SVR reduced de novo variceal development in patients **without** varices at baseline (HR 0.23) but **not** in those who already had small varices (HR 1.58).

### Recurrent HCC after DAA — the controversy, resolved as "insufficient evidence"
- Two 2016 series: **17/59 (29%)** and **16/58 (28%)** recurrence in previously-treated HCC after DAA.
- Three ANRS cohorts: **no** significant increase in HCC incidence.
- Position: insufficient evidence to change surveillance strategy, and insufficient evidence to withhold DAA therapy after locoregional HCC treatment. Some clinicians may intensify imaging to every 3 months for a year — offered as an option, not advice.

### Reinfection and lifestyle
- Reinfection incidence in people who inject drugs: **4.6/100 person-years** (95% CI 1.7–10.0) at 24 wk post-treatment; **1.7/100 person-years** with a history of injection drug use, rising to **4.9/100 person-years** in those who relapse to injection use.
- Monitor by periodic HCV RNA for as long as exposure risk continues; refer to addiction management.
- **Alcohol: no safe limit established post-SVR.** Avoid significant intake in all; **complete abstinence is prudent in advanced fibrosis or cirrhosis.**
- Evaluate all SVR patients for modifiable injury: alcohol, drug use, fatty liver, diabetes. Diabetes remains an HCC risk factor post-SVR, including in non-cirrhotics.

---

## Relevance to Wiki
- [[hepatitis-c]] — supplies the post-SVR follow-up arm the page lacked: confirmation testing schedule (SVR12, 48 wk), who is discharged (F0–F2), who is surveilled indefinitely (F3/F4), reinfection monitoring, alcohol counseling.
...
- **Post-SVR HCC in F0–F2:** BPA 5 says do not screen, while the text acknowledges documented cases and states that real-world confirmation of late HCC in F0–F2 "will require reconsideration" of the recommendation.
