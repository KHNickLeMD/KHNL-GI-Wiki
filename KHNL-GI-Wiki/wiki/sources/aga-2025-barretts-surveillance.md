---
title: "AGA Clinical Practice Guideline: Surveillance of Barrett's Esophagus (2025)"
category: source
...
- **Article:** [Wani S, Zhou MJ, Sawas T, Rubenstein JH, et al. AGA Clinical Practice Guideline: Surveillance of Barrett's Esophagus. *Gastroenterology* 2025;169(6):1188–1207.](https://doi.org/10.1053/j.gastro.2025.09.012)
...
### Recommendations (Table 2, verbatim with grades)

| # | Recommendation | Strength | Certainty |
|---|---|---|---|
| 1 | "In patients with NDBE, the AGA suggests performing endoscopic surveillance compared to no surveillance." | Conditional | Low |
| 2 | "In patients with columnar-lined esophagus <1 cm with intestinal metaplasia, the AGA suggests against surveillance endoscopy." *(body text adds: "…with intestinal metaplasia without neoplasia")* | Conditional | Very low |
| 3 | "In patients undergoing surveillance endoscopy for BE, the AGA recommends using a combination of high-definition WLE plus CE compared WLE alone." | **Strong** | Moderate |
...
**Rec 1 (surveillance intervals)**
- Data on optimal intervals is limited; **most panel experts advise high-quality endoscopy every 3 years**
- **Extend to every 5 years** in lower-progression-risk patients, e.g. **short-segment BE (<3 cm)**
- Discontinuation of surveillance in NDBE should be considered based on **age and comorbidities**

**Rec 3 (sampling)**
- Choice of CE modality (virtual vs dye-based) should follow **endoscopist and center expertise** — no recommendation between them
- CE-directed biopsies are an **adjunct to**, not a replacement for, a structured biopsy protocol
- **Structured biopsy protocol = targeted biopsies of any visible lesion + random 4-quadrant biopsies every 2 cm if no history of dysplasia, every 1 cm if there is a history of dysplasia**
...
- **IND:** **annual** endoscopy until the histologic grade changes
- **IND confirmed by expert pathology review: the panel does not perform EET**
...
- [[barretts-esophagus]] — governs the NDBE surveillance intervals, the IND/LGD pathways, and the biopsy-protocol rule
- [[endoscopic-eradication-therapy]] — the referral threshold and the "no EET for confirmed IND" rule
- [[upper-endoscopy]] — high-quality-examination requirement and chromoendoscopy
- [[proton-pump-inhibitors]] — daily PPI as chemoprevention; PPI over surgery
- [[antireflux-surgery]] — Rec 8 is the explicit comparison
...
[[barretts-esophagus]], [[endoscopic-eradication-therapy]], [[gerd]], [[upper-endoscopy]], [[proton-pump-inhibitors]], [[esophageal-adenocarcinoma]]
