---
title: "ACG 2025: Diagnosis and Management of Eosinophilic Esophagitis"
category: source
...
|---|---|---|---|
| 1 | Diagnose EoE using clinical + histologic criteria | Strong | Moderate |
| 2 | ≥6 biopsies from ≥2 esophageal levels | Strong | Low |
...
| 10 | Dupilumab (≥12y, PPI-nonresponder) | Conditional | Moderate |
| 11 | Dupilumab (1–11y, PPI-nonresponder) | Conditional | Low |
| 12 | No recommendation for/against cendakimab, benralizumab, lirentelimab, mepolizumab, reslizumab | — | — |
| 13 | Do NOT use omalizumab | Conditional | Low |
| 14 | Do NOT use cromolyn or montelukast | Conditional | Very low |
| 15 | Esophageal dilation as adjunct for stricture-related dysphagia | Conditional | Low |
| 16 | Continue effective therapy for maintenance (prevent relapse) | Strong | Low |
| 17 | Evaluate response with symptoms + endoscopy + histology | Strong | Low |
| 18 | Esophagram for pediatric fibrostenotic disease evaluation | Conditional | Very low |
| 19 | Feeding therapist/dietician for pediatric feeding dysfunction | Conditional | Very low |
...
| 2FED | Dairy + wheat | 40–45% |
| 4FED | Dairy, wheat, egg, soy | 40–50% |
| 6FED | Dairy, wheat, egg, soy, nuts, seafood | 40–70% |
| Elemental | All (amino acid formula) | >90% (if adherent) |

- Step-up approach preferred: start with 1FED or 2FED; escalate if no response
- Food reintroduction: add 1 food group × 6–8 weeks → endoscopy; re-eliminate if flare
- **Do NOT use** skin prick, patch test, or serum IgE/IgG to direct diet
- Dietitian referral strongly recommended
...
- Endoscopy insensitive for stricture detection (sensitivity ~15%); esophagram more sensitive
- **Always pair with anti-inflammatory therapy** — dilation alone does not treat underlying EoE
...
- Dose reduction acceptable after achieving remission (especially with BOT: 0.5mg bid effective)
