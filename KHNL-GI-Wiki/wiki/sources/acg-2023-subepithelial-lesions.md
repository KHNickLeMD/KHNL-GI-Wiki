---
title: "ACG 2023: Diagnosis and Management of Gastrointestinal Subepithelial Lesions"
category: source
...
3. **Bite-on-bite biopsy not suggested before EUS** (conditional; very low evidence). Limited evidence; should only follow EUS confirming non-vascular, non-extrinsic lesion.
...
- Anechoic or cystic spaces
- Echogenic foci
- Malignant-appearing lymph nodes
- Presence of ≥2 of these features: sensitivity for malignancy 80–100%; absence of all 3 (irregular border, echogenic foci, cystic spaces): malignancy found in only 0–11%
- **Tumor size is the only feature associated with higher mitotic index** (EUS features do not reliably predict mitotic rate in 2–5 cm GIST)
...
- KC5: For GIST <2 cm requiring resection, endoscopic methods are acceptable
...
This guideline is the primary ACG reference for the [[endoscopic-ultrasound]] evaluation of intramural GI masses. It defines management thresholds for the most clinically important SEL entities — particularly GIST (size-based surgery cutoffs), gastric NETs (type-based endoscopic approach), and esophageal MP-layer tumors (STER vs. surgery). Directly informs the `subepithelial-lesion` diagnostic schema.
