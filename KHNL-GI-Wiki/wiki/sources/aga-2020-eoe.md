---
title: "AGA/JTF Clinical Guideline: Management of Eosinophilic Esophagitis (2020)"
category: source
...
# AGA/JTF Clinical Guideline: Management of Eosinophilic Esophagitis (2020)
...
## Key Recommendations (mostly conditional)

- **PPIs** suggested as an initial pharmacologic option (induce histologic remission in a subset).
- **Topical (swallowed) corticosteroids** — budesonide or fluticasone — suggested over no treatment.
- **Dietary elimination** therapy suggested as an alternative (e.g., empiric multi-food elimination).
- **Esophageal dilation** for symptomatic strictures/fibrostenotic disease (does not treat inflammation — combine with anti-inflammatory therapy).
- Biologics (e.g., dupilumab) emerged after this guideline for refractory disease.
