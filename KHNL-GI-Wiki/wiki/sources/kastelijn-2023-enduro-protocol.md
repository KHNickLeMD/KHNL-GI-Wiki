---
title: "Endoscopic ultrasonography-guided gastroenterostomy versus surgical gastrojejunostomy for palliation of malignant gastric outlet obstruction (ENDURO): study protocol for a randomized controlled trial"
category: source
tags: [gastric-outlet-obstruction, eus, lams, gastrojejunostomy, palliation, protocol, rct]
created: 2026-09-02
updated: 2026-09-02
sources: []
---
...
- **Authors:** Janine B. Kastelijn and Yorick L. van de Pavert (joint first authors), Marc G. Besselink, Paul Fockens, Rogier P. Voermans, Jeanin E. van Hooft, Marco J. Bruno, Hjalmar C. van Santvoort, Frank P. Vleggaar, et al.
- **Year:** 2023
...
*No outcome findings exist. The following are design and technique specifications.*
...
| **Both** SGJ and EUS-GE technically and clinically feasible | |
...
- Gastroscope passed proximal to the stenosis, residual gastric contents removed; feeding tube or nasobiliary drain placed distal to the stenosis if not already in place.
- Linear-array echoendoscope introduced; the jejunal or duodenal loop identified by flushing **saline mixed with indigo carmine** into the post-stenotic loop. Fluoroscopy optional to confirm puncture site.
- **Direct puncture technique** with an **electrocautery-enhanced delivery system**; a **20 × 10 mm LAMS (Hot AXIOS, Boston Scientific)** — i.e. a **20-mm** stent — deployed distal flange first, tractioned against the small-bowel wall, then proximal flange.
- Position and passage confirmed by **backflow of the indigo-coloured saline** into the stomach.
- **No immediate balloon dilation** — the stent is left to expand naturally. All tubes removed immediately afterwards.

**SGJ technique (protocolized):**
- **Laparoscopic**, antecolic **side-to-side** gastrojejunostomy, **without Roux-en-Y** reconstruction; anastomosis on the anterior or posterior stomach depending on tumour location (antrum, or antrum/corpus).
...
- **EUS-GE technical failure or complication → crossover to SGJ is permitted**, with explicit prior informed consent.
- **Biliary intervention is not performed in the same session** as EUS-GE or SGJ; concomitant biliary obstruction is managed per standard of care.
- **Do not re-endoscope through the LAMS within the first 6 weeks** of placement — the fistula tract may not be mature.
- **Persistent GOO symptoms** are defined as nausea, **vomiting >2 times in 24 h**, or inability to tolerate at least soft solid intake. Managed with nil per mouth, nasogastric tube, and prokinetics (metoclopramide, domperidone, or erythromycin). If intake is still **GOOSS 0–1 at post-procedure day 5**, place a **jejunal feeding tube endoscopically** after excluding ileus (distended abdomen, absent or high-pitched peristalsis, no flatus or faeces) — endoscopic placement also lets you assess anastomotic patency. Parenteral nutrition if jejunal feeding is not tolerated.
- **Recurrent GOO symptoms → upper endoscopy is advised.**
- Pre-existing tube feeding is **stopped** after the procedure to give oral intake a fair trial, and restarted only if the patient demonstrably cannot maintain adequate oral intake.
