...
- In May 2021, the FDA issued a new warning restricting OCA use in PBC patients with advanced cirrhosis due to the risk of serious liver injury.
- The 2018 guidance had used the term "decompensated liver disease (Child-Pugh-Turcotte B or C)" — this has been replaced in 2021 with the more operationally specific definition of "advanced cirrhosis" (prior or current decompensation or portal hypertension).
- The 2021 update adds the further recommendation to monitor **all** cirrhotic patients on OCA carefully, not only those with Child-Pugh B/C.

---

## Key Findings / Claims

- OCA (obeticholic acid / Ocaliva) is contraindicated in advanced cirrhosis as defined by prior or current decompensation or portal hypertension — a stricter threshold than the 2018 guidance's "Child-Pugh B or C" language.
- Fibrates (bezafibrate, fenofibrate) remain viable off-label second-line options after UDCA failure but should not be used in decompensated liver disease.
