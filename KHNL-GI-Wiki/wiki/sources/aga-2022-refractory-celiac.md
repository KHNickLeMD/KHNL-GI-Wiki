---
title: "AGA Clinical Practice Update on Management of Refractory Celiac Disease: Expert Review"
category: source
...
- **Article:** [Green PHR, Paski S, Ko CW, Rubio-Tapia A. AGA Clinical Practice Update on Management of Refractory Celiac Disease: Expert Review. *Gastroenterology* 2022;163:1461–1469.](https://doi.org/10.1053/j.gastro.2022.07.086)
- **Authors:** Peter H. R. Green, Shirley Paski, Cynthia W. Ko, Alberto Rubio-Tapia
- **Year:** 2022
...
Expert review covering the evaluation of a patient with [[celiac-disease|celiac disease]] whose symptoms persist or recur on a gluten-free diet — the *nonresponsive* celiac phenotype — and the narrower subset that meets criteria for **refractory celiac disease (RCD)**. The document's spine is a sequence of exclusions: confirm the original diagnosis was real, exclude ongoing gluten ingestion, exclude the common alternative causes of persistent symptoms, and only then call it refractory.

**RCD is defined as celiac disease with persistent symptoms of malabsorption and villous atrophy despite at least 12 months of strict adherence to a gluten-free diet.** It occurs in ~1% of celiac patients (likely an overestimate — data come from referral centers). Persistent villous atrophy is **necessary but not sufficient** for the diagnosis.

RCD splits into two subtypes with different prognosis and management, distinguished by the **intraepithelial lymphocyte (IEL) immunophenotype**, not by symptoms. RCD1 has a normal polyclonal IEL population; RCD2 has an aberrant clonal IEL population making up ≥20% of total IELs, is regarded as a low-grade intraepithelial malignancy, and carries risk of progression to **enteropathy-associated T-cell lymphoma (EATL)** and ulcerative jejunoileitis.

Corticosteroids — **open-capsule budesonide** preferentially — are first-line for both subtypes. The update is candid that initial doses and taper schedules "have not been examined rigorously," and that there are **no FDA-approved therapies** for RCD.
...
### IEL immunophenotype — the criteria that separate RCD1 from RCD2

| | **RCD1** | **RCD2** |
|---|---|---|
| IEL population | Normal, polyclonal expansion | Aberrant, **clonal** |
| Proportion of total IELs | — | **≥20% of total IEL population** |
| Surface CD3 (sCD3) | **+** | **–** |
...
> **BEST PRACTICE ADVICE 5:** Perform small bowel imaging with capsule endoscopy and computed tomography or magnetic resonance enterography to exclude enteropathy-associated T-cell lymphoma and ulcerative jejunoileitis at initial diagnosis of type 2 refractory celiac disease.

> **BEST PRACTICE ADVICE 6:** Complete a detailed nutritional assessment with investigation of micronutrient and macronutrient deficiencies in patients diagnosed with refractory celiac disease. Check albumin as an independent prognostic factor.

> **BEST PRACTICE ADVICE 7:** Correct deficiencies in macro- and micronutrients using oral supplements and/or enteral support. Consider parenteral nutrition for patients with severe malnutrition due to malabsorption.

> **BEST PRACTICE ADVICE 8:** Corticosteroids, most commonly open-capsule budesonide or, if unavailable, prednisone, are the medication of choice and should be used as first-line therapy in either type 1 or type 2 refractory celiac disease.

> **BEST PRACTICE ADVICE 9:** Patients with refractory celiac disease require regular follow-up by a multidisciplinary team, including gastroenterologists and dietitians, to assess clinical and histologic response to therapy. Identify local experts with expertise in celiac disease to assist with management.

> **BEST PRACTICE ADVICE 10:** Patients with refractory celiac disease without response to steroids may benefit from referral to a center with expertise for management or evaluation for inclusion in clinical trials.

### Excluding ongoing gluten ingestion (BPA 2)

- **Persistent gluten ingestion accounts for 40%–50%** of poorly/nonresponsive celiac disease — the single largest cause.
- Dietitian review experienced in celiac disease is **essential**.
- **Negative serologies do not exclude** intermittent or low-level ingestion.
- Stool/urinary **gluten immunodominant peptides** are commercially available; not validated or widely available in Europe.
- If prior workup was equivocal/discrepant → test **HLA-DQ2 / DQ8**.
- Seronegative celiac disease exists; diagnosis can rest on clinical + histologic response to gluten-free diet with consistent pathology and compatible HLA.

### Biopsy protocol

- Initial diagnosis: ≥1–2 biopsies from the **duodenal bulb** and ≥4 from the **distal duodenum**. The optimal protocol for RCD follow-up is **not well defined**.
- If suspicion for RCD is strong (weight loss, anemia, GI bleeding, persistent nutritional deficiencies) → obtain **up to 6 additional distal duodenal biopsies**, of which **2–3 in normal saline or RPMI medium** for flow cytometry, plus tissue for IHC and TCR rearrangement.
- Take targeted biopsies from any abnormal mucosa.
...
- **Repeat imaging** in RCD2 patients who are clinically worsening (increased lymphoma risk).
- Strictures, inflammation, erosions, ulcers, or mass lesions → **small bowel enteroscopy** for a pathologic diagnosis.
...
- Escalation ladder: dietitian-guided diet optimization + oral supplements → enteral support → parenteral support for severe malabsorptive malnutrition.

### Therapies (Table 1, reproduced in full)

| Therapy | Dose | Response | Comments |
|---|---|---|---|
| **Open-capsule budesonide** | **3 mg 3 times daily** | 92% clinical response; 89% histologic improvement | First-line, both subtypes |
| **Prednisone** | **40–60 mg daily** with slow taper over several months | 90% clinical response in RCD1; 77% in RCD2 | If budesonide unavailable |
| Small intestinal release **mesalamine** | **2–4 g/d** | 75% clinical response alone; 33% complete response with mesalamine + budesonide | — |
| **Azathioprine** | **2–2.5 mg/kg/d** | 71% clinical response | Potential risk of accelerated lymphoma development; **use with caution in RCD2** |
...
- **Overall, 80%–90% of RCD patients** have an adequate clinical response to open-capsule budesonide or prednisone, with higher response in RCD1.
- **IV methylprednisolone** is an alternative for severe disease, followed by oral prednisone or open-capsule budesonide.
- ⚠ **Initial doses and taper recommendations for steroids have not been rigorously examined.** Whether steroids reduce lymphoma risk **remains uncertain**; resolution of RCD2 molecular/genetic abnormalities with steroids is **controversial**.
- **Second-line:** optimal choice unknown. Adding an immunosuppressant (azathioprine, mercaptopurine, tioguanine) to steroids appears effective **in RCD1**; azathioprine is the immunosuppressant of choice for long-term RCD1 treatment (linked to villous atrophy in case reports). **Immunosuppressants are not advised in RCD2** for fear of accelerated lymphoma development, though data are scarce and not definitive.
- **Cladribine outcomes in RCD2:** in 17 patients, 58% histologic improvement, 35% decrease in aberrant IELs — but **41% were diagnosed with EATL and died**. A later series of 32 patients showed **5-year survival 63% among responders** with **EATL risk 16%**.
- **Surgery** is rarely needed — reserved for acute abdomen from bowel perforation, or RCD2 with localized ulcerative jejunitis causing obstruction or recurrent GI bleeding.

### Follow-up (BPA 9–10)

- Follow-up is **based on expert opinion**.
- Multidisciplinary: gastroenterologists **and** dietitians.
- **Visits every 3 months until disease is well controlled; every 6 months thereafter.**
- Assess clinical and laboratory parameters each visit with aggressive correction of nutritional deficiencies.
- Dietitian follow-up: malnutrition management, adherence assessment, reinforcement of strict gluten-free diet.
- No response to steroids → refer to an expertise center or for clinical trial enrollment.
