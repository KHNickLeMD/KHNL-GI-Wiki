---
title: "ACG 2019: Hereditary Hemochromatosis"
category: source
...
- SF >1,000 ng/mL → liver biopsy recommended for fibrosis staging and to exclude concurrent liver disease
- Liver biopsy histologic criteria for type 1 HH: grade 4 stainable iron in hepatocytes with periportal distribution, HIC >71 µmol/g dry weight, hepatic iron index (HII) >1.9
- MRI T2* (non-contrast, with HIC estimation software) endorsed for non-invasive HIC in non-C282Y patients when staging or concurrent liver disease evaluation is not needed (Conditional/Low)
...
- Mortality from liver disease markedly increased (standardized mortality ratio ~24) with SF >2,000 ng/mL at diagnosis
- Certain complications do NOT improve with phlebotomy: established cirrhosis, arthropathy, diabetes, hypogonadism
