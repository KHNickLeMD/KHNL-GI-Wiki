---
title: "AGA 2021: Diagnosis and Management of Atrophic Gastritis"
category: source
...
### Definition and Histopathology (BPA 1–2)
- AG = loss of gastric glands with or without metaplasia, in chronic inflammation
- Two forms: nonmetaplastic atrophy (replacement by connective tissue) and metaplastic atrophy (replacement by IM or pseudopyloric metaplasia)
- IM on histology almost invariably implies AG — gastroenterologists and pathologists should document AG extent and severity explicitly
- Risk stratification uses OLGA (severity of atrophy) and OLGIM (extent of IM): Stages III/IV = significantly elevated gastric cancer risk
...
### Updated Sydney Protocol (BPA 4)
- 5 biopsies in separately labeled jars: antrum lesser curve, antrum greater curve, incisura angularis (do not skip), corpus lesser curve, corpus greater curve
- Near 100% sensitivity for H. pylori detection
...
- All AG patients: test and treat regardless of etiology; confirm eradication with non-serologic testing
- Eradication may not reverse established atrophy but still reduces gastric cancer risk
...
- Evaluate all AG patients for iron and B-12 deficiency
- Iron deficiency common (up to 50% of corpus-predominant AG); often precedes B-12 deficiency
...
- Substantially updates: [[gastric-premalignant-conditions]] — Sydney protocol, OLGA/OLGIM staging, surveillance intervals overlap; AG is the upstream stage in the Correa cascade
- Touches: [[helicobacter-pylori-infection]] — reinforces test-and-treat in AG; eradication reduces but does not eliminate gastric cancer risk in established AG
- Touches: [[upper-endoscopy]] — Sydney biopsy protocol, mucosal prep, image-enhanced endoscopy for premalignant lesions
- Touches: [[endoscopic-ultrasound]] — EUS for staging of gastric NETs 1–2 cm

## Contradictions / Open Questions
- **Tension with 2020 AGA GIM guideline:** 2020 AGA GIM guidelines recommend against routine surveillance for GIM (conditional, very low quality evidence), while this 2021 update advocates surveillance every 3 years for advanced AG — creates a potential inconsistency for patients with extensive GIM
- **AIG surveillance interval undefined:** explicitly labeled "unclear" (BPA 8); no AGA-specific recommendation
