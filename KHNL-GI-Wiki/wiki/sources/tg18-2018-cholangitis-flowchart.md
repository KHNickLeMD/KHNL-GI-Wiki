...
category: source
tags: [cholangitis, biliary-infection, tokyo-guidelines, severity-grading, biliary-drainage, ercp, guideline]
created: 2026-08-25
updated: 2026-08-25
sources: []
---
...
### TG18 severity assessment criteria for acute cholangitis

The grading criteria — the decision input the whole flowchart turns on:
...
- **Grade I (mild):** initial treatment incl. antibiotics is sufficient in most cases; **most patients do not require biliary drainage**. Drainage **if no response** to initial treatment. EST + choledocholithotomy may be done **at the same time** as drainage. Postoperative cholangitis usually resolves on antibiotics alone — drainage not usually required.
- **Grade II (moderate):** **early endoscopic or percutaneous transhepatic biliary drainage is indicated.** Treatment of the underlying etiology after general condition improves; EST + subsequent choledocholithotomy may be performed together with drainage.
- **Grade III (severe):** condition may deteriorate rapidly — **respiratory/circulatory management first** (tracheal intubation → ventilation, vasopressors). Endoscopic or percutaneous transhepatic drainage **as soon as possible after the patient's condition has been improved** by initial treatment and organ support. Treat the underlying etiology after general status improves.
- **Transfer criteria (Table 5):** if a hospital cannot perform endoscopic or percutaneous transhepatic drainage or provide intensive care, patients with **moderate or severe** cholangitis should preferably be transferred to one that can — **irrespective of whether those treatments turn out to be required.**
...
- **CQ 1 — How was the TG13 flowchart for acute cholangitis evaluated?** *(Background Question)* → **"It was shown to require partial revision." (Level D)**
  ...
  - Two studies of early vs elective laparoscopic choledocholithotomy were safe with no complication difference, but were single-institution, small (72 and 73 subjects), heavily excluded, and **did not demonstrate safety of single-stage laparoscopic choledocholithotomy in moderate** cholangitis.
- **CQ 2 — What treatments other than antibiotics and biliary drainage are effective for severe cholangitis?** *(Future Research Question)* → **"The administration of recombinant human soluble thrombomodulin (rTM) may be considered for severe cholangitis complicated with DIC (Level D)."**
  - Severe cholangitis is often complicated by DIC. Value of conventional anticoagulants (heparin, antithrombin III, protease inhibitors) in cholangitis is **unclear** — cholangitis numbers in those RCTs are unknown or very small.
  - Suetani et al.: 66 patients with cholangitis-induced DIC, 33 given rTM vs 36 not — **DIC resolution significantly better with rTM (83.3% vs 52.8%, p<0.01)** but **no mortality difference (13.3% vs 27.8%, p=0.26)**.
  - Nakahara et al.: 13 patients; the 7 given rTM had significantly lower DIC scores than the 6 given antithrombin III alone.
  - Both are **case series with insufficient numbers — low level of evidence**; recommended only because no serious side effects were seen.

### What changed from TG13

- Cholangitis and cholecystitis flowcharts, published together in TG07 and TG13, are **split into separate TG18 articles**.
- The cholangitis flowchart is **little changed from TG13 except for moderate cholangitis**: TG18 amends it to show that **single-stage** EST + choledocholithotomy alongside drainage is possible, "in light of the actual situation in clinical practice" — while stating the evidence for it in moderate cholangitis is still insufficient.
- The cholecystitis flowchart, by contrast, underwent **major revision**.

### Consensus process

- At the TG18 public hearing (**June 9, 2017**), participants responded "Strongly agree" or "Agree" to the flowchart changes, taken as indicating their validity.
