...
- **Article:** [Husby S, Murray JA, Katzka DA. AGA Clinical Practice Update on Diagnosis and Monitoring of Celiac Disease—Changing Utility of Serology and Histologic Measures: Expert Review. *Gastroenterology* 2019;156(4):885–889.](https://doi.org/10.1053/j.gastro.2018.12.010)
- **Authors:** Steffen Husby, Joseph A. Murray, David A. Katzka
- **Year:** 2019
- **Journal/Publisher:** *Gastroenterology* 2019;156(4):885–889
- **DOI:** [10.1053/j.gastro.2018.12.010](https://doi.org/10.1053/j.gastro.2018.12.010)
- **Type:** guideline (AGA Clinical Practice Update — expert review)

**Evidence grading:** the document applies **no formal evidence-quality or strength rating** to any statement. Its stated method is that "the recommendations outlined in this expert review are based on available published evidence, including cohort and case-control studies of the diagnostic process as well as controlled and descriptive studies of disease management." It issues **12 Best Practice Advice statements**, numbered **1–11 with an additional 2a**; statements 1–9 cover diagnosis and 10–11 are labeled MANAGEMENT.
...
The update is candid that "the utility of serology vs histology in follow-up has not been definitively settled," and that the correlation between symptoms, mucosal healing, and long-term outcome remains unclear.

## Key Findings / Claims

### Best Practice Advice statements (all 12, verbatim)
...
> **MANAGEMENT: Best Practice Advice 10:** Celiac serology has a guarded role in the detection of continued intestinal injury, in particular as to sensitivity, as negative serology in a treated patient does not guarantee that the intestinal mucosa has healed. Persistently positive serology usually indicates ongoing intestinal damage and gluten exposure. Follow-up serology should be performed 6 and 12 months after diagnosis, and yearly thereafter.
...
### Who to test — raising pretest probability

- Population prevalence of CD ≈ **1%**. Testing is worthwhile once pretest probability reaches **5%–10%**, where serology and histology gain positive predictive value.
- Reached by selecting patients with compatible signs/symptoms, or asymptomatic patients in risk groups (type 1 diabetes, first-degree relatives).
- **Malabsorption symptoms** (including failure-to-thrive) raise the accuracy of antibody testing from **98% to 100%** in a pediatric prospective study.
- CD is present in **5%–10% of children with type 1 diabetes**; asymptomatic first-degree relatives carry a **7.5%** risk in meta-analysis.
- Point-of-care tests give results comparable to conventional testing but have quality-control problems in inexperienced hands, and rapid results are rarely decisive.
...
### HLA-DQ2 / DQ8 — gene dose effect

- Most genetic dependence resides in HLA-DQ2 and -DQ8.
- **Homozygous HLA-DQ2.5 makes CD likely; heterozygous HLA-DQ2.2 makes CD unlikely.**
- **No additional diagnostic value** in cases with a high serum TG2-IgA level.
- Reserve for **second-line evaluation** when the diagnosis is doubtful — inconclusive antibodies, inconclusive histology, or prior GFD.

### Histopathology — what the report must contain

- Biopsies at EGD from **different parts of the duodenum**, including the **bulb** — interpret with Brunner glands and other bulb variants in mind.
- Report should describe **positioning, Marsh classification, villus-crypt ratio, and lymphocyte count**; the update defines lymphocytosis as **more than 25 lymphocytes per high-power field**.
- **CD3 staining** for T cells may be included; **gamma/delta T-cell markers** and **IgA transglutaminase antibody deposits** may be supportive.
- Quality is a real limitation: sampling, cutting, and fixation demand expertise, and **5% of biopsies lead to diagnostic uncertainty**.
...
| Question | What the update says |
|---|---|
| Routine follow-up interval | Every **12 months** is a reasonable schedule |
| Follow-up serology timing | **6 months** and **12 months** after diagnosis, then **yearly** |
| Negative serology on treatment | Does **not** guarantee the mucosa has healed |
| Persistently positive serology | **Usually indicates ongoing intestinal damage and gluten exposure** |
| Persistent/relapsing symptoms, no other explanation | **Endoscopic biopsies** to determine healing — even if TG2-IgA is negative |
| Follow-up biopsy still showing **≥ Marsh 2** | **Repeat biopsy after 12 months** |

**Test performance of persistently positive TG2-IgA/EMA for detecting persistent villous atrophy** (meta-analysis):

| | Adults | Children |
|---|---|---|
| Sensitivity | **0.38** | **0.70** |
| Specificity (patients on GFD ≥1 year) | **0.80** | **0.87** |

- Conclusion drawn: serology at follow-up is **of limited use in adults and better in children**.
- **Undetectable** TG2-IgA — using detectable levels *below* the upper normal limit — may help identify patients who have achieved mucosal healing.
- In children, serology is most useful as **EMA**, with a **median time to mucosal healing of 2.2 years**.

**Predictors of incomplete mucosal recovery, measured at diagnosis** (adult study):

| Factor present at diagnosis | Incomplete recovery vs recovery | *P* |
|---|---|---|
| Malabsorption | 55% vs 41% | .003 |
| High EMA | 46% vs 25% | <.001 |
| Severe mucosal damage (total atrophy) | 32% vs 19% | <.001 |

- **Symptoms did not reliably predict lack of mucosal healing**, and most patients who failed to heal were **without symptoms**.
- In large studies most adult patients do achieve complete mucosal healing.
- Failure to heal was associated with **increased lymphoma risk** but **not** with excess mortality; studies with universal follow-up biopsy are underpowered for rare events.

### Adherence and attrition

- Most patients comply satisfactorily with a GFD, with symptom relief and falling antibody levels.
- Only **35% of adults were still in follow-up 4 years after diagnosis** (Olmsted County); **therapy-resistant CD occurs in ~20% of adults**.
- **Teenagers** are less satisfied with the impact of CD and less adherent. Whether the diagnosis came from symptoms or from screening does not influence long-term adherence.
- **Children lost to follow-up** are more frequently nonadherent and antibody-positive.
- In children who attend registered follow-up and grow and develop normally without symptoms, **routine testing for vitamin and mineral deficiencies seems unnecessary**.
- Long-term GFD harms relate to **lack of vitamins and fiber**; nonadherence risks ongoing malabsorption, anemia, and osteoporosis.
- Growth in weight and height is the essential marker of GFD success in children; adults improve more subtly.
- Dietitian-led, team-based care; online/short-message support may improve adherence.

## Relevance to Wiki

- **[[celiac-disease]]** — supplies the monitoring schedule (serology at 6 and 12 months then yearly), the follow-up-biopsy trigger (persistent/relapsing symptoms even with negative TG2-IgA), the **Marsh ≥2 → re-biopsy at 12 months** rule, the sensitivity/specificity of follow-up serology for persistent villous atrophy, predictors of incomplete mucosal recovery, and the **gluten challenge dose** (3 slices of wheat bread daily for 1–3 months) that closes a stated gap on that page.
- Adds the **biopsy-avoiding diagnostic pathway** (Figure 1) as a decision tree, the HLA gene-dose effect, and the histopathology reporting elements.
- Complements [[aga-2022-refractory-celiac]] on the *upstream* side: this update covers monitoring of the responding patient; the 2022 update takes over once symptoms persist.
...
- The update suggests 1–3 months of gluten challenge before repeat TG2-IgA but notes **"even a shorter period has been advocated"** — no minimum is specified, and no re-biopsy timing is given.

---

## See Also

[[celiac-disease]], [[upper-endoscopy]], [[small-intestinal-bacterial-overgrowth]], [[chronic-diarrhea]]
