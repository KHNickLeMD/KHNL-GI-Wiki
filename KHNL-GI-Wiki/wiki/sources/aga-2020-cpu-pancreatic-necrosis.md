...
- **DPDS long-term stenting is unresolved.** BPA 14 says insufficient evidence supports long-term transenteric endoscopic stenting of the disconnected left remnant, while the body text calls EUS-guided transmural stenting an effective **temporizing** measure and names permanent indwelling stents an important field of study. Practice has moved since 2020; no newer guideline summarized here addresses DPDS.
- **Superseded fluid rates not addressed.** This 2020 CPU predates the [[acg-2024-acute-pancreatitis]] fluid-resuscitation change (no more than 1.5 mL/kg/h without hypovolemia) and does not discuss initial fluid rates in detail; it explicitly refers the reader to the separate AGA Technical Review and Guideline on *Initial Medical Treatment of Acute Pancreatitis*, which are not summarized here.
