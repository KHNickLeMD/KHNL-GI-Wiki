...
Document all of: esophagus, GEJ (antegrade), gastric cardia/fundus (retroflexed), corpus, incisura, antrum/pylorus, 2nd portion of duodenum, and any detected lesions. Target: >90%.
...
|---|---|---|
| Dysphagia without endoscopic etiology | ≥6 biopsies from ≥2 levels (proximal/mid + distal) | >90% |
| EoE suspected or established | EREFS score documented | >95% |
| Erosive esophagitis | LA classification documented | >98% |
| Suspected columnar metaplasia in tubular esophagus | Record SCJ, GEJ, and diaphragmatic hiatus | >95% |
...
4. Incisura in retroflexed view
5. Distal extent of examination in the duodenum

More rigorous documentation is recommended for Barrett's esophagus, gastric intestinal metaplasia, or patients referred for endoscopic treatment. (ESGE recommends ≥10 landmarks; World Endoscopy Organization recommends 28.)

### Standardized Classification Systems (BPA 6)

| Finding | Classification System | Criteria live on |
|---|---|---|
| Erosive esophagitis | Los Angeles (LA) classification | [[reflux-testing]] — criteria are printed as figures in [[acg-2025-egd-quality\|ACG/ASGE 2025]] and [[aga-2024-upper-endoscopy-quality\|AGA 2024]] (Figure 2 in each). Clinical significance on [[gerd]] |
...
- Ensure all patients and referring physicians receive final results and recommendations
