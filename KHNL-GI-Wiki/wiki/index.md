...
- [[crohns-disease]] — Crohn's disease: ADDT — transmural IBD, biologics (anti-TNF/vedolizumab/IL-23/JAK), perianal fistula, postoperative prevention, HD+chromoendoscopy CRC surveillance (SCENIC), endoscopic balloon dilation of benign strictures ≤4 cm (7 sources)
- [[ulcerative-colitis]] — Ulcerative colitis: ADDT — proctitis-to-pancolitis, 5-ASA/biologics/JAK/S1P modulators, ASUC management, ileoscopy (backwash vs CD ileitis), HD+chromoendoscopy dysplasia surveillance (SCENIC) (7 sources)
...
- [[hemorrhoids]] — Hemorrhoids: ADDT — Grade I–IV classification, fiber/fluid conservative, rubber band ligation preferred office treatment (Strong/Moderate), thrombosed external → excision within 4 days, Grade IV → hemorrhoidectomy (1 source)
...
- [[ascites]] — Ascites: SAAG-based differential, grade 1–3 classification, diagnostic paracentesis algorithm, spironolactone/furosemide dosing, LVP + albumin 6–8 g/L, TIPS criteria, hyponatremia management (1 source)
...
*Total: 154 sources | 97 disease scripts | 18 diagnostic schemas | 2 general procedures | 18 advanced procedures | 14 meds | 0 anatomy | 32 concepts | 1 synthesis (on-disk page counts as of 2026-06-14; index Sources section currently lists 133 source pages — full reconciliation still pending a future lint pass)*
