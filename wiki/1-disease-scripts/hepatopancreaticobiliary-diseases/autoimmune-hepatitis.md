...
- Dense plasma cell infiltration
- Centrilobular necrosis: present in acute/severe AIH

### Severity Assessment

**Acute severe AIH:** Jaundice + INR 1.5–<2.0 + no hepatic encephalopathy [[aasld-2020-autoimmune-hepatitis]]

**AIH-related ALF:** INR ≥2.0 + hepatic encephalopathy (any grade) — evaluate directly for liver transplantation; see [[acute-liver-failure]]
...
- Aminotransferases (ALT, AST) — typically markedly elevated; pattern not unique [[acg-2017-liver-chemistries]]
...
- CBC (cytopenias with portal hypertension); CMP; TPMT genotype/phenotype before AZA
...
- Definitive for diagnosis (interface hepatitis, plasma cell infiltrate, rosettes, emperipolesis)
- Required for definite AIH scoring on Simplified criteria
- Recommended before IS withdrawal to confirm histologic remission (preferred, not mandatory in adults)
- Staging for fibrosis guides prognosis and treatment duration decisions
...
| **Tacrolimus (TAC)** | 1–2 mg BID (titrated to trough) | Conditional, Low certainty — alternative if MMF fails or not tolerated |
...
**HCC surveillance in AIH cirrhosis:** Liver ultrasound ± AFP every 6 months — same standard as cirrhosis of any etiology. [[aasld-2020-autoimmune-hepatitis]]
...
- See [[liver-disease-in-pregnancy]] for full pregnancy management context
...
*Cross-references: [[abnormal-liver-chemistries]], [[drug-induced-liver-injury]], [[primary-biliary-cholangitis]], [[primary-sclerosing-cholangitis]], [[wilson-disease]], [[hereditary-hemochromatosis]], [[acute-liver-failure]], [[liver-disease-in-pregnancy]], [[liver-transplantation]]*
