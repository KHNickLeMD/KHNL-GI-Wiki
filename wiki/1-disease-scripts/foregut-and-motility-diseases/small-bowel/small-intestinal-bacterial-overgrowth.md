...
### Laboratory Tests
- Vitamin B12 (may be low in severe/structural SIBO — consumed by bacteria)
...
| Doxycycline | 100 mg q.d.–b.i.d. | Not specified |
...
**Recurrence:**
- 12.6% at 3 months, 27.5% at 6 months, 43.7% at 9 months
- Retreatment with subsequent antibiotic course is common practice (anecdotal/expert opinion)
- No universally accepted retreatment protocol
...
### Monitoring
- Repeat breath testing after treatment: normalization of H₂ or CH₄ correlates with symptom improvement (Key Concept 15)
- Follow-up breath testing is recommended as part of clinical trial outcomes but may guide clinical management in difficult-to-treat cases

---

## Cross-References
- [[irritable-bowel-syndrome]] — SIBO present in up to 78% of IBS patients; rifaximin FDA-approved for IBS-D partly because of SIBO/microbiome rationale
- [[celiac-disease]] — differential diagnosis; SIBO prevalence similar to healthy controls in celiac disease
- [[chronic-pancreatitis]] — pancreatic insufficiency is a recognized SIBO risk factor; symptom overlap (diarrhea, malabsorption, bloating)
- [[disorders-of-gut-brain-interaction]] — SIBO/IMO overlap with Rome IV/V IBS and functional dyspepsia diagnoses
- [[intestinal-methanogen-overgrowth]] — methane-dominant variant; distinct diagnostic and treatment approach
- [[rifaximin]] — preferred non-absorbable antibiotic for SIBO treatment
- [[small-bowel-motility]] — MMC phase III as key protective mechanism; dysmotility as SIBO risk factor
