---
title: "USMSTF 2015: Colonoscopy Surveillance after Colorectal Cancer Resection"
category: source
...
**Context:** The 3-year and 5-year intervals are based largely on post-polypectomy surveillance guidelines for high-risk adenomas. The cumulative incidence of metachronous CRC is ~0.3–0.35%/year, occurring at any time including decades after the index malignancy. All colorectal segments are at increased risk, though in older survivors risk may remain elevated primarily in the proximal colon. Surveillance is continued long-term or until benefit is outweighed by diminishing life expectancy due to age and/or comorbidity.
...
**Evidence context:** One study (n=1,736 with personal/family history of colorectal neoplasia, 24% personal CRC history) showed positive FIT led to CRC/advanced adenoma diagnosis ~2 years earlier, but applicability to post-CRC surveillance subgroup unclear and baseline exam quality unknown. Fecal DNA abnormalities clear from stool after resection of colorectal neoplasms; role in post-CRC surveillance not investigated.
...
- **[[familial-adenomatous-polyposis]]** — not directly addressed; hereditary syndromes excluded from this guideline's intervals
- **[[colorectal-cancer-screening]]** — adjacent context: this guideline addresses post-resection, not screening
- **[[endoscopic-ultrasound]]** — role in rectal cancer local surveillance (EUS every 3–6 months for high-risk rectal patients)

---

## Contradictions / Open Questions

- **Fecal testing gap:** Insufficient evidence for FIT/fecal DNA post-CRC resection — this is an active research area; no definitive guidance.
- **CTC timing post-resection:** Endorsed for obstructive CRC, but optimal timing for routine postoperative CTC surveillance is undefined.
