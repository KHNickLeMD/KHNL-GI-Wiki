---
title: "ACG 2020: Clinical Use of Esophageal Physiologic Testing"
category: source
...
- **Unproven GERD:** ambulatory monitoring off PPI; test selection: wireless pH for infrequent/variable symptoms, pH-impedance when supragastric belching or rumination suspected
- **Proven GERD (prior conclusive evidence + persisting symptoms):** pH impedance monitoring on PPI (only modality to assess ongoing reflux burden on therapy)
...
- Patients with extraesophageal symptoms average 10 consultations and 6 diagnostic procedures in first year of evaluation — upfront testing is more cost-effective ($1,897 vs. $3,033 for empiric BID PPI); minimizes misdiagnosis of extraesophageal reflux
- **Rumination syndrome:** HRIM (high-resolution impedance manometry) with postprandial monitoring is the diagnostic standard; sensitivity/specificity 75–80% and 100% for HRIM in rumination; postprandial monitoring increases identification. Manometric criteria: intragastric pressure rise >30 mmHg with proximal movement of gastric content, esophageal pressurization, and recognized rumination episode
...
- **[[reflux-testing]]**: Adds ACG 2020 recommendations for test selection across symptom categories; AET thresholds and on/off PPI testing strategy; HRM role in reflux evaluation; pre-ARS evaluation framework
- **[[ambulatory-reflux-monitoring]]**: Adds ACG 2020 GRADE recommendations for ambulatory monitoring (Recs 5–11); AET and MNBI as outcome predictors; PSPW index mentioned as emerging (not yet retired in 2020); on-PPI testing indication for proven GERD; RSA as predictor of ARS outcome
- **[[high-resolution-manometry]]**: Adds ACG 2020 clinical applications across symptom categories; provocative maneuvers (MRS, RDC, solid meal); HRM for hiatal hernia diagnosis; post-ARS evaluation; HRM superior to laryngoscopy for extraesophageal evaluation
- **[[chicago-classification-v4]]**: Predates CC v4.0 (2021); this guideline references CC v3.0 — note for historical context; EGJOO concept emerging but not yet CC v4.0 paradigm
- New concept warranting update: **barium esophagram** role in obstructive symptom evaluation

---

## Contradictions / Open Questions

- **AET thresholds**: This 2020 guideline uses the pre-Lyon 2.0 framework where AET >6% is pathologic, 4–6% borderline, and <4% physiologic — consistent with Lyon 2.0 (2024) thresholds. No contradiction, but the 2020 guideline does not have the Lyon 2.0 framing of "conclusive/borderline/excludes."
- **PSPW index**: Mentioned in 2020 as an emerging metric; retired by Lyon 2.0 (2024) as a clinical diagnostic tool.
