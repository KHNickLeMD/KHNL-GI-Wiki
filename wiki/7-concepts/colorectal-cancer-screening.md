...
|----------|----------|---------|-------|
| **Colonoscopy** | Every 10 years | Strong | High-sensitivity structural test; diagnostic and therapeutic |
...
| Colon capsule endoscopy | Every 5 years | Conditional | Limited data; not widely available; bowel prep required |
...
- [[colonoscopy]] — general procedure page (quality, complications, prep)
- [[colorectal-cancer]] — disease script (staging, management)
- [[lynch-syndrome]] — hereditary CRC syndromes
- [[polypectomy-emr]] — polyp removal techniques
